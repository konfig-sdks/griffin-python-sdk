...
class TransactionsListBalanceChangesResponseAccountTransactionsItemBalanceChange(
    schemas.DictSchema
):
    """
    This class is auto generated by Konfig (https://konfigthis.com)

    Shows the account [balance change](http://docs.griffin.com).
    """
    ...
    ) -> 'TransactionsListBalanceChangesResponseAccountTransactionsItemBalanceChange':
