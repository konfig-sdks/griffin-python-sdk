...
class EventsGetAllOrganizationEventsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def events() -> typing.Type['EventsGetAllOrganizationEventsResponseEvents']:
                return EventsGetAllOrganizationEventsResponseEvents
        
            @staticmethod
            def links() -> typing.Type['EventsGetAllOrganizationEventsResponseLinks']:
                return EventsGetAllOrganizationEventsResponseLinks
            __annotations__ = {
                "events": events,
                "links": links,
            }
    
    links: 'EventsGetAllOrganizationEventsResponseLinks'
    events: 'EventsGetAllOrganizationEventsResponseEvents'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["events"]) -> 'EventsGetAllOrganizationEventsResponseEvents': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'EventsGetAllOrganizationEventsResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["events", "links", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["events"]) -> 'EventsGetAllOrganizationEventsResponseEvents': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'EventsGetAllOrganizationEventsResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["events", "links", ], str]):
