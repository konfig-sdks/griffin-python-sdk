...
class TransactionsListBalanceChangesResponseAccountTransactionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            account_transaction_url = schemas.StrSchema
            post_datetime = schemas.DateTimeSchema
            
            
            class balance_change_direction(
                schemas.EnumBase,
                schemas.StrSchema
            ):
            ...
            @staticmethod
            def balance_change() -> typing.Type['TransactionsListBalanceChangesResponseAccountTransactionsItemBalanceChange']:
                return TransactionsListBalanceChangesResponseAccountTransactionsItemBalanceChange
        
            @staticmethod
            def account_balance() -> typing.Type['TransactionsListBalanceChangesResponseAccountTransactionsItemAccountBalance']:
                return TransactionsListBalanceChangesResponseAccountTransactionsItemAccountBalance
            payment_url = schemas.StrSchema
            reference = schemas.StrSchema
            __annotations__ = {
                "account-transaction-url": account_transaction_url,
                "post-datetime": post_datetime,
                "balance-change-direction": balance_change_direction,
                "transaction-origin-type": transaction_origin_type,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["account-transaction-url"]) -> MetaOapg.properties.account_transaction_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["post-datetime"]) -> MetaOapg.properties.post_datetime: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["balance-change-direction"]) -> MetaOapg.properties.balance_change_direction: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["transaction-origin-type"]) -> MetaOapg.properties.transaction_origin_type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["account-url"]) -> MetaOapg.properties.account_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["balance-change"]) -> 'TransactionsListBalanceChangesResponseAccountTransactionsItemBalanceChange': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["account-balance"]) -> 'TransactionsListBalanceChangesResponseAccountTransactionsItemAccountBalance': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account-transaction-url", "post-datetime", "balance-change-direction", "transaction-origin-type", "account-url", "balance-change", "account-balance", "payment-url", "reference", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["account-transaction-url"]) -> MetaOapg.properties.account_transaction_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["post-datetime"]) -> MetaOapg.properties.post_datetime: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["balance-change-direction"]) -> MetaOapg.properties.balance_change_direction: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["transaction-origin-type"]) -> MetaOapg.properties.transaction_origin_type: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["account-url"]) -> MetaOapg.properties.account_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["balance-change"]) -> 'TransactionsListBalanceChangesResponseAccountTransactionsItemBalanceChange': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["account-balance"]) -> 'TransactionsListBalanceChangesResponseAccountTransactionsItemAccountBalance': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment-url"]) -> typing.Union[MetaOapg.properties.payment_url, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account-transaction-url", "post-datetime", "balance-change-direction", "transaction-origin-type", "account-url", "balance-change", "account-balance", "payment-url", "reference", ], str]):
    ...
    ) -> 'TransactionsListBalanceChangesResponseAccountTransactionsItem':
