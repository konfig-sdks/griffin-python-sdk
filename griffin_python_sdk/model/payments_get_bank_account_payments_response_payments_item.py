...
class PaymentsGetBankAccountPaymentsResponsePaymentsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def creditor() -> typing.Type['PaymentsGetBankAccountPaymentsResponsePaymentsItemCreditor']:
                return PaymentsGetBankAccountPaymentsResponsePaymentsItemCreditor
            ...
            @staticmethod
            def payment_amount() -> typing.Type['PaymentsGetBankAccountPaymentsResponsePaymentsItemPaymentAmount']:
                return PaymentsGetBankAccountPaymentsResponsePaymentsItemPaymentAmount
        
            @staticmethod
            def debtor() -> typing.Type['PaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor']:
                return PaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor
            ...
            @staticmethod
            def ultimate_debtor() -> typing.Type['PaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor']:
                return PaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor
    ...
    debtor: 'PaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor'
    creditor: 'PaymentsGetBankAccountPaymentsResponsePaymentsItemCreditor'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["creditor"]) -> 'PaymentsGetBankAccountPaymentsResponsePaymentsItemCreditor': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment-amount"]) -> 'PaymentsGetBankAccountPaymentsResponsePaymentsItemPaymentAmount': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["debtor"]) -> 'PaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment-reference"]) -> MetaOapg.properties.payment_reference: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ultimate-debtor"]) -> 'PaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["creditor"]) -> 'PaymentsGetBankAccountPaymentsResponsePaymentsItemCreditor': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment-amount"]) -> 'PaymentsGetBankAccountPaymentsResponsePaymentsItemPaymentAmount': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["debtor"]) -> 'PaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ultimate-debtor"]) -> typing.Union['PaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor', schemas.Unset]: ...
    ...
    ) -> 'PaymentsGetBankAccountPaymentsResponsePaymentsItem':
