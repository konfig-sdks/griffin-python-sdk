...
class RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationDirector(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["companies-house-url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["companies-house-url", ], str]):
    ...
    ) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationDirector':
