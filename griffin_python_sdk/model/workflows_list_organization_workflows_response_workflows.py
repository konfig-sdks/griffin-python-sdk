...
class WorkflowsListOrganizationWorkflowsResponseWorkflows(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['WorkflowsListOrganizationWorkflowsResponseWorkflowsItem']:
            return WorkflowsListOrganizationWorkflowsResponseWorkflowsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['WorkflowsListOrganizationWorkflowsResponseWorkflowsItem'], typing.List['WorkflowsListOrganizationWorkflowsResponseWorkflowsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'WorkflowsListOrganizationWorkflowsResponseWorkflows':
    ...
    def __getitem__(self, i: int) -> 'WorkflowsListOrganizationWorkflowsResponseWorkflowsItem':
