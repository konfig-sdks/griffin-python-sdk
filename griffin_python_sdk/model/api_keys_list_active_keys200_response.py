...
class ApiKeysListActiveKeys200Response(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def api_keys() -> typing.Type['ApiKeysListActiveKeys200ResponseApiKeys']:
                return ApiKeysListActiveKeys200ResponseApiKeys
        
            @staticmethod
            def links() -> typing.Type['ApiKeysListActiveKeys200ResponseLinks']:
                return ApiKeysListActiveKeys200ResponseLinks
            __annotations__ = {
                "api-keys": api_keys,
                "links": links,
            }
    
    links: 'ApiKeysListActiveKeys200ResponseLinks'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["api-keys"]) -> 'ApiKeysListActiveKeys200ResponseApiKeys': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'ApiKeysListActiveKeys200ResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["api-keys", "links", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["api-keys"]) -> 'ApiKeysListActiveKeys200ResponseApiKeys': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'ApiKeysListActiveKeys200ResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["api-keys", "links", ], str]):
