...
class PooledAccountMembershipListLegalPersonsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def pool_members() -> typing.Type['PooledAccountMembershipListLegalPersonsResponsePoolMembers']:
                return PooledAccountMembershipListLegalPersonsResponsePoolMembers
        
            @staticmethod
            def links() -> typing.Type['PooledAccountMembershipListLegalPersonsResponseLinks']:
                return PooledAccountMembershipListLegalPersonsResponseLinks
        
            @staticmethod
            def meta() -> typing.Type['PooledAccountMembershipListLegalPersonsResponseMeta']:
                return PooledAccountMembershipListLegalPersonsResponseMeta
        
            @staticmethod
            def included() -> typing.Type['PooledAccountMembershipListLegalPersonsResponseIncluded']:
                return PooledAccountMembershipListLegalPersonsResponseIncluded
            __annotations__ = {
    ...
    links: 'PooledAccountMembershipListLegalPersonsResponseLinks'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["pool-members"]) -> 'PooledAccountMembershipListLegalPersonsResponsePoolMembers': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'PooledAccountMembershipListLegalPersonsResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'PooledAccountMembershipListLegalPersonsResponseMeta': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["included"]) -> 'PooledAccountMembershipListLegalPersonsResponseIncluded': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["pool-members", "links", "meta", "included", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pool-members"]) -> 'PooledAccountMembershipListLegalPersonsResponsePoolMembers': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'PooledAccountMembershipListLegalPersonsResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['PooledAccountMembershipListLegalPersonsResponseMeta', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["included"]) -> typing.Union['PooledAccountMembershipListLegalPersonsResponseIncluded', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["pool-members", "links", "meta", "included", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        links: 'PooledAccountMembershipListLegalPersonsResponseLinks',
        meta: typing.Union['PooledAccountMembershipListLegalPersonsResponseMeta', schemas.Unset] = schemas.unset,
        included: typing.Union['PooledAccountMembershipListLegalPersonsResponseIncluded', schemas.Unset] = schemas.unset,
