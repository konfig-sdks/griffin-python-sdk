...
class DecisionsListForLegalPersonResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def decisions() -> typing.Type['DecisionsListForLegalPersonResponseDecisions']:
                return DecisionsListForLegalPersonResponseDecisions
        
            @staticmethod
            def links() -> typing.Type['DecisionsListForLegalPersonResponseLinks']:
                return DecisionsListForLegalPersonResponseLinks
            __annotations__ = {
                "decisions": decisions,
                "links": links,
            }
    
    decisions: 'DecisionsListForLegalPersonResponseDecisions'
    links: 'DecisionsListForLegalPersonResponseLinks'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["decisions"]) -> 'DecisionsListForLegalPersonResponseDecisions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'DecisionsListForLegalPersonResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["decisions", "links", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["decisions"]) -> 'DecisionsListForLegalPersonResponseDecisions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'DecisionsListForLegalPersonResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["decisions", "links", ], str]):
