...
class NavigationGlobalPathsFetchResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            organizations_url = schemas.StrSchema
            users_url = schemas.StrSchema
            roles_url = schemas.StrSchema
            session_url = schemas.StrSchema
            api_key_url = schemas.StrSchema
            ...
            __annotations__ = {
                ...
                "api-key-url": api_key_url,
                "organization-url": organization_url,
            }
    
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["organizations-url"]) -> MetaOapg.properties.organizations_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["users-url"]) -> MetaOapg.properties.users_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["roles-url"]) -> MetaOapg.properties.roles_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["session-url"]) -> MetaOapg.properties.session_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["api-key-url"]) -> MetaOapg.properties.api_key_url: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["organizations-url", "users-url", "roles-url", "session-url", "api-key-url", "organization-url", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["organizations-url"]) -> MetaOapg.properties.organizations_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["users-url"]) -> MetaOapg.properties.users_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["roles-url"]) -> MetaOapg.properties.roles_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["session-url"]) -> typing.Union[MetaOapg.properties.session_url, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["api-key-url"]) -> typing.Union[MetaOapg.properties.api_key_url, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["organization-url"]) -> typing.Union[MetaOapg.properties.organization_url, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["organizations-url", "users-url", "roles-url", "session-url", "api-key-url", "organization-url", ], str]):
