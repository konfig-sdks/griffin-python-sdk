...
class ApiKeysListActiveKeys200ResponseApiKeys(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ApiKeysListActiveKeys200ResponseApiKeysItem']:
            return ApiKeysListActiveKeys200ResponseApiKeysItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ApiKeysListActiveKeys200ResponseApiKeysItem'], typing.List['ApiKeysListActiveKeys200ResponseApiKeysItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ApiKeysListActiveKeys200ResponseApiKeys':
    ...
    def __getitem__(self, i: int) -> 'ApiKeysListActiveKeys200ResponseApiKeysItem':
