...
class TransactionsListBalanceChangesResponseAccountTransactionsItemAccountBalance(
    schemas.DictSchema
):
    """
    ...
    ) -> 'TransactionsListBalanceChangesResponseAccountTransactionsItemAccountBalance':
