...
class RolesGetMembershipRolesResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def roles() -> typing.Type['RolesGetMembershipRolesResponseRoles']:
                return RolesGetMembershipRolesResponseRoles
            __annotations__ = {
                "roles": roles,
            }
    
    roles: 'RolesGetMembershipRolesResponseRoles'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["roles"]) -> 'RolesGetMembershipRolesResponseRoles': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["roles"]) -> 'RolesGetMembershipRolesResponseRoles': ...
