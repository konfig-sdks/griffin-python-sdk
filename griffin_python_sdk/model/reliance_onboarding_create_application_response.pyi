...
class RelianceOnboardingCreateApplicationResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["onboarding-application-url", "onboarding-application-status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["onboarding-application-url", "onboarding-application-status", ], str]):
