...
class RolesListAllRolesResponseRoles(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RolesListAllRolesResponseRolesItem']:
            return RolesListAllRolesResponseRolesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['RolesListAllRolesResponseRolesItem'], typing.List['RolesListAllRolesResponseRolesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'RolesListAllRolesResponseRoles':
    ...
    def __getitem__(self, i: int) -> 'RolesListAllRolesResponseRolesItem':
