...
class LegalPersonsListLegalPersonsResponseIncludedVerifications(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['LegalPersonsListLegalPersonsResponseIncludedVerificationsItem']:
            return LegalPersonsListLegalPersonsResponseIncludedVerificationsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['LegalPersonsListLegalPersonsResponseIncludedVerificationsItem'], typing.List['LegalPersonsListLegalPersonsResponseIncludedVerificationsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'LegalPersonsListLegalPersonsResponseIncludedVerifications':
    ...
    def __getitem__(self, i: int) -> 'LegalPersonsListLegalPersonsResponseIncludedVerificationsItem':
