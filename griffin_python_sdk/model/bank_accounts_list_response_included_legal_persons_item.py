...
class BankAccountsListResponseIncludedLegalPersonsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def latest_decision() -> typing.Type['BankAccountsListResponseIncludedLegalPersonsItemLatestDecision']:
                return BankAccountsListResponseIncludedLegalPersonsItemLatestDecision
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["latest-decision"]) -> 'BankAccountsListResponseIncludedLegalPersonsItemLatestDecision': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["latest-decision"]) -> typing.Union['BankAccountsListResponseIncludedLegalPersonsItemLatestDecision', schemas.Unset]: ...
    ...
    ) -> 'BankAccountsListResponseIncludedLegalPersonsItem':
