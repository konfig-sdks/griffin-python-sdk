...
class BankAccountsListResponseIncluded(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def legal_persons() -> typing.Type['BankAccountsListResponseIncludedLegalPersons']:
                return BankAccountsListResponseIncludedLegalPersons
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["legal-persons"]) -> 'BankAccountsListResponseIncludedLegalPersons': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["legal-persons", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["legal-persons"]) -> 'BankAccountsListResponseIncludedLegalPersons': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["legal-persons", ], str]):
    ...
    ) -> 'BankAccountsListResponseIncluded':
