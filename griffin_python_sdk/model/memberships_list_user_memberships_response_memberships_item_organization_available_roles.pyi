...
class MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRoles(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem']:
            return MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem'], typing.List['MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRoles':
    ...
    def __getitem__(self, i: int) -> 'MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem':
