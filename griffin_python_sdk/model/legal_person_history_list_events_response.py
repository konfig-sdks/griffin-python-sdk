...
class LegalPersonHistoryListEventsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def legal_person_history() -> typing.Type['LegalPersonHistoryListEventsResponseLegalPersonHistory']:
                return LegalPersonHistoryListEventsResponseLegalPersonHistory
        
            @staticmethod
            def links() -> typing.Type['LegalPersonHistoryListEventsResponseLinks']:
                return LegalPersonHistoryListEventsResponseLinks
            __annotations__ = {
                "legal-person-history": legal_person_history,
                "links": links,
            }
    
    links: 'LegalPersonHistoryListEventsResponseLinks'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["legal-person-history"]) -> 'LegalPersonHistoryListEventsResponseLegalPersonHistory': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'LegalPersonHistoryListEventsResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["legal-person-history", "links", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["legal-person-history"]) -> 'LegalPersonHistoryListEventsResponseLegalPersonHistory': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'LegalPersonHistoryListEventsResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["legal-person-history", "links", ], str]):
