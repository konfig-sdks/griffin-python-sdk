...
class MembershipsGetMembershipInfoResponseOrganizationAvailableRoles(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MembershipsGetMembershipInfoResponseOrganizationAvailableRolesItem']:
            return MembershipsGetMembershipInfoResponseOrganizationAvailableRolesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['MembershipsGetMembershipInfoResponseOrganizationAvailableRolesItem'], typing.List['MembershipsGetMembershipInfoResponseOrganizationAvailableRolesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'MembershipsGetMembershipInfoResponseOrganizationAvailableRoles':
    ...
    def __getitem__(self, i: int) -> 'MembershipsGetMembershipInfoResponseOrganizationAvailableRolesItem':
