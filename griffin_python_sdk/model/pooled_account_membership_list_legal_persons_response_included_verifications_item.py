...
class PooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            verification_checks_url = schemas.StrSchema
            ...
            class verification_status(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        ...
                        "pending": "PENDING",
                        "checks-declined": "CHECKSDECLINED",
                        "checks-complete": "CHECKSCOMPLETE",
                        "failed": "FAILED",
                    }
                ...
                @schemas.classproperty
                def CHECKSDECLINED(cls):
                    return cls("checks-declined")
                
                @schemas.classproperty
                def CHECKSCOMPLETE(cls):
                    return cls("checks-complete")
                
                @schemas.classproperty
                def FAILED(cls):
                    return cls("failed")
            updated_at = schemas.DateTimeSchema
            workflow_url = schemas.StrSchema
            ...
            class risk_rating(
                ...
                def LOWRISK(cls):
                    return cls("low-risk")
            verification_risk_assessments_url = schemas.StrSchema
            __annotations__ = {
                "verification-url": verification_url,
                "legal-person-url": legal_person_url,
                "created-at": created_at,
                "verification-checks-url": verification_checks_url,
                "verification-status": verification_status,
                "updated-at": updated_at,
                "workflow-url": workflow_url,
                "risk-rating": risk_rating,
                "verification-risk-assessments-url": verification_risk_assessments_url,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["verification-checks-url"]) -> MetaOapg.properties.verification_checks_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["verification-status"]) -> MetaOapg.properties.verification_status: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["updated-at"]) -> MetaOapg.properties.updated_at: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workflow-url"]) -> MetaOapg.properties.workflow_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["risk-rating"]) -> MetaOapg.properties.risk_rating: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["verification-risk-assessments-url"]) -> MetaOapg.properties.verification_risk_assessments_url: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["verification-url", "legal-person-url", "created-at", "verification-checks-url", "verification-status", "updated-at", "workflow-url", "risk-rating", "verification-risk-assessments-url", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["verification-checks-url"]) -> MetaOapg.properties.verification_checks_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["verification-status"]) -> MetaOapg.properties.verification_status: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["workflow-url"]) -> typing.Union[MetaOapg.properties.workflow_url, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["risk-rating"]) -> typing.Union[MetaOapg.properties.risk_rating, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["verification-risk-assessments-url"]) -> typing.Union[MetaOapg.properties.verification_risk_assessments_url, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["verification-url", "legal-person-url", "created-at", "verification-checks-url", "verification-status", "updated-at", "workflow-url", "risk-rating", "verification-risk-assessments-url", ], str]):
    ...
    ) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem':
