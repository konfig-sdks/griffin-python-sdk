...
class RolesListAllRolesResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def roles() -> typing.Type['RolesListAllRolesResponseRoles']:
                return RolesListAllRolesResponseRoles
            __annotations__ = {
                "roles": roles,
            }
    
    roles: 'RolesListAllRolesResponseRoles'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["roles"]) -> 'RolesListAllRolesResponseRoles': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["roles"]) -> 'RolesListAllRolesResponseRoles': ...
