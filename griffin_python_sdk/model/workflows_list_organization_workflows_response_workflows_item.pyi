...
class WorkflowsListOrganizationWorkflowsResponseWorkflowsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def required_claim_types() -> typing.Type['WorkflowsListOrganizationWorkflowsResponseWorkflowsItemRequiredClaimTypes']:
                return WorkflowsListOrganizationWorkflowsResponseWorkflowsItemRequiredClaimTypes
        
            @staticmethod
            def workflow_rules() -> typing.Type['WorkflowsListOrganizationWorkflowsResponseWorkflowsItemWorkflowRules']:
                return WorkflowsListOrganizationWorkflowsResponseWorkflowsItemWorkflowRules
            __annotations__ = {
                "workflow-url": workflow_url,
                "display-name": display_name,
                "legal-person-type": legal_person_type,
                "created-at": created_at,
                "required-claim-types": required_claim_types,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["required-claim-types"]) -> 'WorkflowsListOrganizationWorkflowsResponseWorkflowsItemRequiredClaimTypes': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workflow-rules"]) -> 'WorkflowsListOrganizationWorkflowsResponseWorkflowsItemWorkflowRules': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["workflow-url", "display-name", "legal-person-type", "created-at", "required-claim-types", "workflow-rules", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["workflow-url"]) -> MetaOapg.properties.workflow_url: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["required-claim-types"]) -> typing.Union['WorkflowsListOrganizationWorkflowsResponseWorkflowsItemRequiredClaimTypes', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["workflow-rules"]) -> typing.Union['WorkflowsListOrganizationWorkflowsResponseWorkflowsItemWorkflowRules', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["workflow-url", "display-name", "legal-person-type", "created-at", "required-claim-types", "workflow-rules", ], str]):
    ...
    ) -> 'WorkflowsListOrganizationWorkflowsResponseWorkflowsItem':
