...
class PayeesListLegalPersonPayeesResponsePayeesItem(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payee-status"]) -> MetaOapg.properties.payee_status: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["payee-url", "account-number", "account-holder", "legal-person-url", "bank-id", "created-at", "payee-status", "country-code", "account-url", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payee-status"]) -> MetaOapg.properties.payee_status: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["country-code"]) -> MetaOapg.properties.country_code: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["account-url"]) -> typing.Union[MetaOapg.properties.account_url, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["payee-url", "account-number", "account-holder", "legal-person-url", "bank-id", "created-at", "payee-status", "country-code", "account-url", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'PayeesListLegalPersonPayeesResponsePayeesItem':
        return super().__new__(
            cls,
            *args,
            _configuration=_configuration,
