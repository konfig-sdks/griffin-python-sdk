...
class PaymentsListSubmissions200ResponseSubmissionsItemSubmissionSchemeInformation(
    ...
    class MetaOapg:
        ...
        class any_of_0(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class end_to_end_identification(
                        schemas.StrSchema
                    ):
                    ...
                    class scheme_status_code_description(
                        schemas.StrSchema
                    ):
                    ...
                    __annotations__ = {
                        ...
                        "scheme-status-code": scheme_status_code,
                        "scheme-status-code-description": scheme_status_code_description,
                        "payment-scheme": payment_scheme,
                    }
            
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["end-to-end-identification"]) -> MetaOapg.properties.end_to_end_identification: ...
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["scheme-status-code"]) -> MetaOapg.properties.scheme_status_code: ...
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["scheme-status-code-description"]) -> MetaOapg.properties.scheme_status_code_description: ...
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["payment-scheme"]) -> MetaOapg.properties.payment_scheme: ...
            
            @typing.overload
            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
            
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["end-to-end-identification", "scheme-status-code", "scheme-status-code-description", "payment-scheme", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["end-to-end-identification"]) -> MetaOapg.properties.end_to_end_identification: ...
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["scheme-status-code"]) -> typing.Union[MetaOapg.properties.scheme_status_code, schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["scheme-status-code-description"]) -> typing.Union[MetaOapg.properties.scheme_status_code_description, schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["payment-scheme"]) -> MetaOapg.properties.payment_scheme: ...
            
            @typing.overload
            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
            
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["end-to-end-identification", "scheme-status-code", "scheme-status-code-description", "payment-scheme", ], str]):
        ...
        class any_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["payment-scheme", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["payment-scheme", ], str]):
                return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'PaymentsListSubmissions200ResponseSubmissionsItemSubmissionSchemeInformation':
        return super().__new__(
            cls,
            *args,
            _configuration=_configuration,
