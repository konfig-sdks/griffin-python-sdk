...
class PooledAccountMembershipListLegalPersonsResponsePoolMembersItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created-at", "legal-person-url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created-at", "legal-person-url", ], str]):
    ...
    ) -> 'PooledAccountMembershipListLegalPersonsResponsePoolMembersItem':
