...
class MembershipsListOrganizationMembershipsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def memberships() -> typing.Type['MembershipsListOrganizationMembershipsResponseMemberships']:
                return MembershipsListOrganizationMembershipsResponseMemberships
        
            @staticmethod
            def links() -> typing.Type['MembershipsListOrganizationMembershipsResponseLinks']:
                return MembershipsListOrganizationMembershipsResponseLinks
            __annotations__ = {
                "memberships": memberships,
                "links": links,
            }
    
    links: 'MembershipsListOrganizationMembershipsResponseLinks'
    memberships: 'MembershipsListOrganizationMembershipsResponseMemberships'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["memberships"]) -> 'MembershipsListOrganizationMembershipsResponseMemberships': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'MembershipsListOrganizationMembershipsResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["memberships", "links", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["memberships"]) -> 'MembershipsListOrganizationMembershipsResponseMemberships': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'MembershipsListOrganizationMembershipsResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["memberships", "links", ], str]):
