...
class LegalPersonsListLegalPersonsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def legal_persons() -> typing.Type['LegalPersonsListLegalPersonsResponseLegalPersons']:
                return LegalPersonsListLegalPersonsResponseLegalPersons
        
            @staticmethod
            def links() -> typing.Type['LegalPersonsListLegalPersonsResponseLinks']:
                return LegalPersonsListLegalPersonsResponseLinks
        
            @staticmethod
            def meta() -> typing.Type['LegalPersonsListLegalPersonsResponseMeta']:
                return LegalPersonsListLegalPersonsResponseMeta
        
            @staticmethod
            def included() -> typing.Type['LegalPersonsListLegalPersonsResponseIncluded']:
                return LegalPersonsListLegalPersonsResponseIncluded
            __annotations__ = {
    ...
    links: 'LegalPersonsListLegalPersonsResponseLinks'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["legal-persons"]) -> 'LegalPersonsListLegalPersonsResponseLegalPersons': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'LegalPersonsListLegalPersonsResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'LegalPersonsListLegalPersonsResponseMeta': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["included"]) -> 'LegalPersonsListLegalPersonsResponseIncluded': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["legal-persons", "links", "meta", "included", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["legal-persons"]) -> 'LegalPersonsListLegalPersonsResponseLegalPersons': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'LegalPersonsListLegalPersonsResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['LegalPersonsListLegalPersonsResponseMeta', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["included"]) -> typing.Union['LegalPersonsListLegalPersonsResponseIncluded', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["legal-persons", "links", "meta", "included", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        links: 'LegalPersonsListLegalPersonsResponseLinks',
        meta: typing.Union['LegalPersonsListLegalPersonsResponseMeta', schemas.Unset] = schemas.unset,
        included: typing.Union['LegalPersonsListLegalPersonsResponseIncluded', schemas.Unset] = schemas.unset,
