...
class RelianceOnboardingCreateApplicationRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def subject_profile() -> typing.Type['RelianceOnboardingCreateApplicationRequestSubjectProfile']:
                return RelianceOnboardingCreateApplicationRequestSubjectProfile
        
            @staticmethod
            def related_profiles() -> typing.Type['RelianceOnboardingCreateApplicationRequestRelatedProfiles']:
                return RelianceOnboardingCreateApplicationRequestRelatedProfiles
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subject-profile"]) -> 'RelianceOnboardingCreateApplicationRequestSubjectProfile': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["related-profiles"]) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfiles': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["workflow-url", "subject-profile", "related-profiles", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subject-profile"]) -> 'RelianceOnboardingCreateApplicationRequestSubjectProfile': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["related-profiles"]) -> typing.Union['RelianceOnboardingCreateApplicationRequestRelatedProfiles', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["workflow-url", "subject-profile", "related-profiles", ], str]):
