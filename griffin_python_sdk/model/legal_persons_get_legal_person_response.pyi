...
class LegalPersonsGetLegalPersonResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def latest_decision() -> typing.Type['LegalPersonsGetLegalPersonResponseLatestDecision']:
                return LegalPersonsGetLegalPersonResponseLatestDecision
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["latest-decision"]) -> 'LegalPersonsGetLegalPersonResponseLatestDecision': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["latest-decision"]) -> typing.Union['LegalPersonsGetLegalPersonResponseLatestDecision', schemas.Unset]: ...
