...
class ClaimsGetAllClaimsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def claims() -> typing.Type['ClaimsGetAllClaimsResponseClaims']:
                return ClaimsGetAllClaimsResponseClaims
        
            @staticmethod
            def links() -> typing.Type['ClaimsGetAllClaimsResponseLinks']:
                return ClaimsGetAllClaimsResponseLinks
            __annotations__ = {
                "claims": claims,
                "links": links,
            }
    
    claims: 'ClaimsGetAllClaimsResponseClaims'
    links: 'ClaimsGetAllClaimsResponseLinks'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["claims"]) -> 'ClaimsGetAllClaimsResponseClaims': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'ClaimsGetAllClaimsResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["claims", "links", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["claims"]) -> 'ClaimsGetAllClaimsResponseClaims': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'ClaimsGetAllClaimsResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["claims", "links", ], str]):
