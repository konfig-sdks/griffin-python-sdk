...
class OrganizationsGetDetailsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available_roles() -> typing.Type['OrganizationsGetDetailsResponseAvailableRoles']:
                return OrganizationsGetDetailsResponseAvailableRoles
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available-roles"]) -> 'OrganizationsGetDetailsResponseAvailableRoles': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available-roles"]) -> 'OrganizationsGetDetailsResponseAvailableRoles': ...
