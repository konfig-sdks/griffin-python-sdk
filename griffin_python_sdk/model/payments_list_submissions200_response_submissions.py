...
class PaymentsListSubmissions200ResponseSubmissions(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PaymentsListSubmissions200ResponseSubmissionsItem']:
            return PaymentsListSubmissions200ResponseSubmissionsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PaymentsListSubmissions200ResponseSubmissionsItem'], typing.List['PaymentsListSubmissions200ResponseSubmissionsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PaymentsListSubmissions200ResponseSubmissions':
    ...
    def __getitem__(self, i: int) -> 'PaymentsListSubmissions200ResponseSubmissionsItem':
