...
class PooledAccountMembershipListLegalPersonsResponseIncluded(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def verifications() -> typing.Type['PooledAccountMembershipListLegalPersonsResponseIncludedVerifications']:
                return PooledAccountMembershipListLegalPersonsResponseIncludedVerifications
        
            @staticmethod
            def risk_rating_entries() -> typing.Type['PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntries']:
                return PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntries
        
            @staticmethod
            def legal_persons() -> typing.Type['PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersons']:
                return PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersons
            __annotations__ = {
                "verifications": verifications,
                "risk-rating-entries": risk_rating_entries,
                "legal-persons": legal_persons,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["verifications"]) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedVerifications': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["risk-rating-entries"]) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntries': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["legal-persons"]) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersons': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["verifications", "risk-rating-entries", "legal-persons", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["verifications"]) -> typing.Union['PooledAccountMembershipListLegalPersonsResponseIncludedVerifications', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["risk-rating-entries"]) -> typing.Union['PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntries', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["legal-persons"]) -> typing.Union['PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersons', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["verifications", "risk-rating-entries", "legal-persons", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        verifications: typing.Union['PooledAccountMembershipListLegalPersonsResponseIncludedVerifications', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'PooledAccountMembershipListLegalPersonsResponseIncluded':
