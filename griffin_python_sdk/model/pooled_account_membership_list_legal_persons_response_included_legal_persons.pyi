...
class PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersons(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem']:
            return PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem'], typing.List['PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersons':
    ...
    def __getitem__(self, i: int) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem':
