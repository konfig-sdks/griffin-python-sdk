...
class ApiKeysListActiveKeysResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def api_keys() -> typing.Type['ApiKeysListActiveKeysResponseApiKeys']:
                return ApiKeysListActiveKeysResponseApiKeys
        
            @staticmethod
            def links() -> typing.Type['ApiKeysListActiveKeysResponseLinks']:
                return ApiKeysListActiveKeysResponseLinks
            __annotations__ = {
                "api-keys": api_keys,
                "links": links,
            }
    
    links: 'ApiKeysListActiveKeysResponseLinks'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["api-keys"]) -> 'ApiKeysListActiveKeysResponseApiKeys': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'ApiKeysListActiveKeysResponseLinks': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["api-keys"]) -> 'ApiKeysListActiveKeysResponseApiKeys': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'ApiKeysListActiveKeysResponseLinks': ...
