...
class MembershipsListUserMembershipsResponseMembershipsItemOrganization(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available_roles() -> typing.Type['MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRoles']:
                return MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRoles
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available-roles"]) -> 'MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRoles': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available-roles"]) -> 'MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRoles': ...
    ...
    ) -> 'MembershipsListUserMembershipsResponseMembershipsItemOrganization':
