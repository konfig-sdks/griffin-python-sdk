...
class MembershipsListOrganizationMembershipsResponseMembershipsItemRoles(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MembershipsListOrganizationMembershipsResponseMembershipsItemRolesItem']:
            return MembershipsListOrganizationMembershipsResponseMembershipsItemRolesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['MembershipsListOrganizationMembershipsResponseMembershipsItemRolesItem'], typing.List['MembershipsListOrganizationMembershipsResponseMembershipsItemRolesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItemRoles':
    ...
    def __getitem__(self, i: int) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItemRolesItem':
