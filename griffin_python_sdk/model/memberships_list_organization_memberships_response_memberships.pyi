...
class MembershipsListOrganizationMembershipsResponseMemberships(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MembershipsListOrganizationMembershipsResponseMembershipsItem']:
            return MembershipsListOrganizationMembershipsResponseMembershipsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['MembershipsListOrganizationMembershipsResponseMembershipsItem'], typing.List['MembershipsListOrganizationMembershipsResponseMembershipsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'MembershipsListOrganizationMembershipsResponseMemberships':
    ...
    def __getitem__(self, i: int) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItem':
