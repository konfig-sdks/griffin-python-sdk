...
class WebhooksGetLatestTestStatusResponse(
    ...
    class MetaOapg:
        ...
        class any_of_0(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    __annotations__ = {
                        "webhook-request-status": webhook_request_status,
                        "updated-at": updated_at,
                    }
            
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["webhook-request-status"]) -> MetaOapg.properties.webhook_request_status: ...
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["webhook-request-status", "updated-at", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["webhook-request-status"]) -> MetaOapg.properties.webhook_request_status: ...
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["webhook-request-status", "updated-at", ], str]):
        ...
        class any_of_1(
                ...
                class properties:
                    ...
                    class webhook_request_status(
                        ...
                        def COMPLETE(cls):
                            return cls("complete")
                    updated_at = schemas.DateTimeSchema
                    webhook_http_status = schemas.Int64Schema
                    
                    
                    class webhook_error_code(
                        schemas.EnumBase,
                        schemas.StrSchema
                    ):
                        ...
                        class MetaOapg:
                            enum_value_to_name = {
                                ...
                                "webhook-unknown-host": "UNKNOWNHOST",
                                "webhook-unknown-error": "UNKNOWNERROR",
                                "webhook-invalid-response": "INVALIDRESPONSE",
                            }
                        
                        @schemas.classproperty
                        def TIMEOUT(cls):
                            return cls("webhook-timeout")
                        
                        @schemas.classproperty
                        def UNKNOWNHOST(cls):
                            return cls("webhook-unknown-host")
                        
                        @schemas.classproperty
                        def UNKNOWNERROR(cls):
                            return cls("webhook-unknown-error")
                        
                        @schemas.classproperty
                        def INVALIDRESPONSE(cls):
                            return cls("webhook-invalid-response")
                    __annotations__ = {
                        "webhook-request-status": webhook_request_status,
                        "updated-at": updated_at,
                        "webhook-http-status": webhook_http_status,
                        "webhook-error-code": webhook_error_code,
                    }
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["webhook-http-status"]) -> MetaOapg.properties.webhook_http_status: ...
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["webhook-error-code"]) -> MetaOapg.properties.webhook_error_code: ...
            
            @typing.overload
            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
            
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["webhook-request-status", "updated-at", "webhook-http-status", "webhook-error-code", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["webhook-http-status"]) -> MetaOapg.properties.webhook_http_status: ...
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["webhook-error-code"]) -> MetaOapg.properties.webhook_error_code: ...
            
            @typing.overload
            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
            
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["webhook-request-status", "updated-at", "webhook-http-status", "webhook-error-code", ], str]):
                return super().get_item_oapg(name)
