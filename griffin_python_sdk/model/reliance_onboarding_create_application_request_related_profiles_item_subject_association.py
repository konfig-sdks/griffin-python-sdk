...
class RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociation(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def director() -> typing.Type['RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationDirector']:
                return RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationDirector
        
            @staticmethod
            def psc() -> typing.Type['RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationPsc']:
                return RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationPsc
            senior_manager = schemas.DictSchema
            __annotations__ = {
                "director": director,
                "psc": psc,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["director"]) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationDirector': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["psc"]) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationPsc': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["director", "psc", "senior-manager", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["director"]) -> typing.Union['RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationDirector', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["psc"]) -> typing.Union['RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationPsc', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["director", "psc", "senior-manager", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        director: typing.Union['RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationDirector', schemas.Unset] = schemas.unset,
        psc: typing.Union['RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationPsc', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociation':
