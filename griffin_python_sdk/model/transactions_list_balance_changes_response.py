...
class TransactionsListBalanceChangesResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def account_transactions() -> typing.Type['TransactionsListBalanceChangesResponseAccountTransactions']:
                return TransactionsListBalanceChangesResponseAccountTransactions
        
            @staticmethod
            def links() -> typing.Type['TransactionsListBalanceChangesResponseLinks']:
                return TransactionsListBalanceChangesResponseLinks
        
            @staticmethod
            def included() -> typing.Type['TransactionsListBalanceChangesResponseIncluded']:
                return TransactionsListBalanceChangesResponseIncluded
            __annotations__ = {
    ...
    links: 'TransactionsListBalanceChangesResponseLinks'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["account-transactions"]) -> 'TransactionsListBalanceChangesResponseAccountTransactions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'TransactionsListBalanceChangesResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["included"]) -> 'TransactionsListBalanceChangesResponseIncluded': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account-transactions", "links", "included", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["account-transactions"]) -> 'TransactionsListBalanceChangesResponseAccountTransactions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'TransactionsListBalanceChangesResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["included"]) -> typing.Union['TransactionsListBalanceChangesResponseIncluded', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account-transactions", "links", "included", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        links: 'TransactionsListBalanceChangesResponseLinks',
        included: typing.Union['TransactionsListBalanceChangesResponseIncluded', schemas.Unset] = schemas.unset,
