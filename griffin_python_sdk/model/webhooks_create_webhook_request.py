...
class WebhooksCreateWebhookRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["webhook-destination-url", "webhook-description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["webhook-destination-url", "webhook-description", ], str]):
