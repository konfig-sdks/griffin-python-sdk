...
class MembershipsGetMembershipInfoResponseRoles(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MembershipsGetMembershipInfoResponseRolesItem']:
            return MembershipsGetMembershipInfoResponseRolesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['MembershipsGetMembershipInfoResponseRolesItem'], typing.List['MembershipsGetMembershipInfoResponseRolesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'MembershipsGetMembershipInfoResponseRoles':
    ...
    def __getitem__(self, i: int) -> 'MembershipsGetMembershipInfoResponseRolesItem':
