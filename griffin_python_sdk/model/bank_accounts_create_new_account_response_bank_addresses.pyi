...
class BankAccountsCreateNewAccountResponseBankAddresses(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['BankAccountsCreateNewAccountResponseBankAddressesItem']:
            return BankAccountsCreateNewAccountResponseBankAddressesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['BankAccountsCreateNewAccountResponseBankAddressesItem'], typing.List['BankAccountsCreateNewAccountResponseBankAddressesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'BankAccountsCreateNewAccountResponseBankAddresses':
    ...
    def __getitem__(self, i: int) -> 'BankAccountsCreateNewAccountResponseBankAddressesItem':
