...
class PooledAccountMembershipManageLegalPersonsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        required = {
            "pooled-account-memberships-url",
        }
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["pooled-account-memberships-url", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pooled-account-memberships-url"]) -> MetaOapg.properties.pooled_account_memberships_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["pooled-account-memberships-url", ], str]):
