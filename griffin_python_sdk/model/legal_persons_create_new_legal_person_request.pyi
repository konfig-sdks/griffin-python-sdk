...
class LegalPersonsCreateNewLegalPersonRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def claims() -> typing.Type['LegalPersonsCreateNewLegalPersonRequestClaims']:
                return LegalPersonsCreateNewLegalPersonRequestClaims
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["claims"]) -> 'LegalPersonsCreateNewLegalPersonRequestClaims': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["display-name", "legal-person-type", "claims", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["claims"]) -> typing.Union['LegalPersonsCreateNewLegalPersonRequestClaims', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["display-name", "legal-person-type", "claims", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        claims: typing.Union['LegalPersonsCreateNewLegalPersonRequestClaims', schemas.Unset] = schemas.unset,
