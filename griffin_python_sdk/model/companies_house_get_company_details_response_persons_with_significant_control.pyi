...
class CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControl(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem']:
            return CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem'], typing.List['CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControl':
    ...
    def __getitem__(self, i: int) -> 'CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem':
