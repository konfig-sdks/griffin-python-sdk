...
class PaymentsListAdmissionsResponseAdmissions(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PaymentsListAdmissionsResponseAdmissionsItem']:
            return PaymentsListAdmissionsResponseAdmissionsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PaymentsListAdmissionsResponseAdmissionsItem'], typing.List['PaymentsListAdmissionsResponseAdmissionsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PaymentsListAdmissionsResponseAdmissions':
    ...
    def __getitem__(self, i: int) -> 'PaymentsListAdmissionsResponseAdmissionsItem':
