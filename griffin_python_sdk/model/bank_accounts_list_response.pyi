...
class BankAccountsListResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def accounts() -> typing.Type['BankAccountsListResponseAccounts']:
                return BankAccountsListResponseAccounts
        
            @staticmethod
            def links() -> typing.Type['BankAccountsListResponseLinks']:
                return BankAccountsListResponseLinks
        
            @staticmethod
            def included() -> typing.Type['BankAccountsListResponseIncluded']:
                return BankAccountsListResponseIncluded
            __annotations__ = {
                "accounts": accounts,
                "links": links,
                "included": included,
    ...
    links: 'BankAccountsListResponseLinks'
    accounts: 'BankAccountsListResponseAccounts'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["accounts"]) -> 'BankAccountsListResponseAccounts': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'BankAccountsListResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["included"]) -> 'BankAccountsListResponseIncluded': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accounts", "links", "included", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["accounts"]) -> 'BankAccountsListResponseAccounts': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'BankAccountsListResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["included"]) -> typing.Union['BankAccountsListResponseIncluded', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["accounts", "links", "included", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        links: 'BankAccountsListResponseLinks',
        accounts: 'BankAccountsListResponseAccounts',
        included: typing.Union['BankAccountsListResponseIncluded', schemas.Unset] = schemas.unset,
