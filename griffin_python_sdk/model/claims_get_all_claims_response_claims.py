...
class ClaimsGetAllClaimsResponseClaims(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ClaimsGetAllClaimsResponseClaimsItem']:
            return ClaimsGetAllClaimsResponseClaimsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ClaimsGetAllClaimsResponseClaimsItem'], typing.List['ClaimsGetAllClaimsResponseClaimsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ClaimsGetAllClaimsResponseClaims':
    ...
    def __getitem__(self, i: int) -> 'ClaimsGetAllClaimsResponseClaimsItem':
