...
class CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def natures_of_control() -> typing.Type['CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItemNaturesOfControl']:
                return CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItemNaturesOfControl
            ...
            __annotations__ = {
                ...
                "natures-of-control": natures_of_control,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["natures-of-control"]) -> 'CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItemNaturesOfControl': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["day-of-birth"]) -> MetaOapg.properties.day_of_birth: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["month-of-birth"]) -> MetaOapg.properties.month_of_birth: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["year-of-birth"]) -> MetaOapg.properties.year_of_birth: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["display-name", "natures-of-control", "companies-house-url", "given-name", "surname", "day-of-birth", "month-of-birth", "year-of-birth", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["natures-of-control"]) -> 'CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItemNaturesOfControl': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["companies-house-url"]) -> MetaOapg.properties.companies_house_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["given-name"]) -> typing.Union[MetaOapg.properties.given_name, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["surname"]) -> typing.Union[MetaOapg.properties.surname, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["day-of-birth"]) -> typing.Union[MetaOapg.properties.day_of_birth, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["month-of-birth"]) -> typing.Union[MetaOapg.properties.month_of_birth, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["year-of-birth"]) -> typing.Union[MetaOapg.properties.year_of_birth, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["display-name", "natures-of-control", "companies-house-url", "given-name", "surname", "day-of-birth", "month-of-birth", "year-of-birth", ], str]):
    ...
    ) -> 'CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem':
