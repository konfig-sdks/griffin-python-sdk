...
class PooledAccountMembershipListLegalPersonsResponseIncludedVerifications(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem']:
            return PooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem'], typing.List['PooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedVerifications':
    ...
    def __getitem__(self, i: int) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem':
