...
class LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntries(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItem']:
            return LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItem'], typing.List['LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntries':
    ...
    def __getitem__(self, i: int) -> 'LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItem':
