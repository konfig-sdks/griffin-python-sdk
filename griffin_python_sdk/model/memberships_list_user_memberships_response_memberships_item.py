...
class MembershipsListUserMembershipsResponseMembershipsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def organization() -> typing.Type['MembershipsListUserMembershipsResponseMembershipsItemOrganization']:
                return MembershipsListUserMembershipsResponseMembershipsItemOrganization
        
            @staticmethod
            def roles() -> typing.Type['MembershipsListUserMembershipsResponseMembershipsItemRoles']:
                return MembershipsListUserMembershipsResponseMembershipsItemRoles
        
            @staticmethod
            def user() -> typing.Type['MembershipsListUserMembershipsResponseMembershipsItemUser']:
                return MembershipsListUserMembershipsResponseMembershipsItemUser
    ...
    organization: 'MembershipsListUserMembershipsResponseMembershipsItemOrganization'
    roles: 'MembershipsListUserMembershipsResponseMembershipsItemRoles'
    user: 'MembershipsListUserMembershipsResponseMembershipsItemUser'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["organization"]) -> 'MembershipsListUserMembershipsResponseMembershipsItemOrganization': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["roles"]) -> 'MembershipsListUserMembershipsResponseMembershipsItemRoles': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["user"]) -> 'MembershipsListUserMembershipsResponseMembershipsItemUser': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["organization"]) -> 'MembershipsListUserMembershipsResponseMembershipsItemOrganization': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["roles"]) -> 'MembershipsListUserMembershipsResponseMembershipsItemRoles': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["user"]) -> 'MembershipsListUserMembershipsResponseMembershipsItemUser': ...
    ...
    ) -> 'MembershipsListUserMembershipsResponseMembershipsItem':
