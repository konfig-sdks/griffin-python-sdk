...
class RelianceOnboardingCreateApplicationRequestRelatedProfiles(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RelianceOnboardingCreateApplicationRequestRelatedProfilesItem']:
            return RelianceOnboardingCreateApplicationRequestRelatedProfilesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['RelianceOnboardingCreateApplicationRequestRelatedProfilesItem'], typing.List['RelianceOnboardingCreateApplicationRequestRelatedProfilesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfiles':
    ...
    def __getitem__(self, i: int) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItem':
