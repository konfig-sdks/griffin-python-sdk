...
class BankAccountsGetAccountResponseBankAddresses(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['BankAccountsGetAccountResponseBankAddressesItem']:
            return BankAccountsGetAccountResponseBankAddressesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['BankAccountsGetAccountResponseBankAddressesItem'], typing.List['BankAccountsGetAccountResponseBankAddressesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'BankAccountsGetAccountResponseBankAddresses':
    ...
    def __getitem__(self, i: int) -> 'BankAccountsGetAccountResponseBankAddressesItem':
