...
class LegalPersonsListLegalPersonsResponseIncluded(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def verifications() -> typing.Type['LegalPersonsListLegalPersonsResponseIncludedVerifications']:
                return LegalPersonsListLegalPersonsResponseIncludedVerifications
        
            @staticmethod
            def risk_rating_entries() -> typing.Type['LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntries']:
                return LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntries
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["verifications"]) -> 'LegalPersonsListLegalPersonsResponseIncludedVerifications': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["risk-rating-entries"]) -> 'LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntries': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["verifications", "risk-rating-entries", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["verifications"]) -> typing.Union['LegalPersonsListLegalPersonsResponseIncludedVerifications', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["risk-rating-entries"]) -> typing.Union['LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntries', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["verifications", "risk-rating-entries", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        verifications: typing.Union['LegalPersonsListLegalPersonsResponseIncludedVerifications', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'LegalPersonsListLegalPersonsResponseIncluded':
