...
class WorkflowsListOrganizationWorkflowsResponseWorkflowsItemWorkflowRules(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    "allow-zero-directors": "ZERODIRECTORS",
                    "allow-missing-directors": "MISSINGDIRECTORS",
                }
            
            @schemas.classproperty
            def ZERODIRECTORS(cls):
                return cls("allow-zero-directors")
            
            @schemas.classproperty
            def MISSINGDIRECTORS(cls):
                return cls("allow-missing-directors")

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple[typing.Union[MetaOapg.items, str, ]], typing.List[typing.Union[MetaOapg.items, str, ]]],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'WorkflowsListOrganizationWorkflowsResponseWorkflowsItemWorkflowRules':
