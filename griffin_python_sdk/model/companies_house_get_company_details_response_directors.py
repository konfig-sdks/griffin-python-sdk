...
class CompaniesHouseGetCompanyDetailsResponseDirectors(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CompaniesHouseGetCompanyDetailsResponseDirectorsItem']:
            return CompaniesHouseGetCompanyDetailsResponseDirectorsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['CompaniesHouseGetCompanyDetailsResponseDirectorsItem'], typing.List['CompaniesHouseGetCompanyDetailsResponseDirectorsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'CompaniesHouseGetCompanyDetailsResponseDirectors':
    ...
    def __getitem__(self, i: int) -> 'CompaniesHouseGetCompanyDetailsResponseDirectorsItem':
