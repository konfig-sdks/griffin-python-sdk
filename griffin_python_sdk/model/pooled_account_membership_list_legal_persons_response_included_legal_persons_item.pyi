...
class PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def latest_decision() -> typing.Type['PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision']:
                return PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["latest-decision"]) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["latest-decision"]) -> typing.Union['PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision', schemas.Unset]: ...
    ...
    ) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem':
