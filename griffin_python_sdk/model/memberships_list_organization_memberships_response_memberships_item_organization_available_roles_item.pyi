...
class MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["role-url"]) -> MetaOapg.properties.role_url: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "display-name", "role-url", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["role-url"]) -> MetaOapg.properties.role_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "display-name", "role-url", ], str]):
    ...
    ) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem':
