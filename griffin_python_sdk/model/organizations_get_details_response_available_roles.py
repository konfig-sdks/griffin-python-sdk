...
class OrganizationsGetDetailsResponseAvailableRoles(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OrganizationsGetDetailsResponseAvailableRolesItem']:
            return OrganizationsGetDetailsResponseAvailableRolesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['OrganizationsGetDetailsResponseAvailableRolesItem'], typing.List['OrganizationsGetDetailsResponseAvailableRolesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'OrganizationsGetDetailsResponseAvailableRoles':
    ...
    def __getitem__(self, i: int) -> 'OrganizationsGetDetailsResponseAvailableRolesItem':
