...
class PooledAccountMembershipListLegalPersonsResponseMetaPage(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def estimated_total() -> typing.Type['PooledAccountMembershipListLegalPersonsResponseMetaPageEstimatedTotal']:
                return PooledAccountMembershipListLegalPersonsResponseMetaPageEstimatedTotal
            __annotations__ = {
                "total": total,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["estimated-total"]) -> 'PooledAccountMembershipListLegalPersonsResponseMetaPageEstimatedTotal': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "estimated-total", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["estimated-total"]) -> typing.Union['PooledAccountMembershipListLegalPersonsResponseMetaPageEstimatedTotal', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "estimated-total", ], str]):
    ...
    ) -> 'PooledAccountMembershipListLegalPersonsResponseMetaPage':
