...
class MembershipsListUserMembershipsResponseMemberships(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MembershipsListUserMembershipsResponseMembershipsItem']:
            return MembershipsListUserMembershipsResponseMembershipsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['MembershipsListUserMembershipsResponseMembershipsItem'], typing.List['MembershipsListUserMembershipsResponseMembershipsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'MembershipsListUserMembershipsResponseMemberships':
    ...
    def __getitem__(self, i: int) -> 'MembershipsListUserMembershipsResponseMembershipsItem':
