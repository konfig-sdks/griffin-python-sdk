...
class LegalPersonHistoryListEventsResponseLegalPersonHistory(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['LegalPersonHistoryListEventsResponseLegalPersonHistoryItem']:
            return LegalPersonHistoryListEventsResponseLegalPersonHistoryItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['LegalPersonHistoryListEventsResponseLegalPersonHistoryItem'], typing.List['LegalPersonHistoryListEventsResponseLegalPersonHistoryItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'LegalPersonHistoryListEventsResponseLegalPersonHistory':
    ...
    def __getitem__(self, i: int) -> 'LegalPersonHistoryListEventsResponseLegalPersonHistoryItem':
