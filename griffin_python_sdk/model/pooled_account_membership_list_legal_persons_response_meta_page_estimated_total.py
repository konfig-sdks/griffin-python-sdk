...
class PooledAccountMembershipListLegalPersonsResponseMetaPageEstimatedTotal(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class at_least(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "10000": "POSITIVE_10000",
                    }
                
                @schemas.classproperty
                def POSITIVE_10000(cls):
                    return cls("10000")
            __annotations__ = {
                "at-least": at_least,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["at-least"]) -> MetaOapg.properties.at_least: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["at-least", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["at-least"]) -> typing.Union[MetaOapg.properties.at_least, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["at-least", ], str]):
    ...
    ) -> 'PooledAccountMembershipListLegalPersonsResponseMetaPageEstimatedTotal':
