...
class PooledAccountMembershipListLegalPersonsResponseLinks(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["prev", "next", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["prev", "next", ], str]):
    ...
    ) -> 'PooledAccountMembershipListLegalPersonsResponseLinks':
        return super().__new__(
            cls,
            *args,
            next=next,
