...
class PaymentsGetBankAccountPaymentsResponsePayments(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PaymentsGetBankAccountPaymentsResponsePaymentsItem']:
            return PaymentsGetBankAccountPaymentsResponsePaymentsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PaymentsGetBankAccountPaymentsResponsePaymentsItem'], typing.List['PaymentsGetBankAccountPaymentsResponsePaymentsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PaymentsGetBankAccountPaymentsResponsePayments':
    ...
    def __getitem__(self, i: int) -> 'PaymentsGetBankAccountPaymentsResponsePaymentsItem':
