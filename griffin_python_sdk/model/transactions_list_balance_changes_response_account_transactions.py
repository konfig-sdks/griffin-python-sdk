...
class TransactionsListBalanceChangesResponseAccountTransactions(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TransactionsListBalanceChangesResponseAccountTransactionsItem']:
            return TransactionsListBalanceChangesResponseAccountTransactionsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['TransactionsListBalanceChangesResponseAccountTransactionsItem'], typing.List['TransactionsListBalanceChangesResponseAccountTransactionsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'TransactionsListBalanceChangesResponseAccountTransactions':
    ...
    def __getitem__(self, i: int) -> 'TransactionsListBalanceChangesResponseAccountTransactionsItem':
