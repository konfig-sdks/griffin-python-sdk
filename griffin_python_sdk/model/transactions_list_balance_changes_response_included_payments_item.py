...
class TransactionsListBalanceChangesResponseIncludedPaymentsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def creditor() -> typing.Type['TransactionsListBalanceChangesResponseIncludedPaymentsItemCreditor']:
                return TransactionsListBalanceChangesResponseIncludedPaymentsItemCreditor
            ...
            class payment_direction(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "inbound-payment": "INBOUNDPAYMENT",
                        "outbound-payment": "OUTBOUNDPAYMENT",
                    }
                
                @schemas.classproperty
                def INBOUNDPAYMENT(cls):
                    return cls("inbound-payment")
                
                @schemas.classproperty
                def OUTBOUNDPAYMENT(cls):
                    return cls("outbound-payment")
            created_at = schemas.DateTimeSchema
            payment_url = schemas.StrSchema
        
            @staticmethod
            def payment_amount() -> typing.Type['TransactionsListBalanceChangesResponseIncludedPaymentsItemPaymentAmount']:
                return TransactionsListBalanceChangesResponseIncludedPaymentsItemPaymentAmount
        
            @staticmethod
            def debtor() -> typing.Type['TransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor']:
                return TransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor
            ...
            @staticmethod
            def ultimate_debtor() -> typing.Type['TransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor']:
                return TransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor
            payment_admissions_url = schemas.StrSchema
            payment_submissions_url = schemas.StrSchema
            __annotations__ = {
                "creditor": creditor,
                ...
                "ultimate-debtor": ultimate_debtor,
                "payment-admissions-url": payment_admissions_url,
                "payment-submissions-url": payment_submissions_url,
            }
    
    debtor: 'TransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor'
    creditor: 'TransactionsListBalanceChangesResponseIncludedPaymentsItemCreditor'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["creditor"]) -> 'TransactionsListBalanceChangesResponseIncludedPaymentsItemCreditor': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment-direction"]) -> MetaOapg.properties.payment_direction: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["created-at"]) -> MetaOapg.properties.created_at: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment-url"]) -> MetaOapg.properties.payment_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment-amount"]) -> 'TransactionsListBalanceChangesResponseIncludedPaymentsItemPaymentAmount': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["debtor"]) -> 'TransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment-reference"]) -> MetaOapg.properties.payment_reference: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ultimate-debtor"]) -> 'TransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment-admissions-url"]) -> MetaOapg.properties.payment_admissions_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment-submissions-url"]) -> MetaOapg.properties.payment_submissions_url: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["creditor", "payment-direction", "created-at", "payment-url", "payment-amount", "debtor", "payment-reference", "ultimate-debtor", "payment-admissions-url", "payment-submissions-url", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["creditor"]) -> 'TransactionsListBalanceChangesResponseIncludedPaymentsItemCreditor': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment-direction"]) -> MetaOapg.properties.payment_direction: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["created-at"]) -> MetaOapg.properties.created_at: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment-url"]) -> MetaOapg.properties.payment_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment-amount"]) -> 'TransactionsListBalanceChangesResponseIncludedPaymentsItemPaymentAmount': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["debtor"]) -> 'TransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment-reference"]) -> typing.Union[MetaOapg.properties.payment_reference, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ultimate-debtor"]) -> typing.Union['TransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment-admissions-url"]) -> typing.Union[MetaOapg.properties.payment_admissions_url, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment-submissions-url"]) -> typing.Union[MetaOapg.properties.payment_submissions_url, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["creditor", "payment-direction", "created-at", "payment-url", "payment-amount", "debtor", "payment-reference", "ultimate-debtor", "payment-admissions-url", "payment-submissions-url", ], str]):
    ...
    ) -> 'TransactionsListBalanceChangesResponseIncludedPaymentsItem':
