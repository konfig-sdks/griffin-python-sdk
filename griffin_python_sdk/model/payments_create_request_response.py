...
class PaymentsCreateRequestResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def creditor() -> typing.Type['PaymentsCreateRequestResponseCreditor']:
                return PaymentsCreateRequestResponseCreditor
            ...
            @staticmethod
            def payment_amount() -> typing.Type['PaymentsCreateRequestResponsePaymentAmount']:
                return PaymentsCreateRequestResponsePaymentAmount
        
            @staticmethod
            def debtor() -> typing.Type['PaymentsCreateRequestResponseDebtor']:
                return PaymentsCreateRequestResponseDebtor
            ...
            @staticmethod
            def ultimate_debtor() -> typing.Type['PaymentsCreateRequestResponseUltimateDebtor']:
                return PaymentsCreateRequestResponseUltimateDebtor
    ...
    debtor: 'PaymentsCreateRequestResponseDebtor'
    creditor: 'PaymentsCreateRequestResponseCreditor'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["creditor"]) -> 'PaymentsCreateRequestResponseCreditor': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment-amount"]) -> 'PaymentsCreateRequestResponsePaymentAmount': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["debtor"]) -> 'PaymentsCreateRequestResponseDebtor': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment-reference"]) -> MetaOapg.properties.payment_reference: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ultimate-debtor"]) -> 'PaymentsCreateRequestResponseUltimateDebtor': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["creditor"]) -> 'PaymentsCreateRequestResponseCreditor': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment-amount"]) -> 'PaymentsCreateRequestResponsePaymentAmount': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["debtor"]) -> 'PaymentsCreateRequestResponseDebtor': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ultimate-debtor"]) -> typing.Union['PaymentsCreateRequestResponseUltimateDebtor', schemas.Unset]: ...
