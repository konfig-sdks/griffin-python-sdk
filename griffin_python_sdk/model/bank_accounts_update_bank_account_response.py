...
class BankAccountsUpdateBankAccountResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available_balance() -> typing.Type['BankAccountsUpdateBankAccountResponseAvailableBalance']:
                return BankAccountsUpdateBankAccountResponseAvailableBalance
            account_transactions_url = schemas.StrSchema
            account_url = schemas.StrSchema
        
            @staticmethod
            def account_balance() -> typing.Type['BankAccountsUpdateBankAccountResponseAccountBalance']:
                return BankAccountsUpdateBankAccountResponseAccountBalance
            ...
            @staticmethod
            def bank_addresses() -> typing.Type['BankAccountsUpdateBankAccountResponseBankAddresses']:
                return BankAccountsUpdateBankAccountResponseBankAddresses
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available-balance"]) -> 'BankAccountsUpdateBankAccountResponseAvailableBalance': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["account-balance"]) -> 'BankAccountsUpdateBankAccountResponseAccountBalance': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["bank-addresses"]) -> 'BankAccountsUpdateBankAccountResponseBankAddresses': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available-balance"]) -> 'BankAccountsUpdateBankAccountResponseAvailableBalance': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["account-balance"]) -> 'BankAccountsUpdateBankAccountResponseAccountBalance': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["bank-addresses"]) -> typing.Union['BankAccountsUpdateBankAccountResponseBankAddresses', schemas.Unset]: ...
