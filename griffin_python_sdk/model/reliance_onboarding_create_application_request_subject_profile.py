...
class RelianceOnboardingCreateApplicationRequestSubjectProfile(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def claims() -> typing.Type['RelianceOnboardingCreateApplicationRequestSubjectProfileClaims']:
                return RelianceOnboardingCreateApplicationRequestSubjectProfileClaims
            __annotations__ = {
                "display-name": display_name,
                "claims": claims,
            }
    
    claims: 'RelianceOnboardingCreateApplicationRequestSubjectProfileClaims'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["display-name"]) -> MetaOapg.properties.display_name: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["claims"]) -> 'RelianceOnboardingCreateApplicationRequestSubjectProfileClaims': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["display-name", "claims", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["claims"]) -> 'RelianceOnboardingCreateApplicationRequestSubjectProfileClaims': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["display-name", "claims", ], str]):
    ...
    ) -> 'RelianceOnboardingCreateApplicationRequestSubjectProfile':
