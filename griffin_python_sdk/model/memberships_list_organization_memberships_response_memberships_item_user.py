...
class MembershipsListOrganizationMembershipsResponseMembershipsItemUser(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            user_url = schemas.StrSchema
            user_username = schemas.StrSchema
            api_keys_url = schemas.StrSchema
            user_memberships_url = schemas.StrSchema
            ...
            __annotations__ = {
                ...
                "api-keys-url": api_keys_url,
                "user-memberships-url": user_memberships_url,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["user-email"]) -> MetaOapg.properties.user_email: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["user-url"]) -> MetaOapg.properties.user_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["user-username"]) -> MetaOapg.properties.user_username: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["api-keys-url"]) -> MetaOapg.properties.api_keys_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["user-memberships-url"]) -> MetaOapg.properties.user_memberships_url: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user-email", "user-url", "user-username", "api-keys-url", "user-memberships-url", "given-name", "surname", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["user-email"]) -> MetaOapg.properties.user_email: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["user-url"]) -> MetaOapg.properties.user_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["user-username"]) -> MetaOapg.properties.user_username: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["api-keys-url"]) -> MetaOapg.properties.api_keys_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["user-memberships-url"]) -> MetaOapg.properties.user_memberships_url: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user-email", "user-url", "user-username", "api-keys-url", "user-memberships-url", "given-name", "surname", ], str]):
    ...
    ) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItemUser':
