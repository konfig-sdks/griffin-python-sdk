...
class PaymentsGetBankAccountPaymentsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payments() -> typing.Type['PaymentsGetBankAccountPaymentsResponsePayments']:
                return PaymentsGetBankAccountPaymentsResponsePayments
        
            @staticmethod
            def links() -> typing.Type['PaymentsGetBankAccountPaymentsResponseLinks']:
                return PaymentsGetBankAccountPaymentsResponseLinks
            __annotations__ = {
                "payments": payments,
                "links": links,
            }
    
    payments: 'PaymentsGetBankAccountPaymentsResponsePayments'
    links: 'PaymentsGetBankAccountPaymentsResponseLinks'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payments"]) -> 'PaymentsGetBankAccountPaymentsResponsePayments': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'PaymentsGetBankAccountPaymentsResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["payments", "links", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payments"]) -> 'PaymentsGetBankAccountPaymentsResponsePayments': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'PaymentsGetBankAccountPaymentsResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["payments", "links", ], str]):
