...
class WorkflowsGetWorkflowResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def required_claim_types() -> typing.Type['WorkflowsGetWorkflowResponseRequiredClaimTypes']:
                return WorkflowsGetWorkflowResponseRequiredClaimTypes
        
            @staticmethod
            def workflow_rules() -> typing.Type['WorkflowsGetWorkflowResponseWorkflowRules']:
                return WorkflowsGetWorkflowResponseWorkflowRules
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["required-claim-types"]) -> 'WorkflowsGetWorkflowResponseRequiredClaimTypes': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workflow-rules"]) -> 'WorkflowsGetWorkflowResponseWorkflowRules': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["required-claim-types"]) -> typing.Union['WorkflowsGetWorkflowResponseRequiredClaimTypes', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["workflow-rules"]) -> typing.Union['WorkflowsGetWorkflowResponseWorkflowRules', schemas.Unset]: ...
