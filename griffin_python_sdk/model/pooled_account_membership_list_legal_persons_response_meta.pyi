...
class PooledAccountMembershipListLegalPersonsResponseMeta(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def page() -> typing.Type['PooledAccountMembershipListLegalPersonsResponseMetaPage']:
                return PooledAccountMembershipListLegalPersonsResponseMetaPage
            __annotations__ = {
                "page": page,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["page"]) -> 'PooledAccountMembershipListLegalPersonsResponseMetaPage': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["page"]) -> typing.Union['PooledAccountMembershipListLegalPersonsResponseMetaPage', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        page: typing.Union['PooledAccountMembershipListLegalPersonsResponseMetaPage', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'PooledAccountMembershipListLegalPersonsResponseMeta':
