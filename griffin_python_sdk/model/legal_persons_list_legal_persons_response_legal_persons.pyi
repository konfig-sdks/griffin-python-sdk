...
class LegalPersonsListLegalPersonsResponseLegalPersons(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['LegalPersonsListLegalPersonsResponseLegalPersonsItem']:
            return LegalPersonsListLegalPersonsResponseLegalPersonsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['LegalPersonsListLegalPersonsResponseLegalPersonsItem'], typing.List['LegalPersonsListLegalPersonsResponseLegalPersonsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'LegalPersonsListLegalPersonsResponseLegalPersons':
    ...
    def __getitem__(self, i: int) -> 'LegalPersonsListLegalPersonsResponseLegalPersonsItem':
