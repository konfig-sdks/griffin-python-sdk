...
class PayeesListLegalPersonPayeesResponsePayees(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PayeesListLegalPersonPayeesResponsePayeesItem']:
            return PayeesListLegalPersonPayeesResponsePayeesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PayeesListLegalPersonPayeesResponsePayeesItem'], typing.List['PayeesListLegalPersonPayeesResponsePayeesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PayeesListLegalPersonPayeesResponsePayees':
    ...
    def __getitem__(self, i: int) -> 'PayeesListLegalPersonPayeesResponsePayeesItem':
