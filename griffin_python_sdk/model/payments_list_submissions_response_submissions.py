...
class PaymentsListSubmissionsResponseSubmissions(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PaymentsListSubmissionsResponseSubmissionsItem']:
            return PaymentsListSubmissionsResponseSubmissionsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PaymentsListSubmissionsResponseSubmissionsItem'], typing.List['PaymentsListSubmissionsResponseSubmissionsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PaymentsListSubmissionsResponseSubmissions':
    ...
    def __getitem__(self, i: int) -> 'PaymentsListSubmissionsResponseSubmissionsItem':
