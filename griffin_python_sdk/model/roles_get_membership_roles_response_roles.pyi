...
class RolesGetMembershipRolesResponseRoles(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RolesGetMembershipRolesResponseRolesItem']:
            return RolesGetMembershipRolesResponseRolesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['RolesGetMembershipRolesResponseRolesItem'], typing.List['RolesGetMembershipRolesResponseRolesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'RolesGetMembershipRolesResponseRoles':
    ...
    def __getitem__(self, i: int) -> 'RolesGetMembershipRolesResponseRolesItem':
