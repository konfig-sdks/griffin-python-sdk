...
class PooledAccountMembershipManageLegalPersonsRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def additions() -> typing.Type['PooledAccountMembershipManageLegalPersonsRequestAdditions']:
                return PooledAccountMembershipManageLegalPersonsRequestAdditions
        
            @staticmethod
            def deletions() -> typing.Type['PooledAccountMembershipManageLegalPersonsRequestDeletions']:
                return PooledAccountMembershipManageLegalPersonsRequestDeletions
            __annotations__ = {
                "additions": additions,
                "deletions": deletions,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["additions"]) -> 'PooledAccountMembershipManageLegalPersonsRequestAdditions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["deletions"]) -> 'PooledAccountMembershipManageLegalPersonsRequestDeletions': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["additions", "deletions", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["additions"]) -> 'PooledAccountMembershipManageLegalPersonsRequestAdditions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deletions"]) -> 'PooledAccountMembershipManageLegalPersonsRequestDeletions': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["additions", "deletions", ], str]):
