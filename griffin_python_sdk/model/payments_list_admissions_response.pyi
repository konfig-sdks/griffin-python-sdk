...
class PaymentsListAdmissionsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def admissions() -> typing.Type['PaymentsListAdmissionsResponseAdmissions']:
                return PaymentsListAdmissionsResponseAdmissions
            __annotations__ = {
                "admissions": admissions,
            }
    
    admissions: 'PaymentsListAdmissionsResponseAdmissions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["admissions"]) -> 'PaymentsListAdmissionsResponseAdmissions': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["admissions", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["admissions"]) -> 'PaymentsListAdmissionsResponseAdmissions': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["admissions", ], str]):
