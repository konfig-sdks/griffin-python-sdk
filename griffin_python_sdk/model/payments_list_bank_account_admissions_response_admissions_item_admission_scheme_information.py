...
class PaymentsListBankAccountAdmissionsResponseAdmissionsItemAdmissionSchemeInformation(
    ...
    class MetaOapg:
        ...
        class any_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["end-to-end-identification", "payment-scheme", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["end-to-end-identification", "payment-scheme", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'PaymentsListBankAccountAdmissionsResponseAdmissionsItemAdmissionSchemeInformation':
        return super().__new__(
            cls,
            *args,
            _configuration=_configuration,
