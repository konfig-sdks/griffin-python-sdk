...
class EventsGetAllOrganizationEventsResponseEventsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class event_type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        ...
                        "verification-updated": "VERIFICATIONUPDATED",
                        "admission-updated": "ADMISSIONUPDATED",
                        "verification-created": "VERIFICATIONCREATED",
                        "account-status-updated": "ACCOUNTSTATUSUPDATED",
                        "submission-created": "SUBMISSIONCREATED",
                        "test-event": "TESTEVENT",
                        "admission-created": "ADMISSIONCREATED",
                        "account-status-created": "ACCOUNTSTATUSCREATED",
            ...
            event_payload = schemas.DictSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["event-url"]) -> MetaOapg.properties.event_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["event-type"]) -> MetaOapg.properties.event_type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["event-payload"]) -> MetaOapg.properties.event_payload: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["event-url", "event-type", "event-payload", "created-at", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["event-url"]) -> MetaOapg.properties.event_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["event-type"]) -> MetaOapg.properties.event_type: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["event-payload"]) -> MetaOapg.properties.event_payload: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["event-url", "event-type", "event-payload", "created-at", ], str]):
    ...
    ) -> 'EventsGetAllOrganizationEventsResponseEventsItem':
