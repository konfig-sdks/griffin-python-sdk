...
class PaymentsListBankAccountAdmissionsResponseAdmissions(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PaymentsListBankAccountAdmissionsResponseAdmissionsItem']:
            return PaymentsListBankAccountAdmissionsResponseAdmissionsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PaymentsListBankAccountAdmissionsResponseAdmissionsItem'], typing.List['PaymentsListBankAccountAdmissionsResponseAdmissionsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PaymentsListBankAccountAdmissionsResponseAdmissions':
    ...
    def __getitem__(self, i: int) -> 'PaymentsListBankAccountAdmissionsResponseAdmissionsItem':
