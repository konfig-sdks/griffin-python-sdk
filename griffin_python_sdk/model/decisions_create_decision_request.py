...
class DecisionsCreateDecisionRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["verification-url", "decision-outcome", "decision-notes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["verification-url", "decision-outcome", "decision-notes", ], str]):
