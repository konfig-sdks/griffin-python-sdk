...
class MembershipsListUserMembershipsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def memberships() -> typing.Type['MembershipsListUserMembershipsResponseMemberships']:
                return MembershipsListUserMembershipsResponseMemberships
        
            @staticmethod
            def links() -> typing.Type['MembershipsListUserMembershipsResponseLinks']:
                return MembershipsListUserMembershipsResponseLinks
            __annotations__ = {
                "memberships": memberships,
                "links": links,
            }
    
    links: 'MembershipsListUserMembershipsResponseLinks'
    memberships: 'MembershipsListUserMembershipsResponseMemberships'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["memberships"]) -> 'MembershipsListUserMembershipsResponseMemberships': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'MembershipsListUserMembershipsResponseLinks': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["memberships"]) -> 'MembershipsListUserMembershipsResponseMemberships': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'MembershipsListUserMembershipsResponseLinks': ...
