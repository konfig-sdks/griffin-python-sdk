...
class BankAccountsListResponseAccounts(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['BankAccountsListResponseAccountsItem']:
            return BankAccountsListResponseAccountsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['BankAccountsListResponseAccountsItem'], typing.List['BankAccountsListResponseAccountsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'BankAccountsListResponseAccounts':
    ...
    def __getitem__(self, i: int) -> 'BankAccountsListResponseAccountsItem':
