...
class MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRoles(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem']:
            return MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem'], typing.List['MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRoles':
    ...
    def __getitem__(self, i: int) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem':
