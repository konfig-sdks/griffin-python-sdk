...
class RelianceOnboardingCreateApplicationRequestRelatedProfilesItemClaims(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RelianceOnboardingCreateApplicationRequestRelatedProfilesItemClaimsItem']:
            return RelianceOnboardingCreateApplicationRequestRelatedProfilesItemClaimsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['RelianceOnboardingCreateApplicationRequestRelatedProfilesItemClaimsItem'], typing.List['RelianceOnboardingCreateApplicationRequestRelatedProfilesItemClaimsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItemClaims':
    ...
    def __getitem__(self, i: int) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItemClaimsItem':
