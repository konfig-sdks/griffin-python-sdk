...
class RolesAssignMembershipRolesRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def role_urls() -> typing.Type['RolesAssignMembershipRolesRequestRoleUrls']:
                return RolesAssignMembershipRolesRequestRoleUrls
            __annotations__ = {
                "role-urls": role_urls,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["role-urls"]) -> 'RolesAssignMembershipRolesRequestRoleUrls': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["role-urls", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["role-urls"]) -> 'RolesAssignMembershipRolesRequestRoleUrls': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["role-urls", ], str]):
