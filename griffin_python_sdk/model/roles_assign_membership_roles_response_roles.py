...
class RolesAssignMembershipRolesResponseRoles(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RolesAssignMembershipRolesResponseRolesItem']:
            return RolesAssignMembershipRolesResponseRolesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['RolesAssignMembershipRolesResponseRolesItem'], typing.List['RolesAssignMembershipRolesResponseRolesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'RolesAssignMembershipRolesResponseRoles':
    ...
    def __getitem__(self, i: int) -> 'RolesAssignMembershipRolesResponseRolesItem':
