...
class BankAccountsUpdateBankAccountResponseBankAddresses(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['BankAccountsUpdateBankAccountResponseBankAddressesItem']:
            return BankAccountsUpdateBankAccountResponseBankAddressesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['BankAccountsUpdateBankAccountResponseBankAddressesItem'], typing.List['BankAccountsUpdateBankAccountResponseBankAddressesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'BankAccountsUpdateBankAccountResponseBankAddresses':
    ...
    def __getitem__(self, i: int) -> 'BankAccountsUpdateBankAccountResponseBankAddressesItem':
