...
class ApiKeysListActiveKeysResponseApiKeys(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ApiKeysListActiveKeysResponseApiKeysItem']:
            return ApiKeysListActiveKeysResponseApiKeysItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ApiKeysListActiveKeysResponseApiKeysItem'], typing.List['ApiKeysListActiveKeysResponseApiKeysItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ApiKeysListActiveKeysResponseApiKeys':
    ...
    def __getitem__(self, i: int) -> 'ApiKeysListActiveKeysResponseApiKeysItem':
