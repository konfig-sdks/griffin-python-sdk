...
class PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            risk_rating_url = schemas.StrSchema
            ...
            @staticmethod
            def manually_created_by() -> typing.Type['PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItemManuallyCreatedBy']:
                return PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItemManuallyCreatedBy
            ...
            class previous_risk_rating(
                ...
                def LOWRISK(cls):
                    return cls("low-risk")
            __annotations__ = {
                "risk-rating-url": risk_rating_url,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["risk-rating-url"]) -> MetaOapg.properties.risk_rating_url: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["manually-created-by"]) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItemManuallyCreatedBy': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["risk-rating-url", "risk-rating", "legal-person-url", "notes", "manually-created-by", "verification-url", "previous-risk-rating", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["risk-rating-url"]) -> MetaOapg.properties.risk_rating_url: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["manually-created-by"]) -> typing.Union['PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItemManuallyCreatedBy', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["verification-url"]) -> typing.Union[MetaOapg.properties.verification_url, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["risk-rating-url", "risk-rating", "legal-person-url", "notes", "manually-created-by", "verification-url", "previous-risk-rating", ], str]):
    ...
    ) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem':
