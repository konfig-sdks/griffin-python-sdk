...
class PaymentsListSubmissions200Response(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def submissions() -> typing.Type['PaymentsListSubmissions200ResponseSubmissions']:
                return PaymentsListSubmissions200ResponseSubmissions
            __annotations__ = {
                "submissions": submissions,
            }
    
    submissions: 'PaymentsListSubmissions200ResponseSubmissions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["submissions"]) -> 'PaymentsListSubmissions200ResponseSubmissions': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["submissions", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["submissions"]) -> 'PaymentsListSubmissions200ResponseSubmissions': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["submissions", ], str]):
