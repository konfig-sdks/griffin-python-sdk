...
class TransactionsListBalanceChangesResponseIncluded(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payments() -> typing.Type['TransactionsListBalanceChangesResponseIncludedPayments']:
                return TransactionsListBalanceChangesResponseIncludedPayments
            __annotations__ = {
                "payments": payments,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payments"]) -> 'TransactionsListBalanceChangesResponseIncludedPayments': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payments"]) -> typing.Union['TransactionsListBalanceChangesResponseIncludedPayments', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        payments: typing.Union['TransactionsListBalanceChangesResponseIncludedPayments', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'TransactionsListBalanceChangesResponseIncluded':
