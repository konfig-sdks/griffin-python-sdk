...
class TransactionsListBalanceChangesResponseIncludedPayments(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TransactionsListBalanceChangesResponseIncludedPaymentsItem']:
            return TransactionsListBalanceChangesResponseIncludedPaymentsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['TransactionsListBalanceChangesResponseIncludedPaymentsItem'], typing.List['TransactionsListBalanceChangesResponseIncludedPaymentsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'TransactionsListBalanceChangesResponseIncludedPayments':
    ...
    def __getitem__(self, i: int) -> 'TransactionsListBalanceChangesResponseIncludedPaymentsItem':
