...
class PayeesRegisterNewPayeeRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account-holder", "account-number", "bank-id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account-holder", "account-number", "bank-id", ], str]):
