...
class RolesAssignMembershipRolesResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def roles() -> typing.Type['RolesAssignMembershipRolesResponseRoles']:
                return RolesAssignMembershipRolesResponseRoles
            __annotations__ = {
                "roles": roles,
            }
    
    roles: 'RolesAssignMembershipRolesResponseRoles'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["roles"]) -> 'RolesAssignMembershipRolesResponseRoles': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["roles"]) -> 'RolesAssignMembershipRolesResponseRoles': ...
