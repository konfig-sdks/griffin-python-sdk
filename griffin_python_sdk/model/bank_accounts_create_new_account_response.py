...
class BankAccountsCreateNewAccountResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available_balance() -> typing.Type['BankAccountsCreateNewAccountResponseAvailableBalance']:
                return BankAccountsCreateNewAccountResponseAvailableBalance
            account_transactions_url = schemas.StrSchema
            account_url = schemas.StrSchema
        
            @staticmethod
            def account_balance() -> typing.Type['BankAccountsCreateNewAccountResponseAccountBalance']:
                return BankAccountsCreateNewAccountResponseAccountBalance
            ...
            @staticmethod
            def bank_addresses() -> typing.Type['BankAccountsCreateNewAccountResponseBankAddresses']:
                return BankAccountsCreateNewAccountResponseBankAddresses
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available-balance"]) -> 'BankAccountsCreateNewAccountResponseAvailableBalance': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["account-balance"]) -> 'BankAccountsCreateNewAccountResponseAccountBalance': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["bank-addresses"]) -> 'BankAccountsCreateNewAccountResponseBankAddresses': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available-balance"]) -> 'BankAccountsCreateNewAccountResponseAvailableBalance': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["account-balance"]) -> 'BankAccountsCreateNewAccountResponseAccountBalance': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["bank-addresses"]) -> typing.Union['BankAccountsCreateNewAccountResponseBankAddresses', schemas.Unset]: ...
