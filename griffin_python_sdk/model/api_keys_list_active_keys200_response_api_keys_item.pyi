...
class ApiKeysListActiveKeys200ResponseApiKeysItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["api-key-url", "api-key-name", "api-key-live?", "organization-url", "user-url", "created-at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["api-key-url", "api-key-name", "api-key-live?", "organization-url", "user-url", "created-at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ApiKeysListActiveKeys200ResponseApiKeysItem':
        return super().__new__(
            cls,
            *args,
            _configuration=_configuration,
