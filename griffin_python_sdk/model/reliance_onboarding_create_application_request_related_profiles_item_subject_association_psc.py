...
class RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationPsc(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ownership-percent", "companies-house-url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ownership-percent", "companies-house-url", ], str]):
    ...
    ) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociationPsc':
