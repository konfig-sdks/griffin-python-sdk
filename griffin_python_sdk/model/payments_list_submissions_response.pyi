...
class PaymentsListSubmissionsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def submissions() -> typing.Type['PaymentsListSubmissionsResponseSubmissions']:
                return PaymentsListSubmissionsResponseSubmissions
        
            @staticmethod
            def links() -> typing.Type['PaymentsListSubmissionsResponseLinks']:
                return PaymentsListSubmissionsResponseLinks
            __annotations__ = {
                "submissions": submissions,
                "links": links,
            }
    
    submissions: 'PaymentsListSubmissionsResponseSubmissions'
    links: 'PaymentsListSubmissionsResponseLinks'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["submissions"]) -> 'PaymentsListSubmissionsResponseSubmissions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'PaymentsListSubmissionsResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["submissions", "links", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["submissions"]) -> 'PaymentsListSubmissionsResponseSubmissions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'PaymentsListSubmissionsResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["submissions", "links", ], str]):
