...
class PaymentsGetDetailsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def creditor() -> typing.Type['PaymentsGetDetailsResponseCreditor']:
                return PaymentsGetDetailsResponseCreditor
            ...
            @staticmethod
            def payment_amount() -> typing.Type['PaymentsGetDetailsResponsePaymentAmount']:
                return PaymentsGetDetailsResponsePaymentAmount
        
            @staticmethod
            def debtor() -> typing.Type['PaymentsGetDetailsResponseDebtor']:
                return PaymentsGetDetailsResponseDebtor
            ...
            @staticmethod
            def ultimate_debtor() -> typing.Type['PaymentsGetDetailsResponseUltimateDebtor']:
                return PaymentsGetDetailsResponseUltimateDebtor
    ...
    debtor: 'PaymentsGetDetailsResponseDebtor'
    creditor: 'PaymentsGetDetailsResponseCreditor'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["creditor"]) -> 'PaymentsGetDetailsResponseCreditor': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment-amount"]) -> 'PaymentsGetDetailsResponsePaymentAmount': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["debtor"]) -> 'PaymentsGetDetailsResponseDebtor': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment-reference"]) -> MetaOapg.properties.payment_reference: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ultimate-debtor"]) -> 'PaymentsGetDetailsResponseUltimateDebtor': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["creditor"]) -> 'PaymentsGetDetailsResponseCreditor': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment-amount"]) -> 'PaymentsGetDetailsResponsePaymentAmount': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["debtor"]) -> 'PaymentsGetDetailsResponseDebtor': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ultimate-debtor"]) -> typing.Union['PaymentsGetDetailsResponseUltimateDebtor', schemas.Unset]: ...
