...
class BankAccountsListResponseIncludedLegalPersons(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['BankAccountsListResponseIncludedLegalPersonsItem']:
            return BankAccountsListResponseIncludedLegalPersonsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['BankAccountsListResponseIncludedLegalPersonsItem'], typing.List['BankAccountsListResponseIncludedLegalPersonsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'BankAccountsListResponseIncludedLegalPersons':
    ...
    def __getitem__(self, i: int) -> 'BankAccountsListResponseIncludedLegalPersonsItem':
