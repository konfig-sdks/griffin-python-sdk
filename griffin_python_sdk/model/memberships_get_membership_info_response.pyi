...
class MembershipsGetMembershipInfoResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def organization() -> typing.Type['MembershipsGetMembershipInfoResponseOrganization']:
                return MembershipsGetMembershipInfoResponseOrganization
        
            @staticmethod
            def roles() -> typing.Type['MembershipsGetMembershipInfoResponseRoles']:
                return MembershipsGetMembershipInfoResponseRoles
        
            @staticmethod
            def user() -> typing.Type['MembershipsGetMembershipInfoResponseUser']:
                return MembershipsGetMembershipInfoResponseUser
    ...
    organization: 'MembershipsGetMembershipInfoResponseOrganization'
    roles: 'MembershipsGetMembershipInfoResponseRoles'
    user: 'MembershipsGetMembershipInfoResponseUser'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["organization"]) -> 'MembershipsGetMembershipInfoResponseOrganization': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["roles"]) -> 'MembershipsGetMembershipInfoResponseRoles': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["user"]) -> 'MembershipsGetMembershipInfoResponseUser': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["organization"]) -> 'MembershipsGetMembershipInfoResponseOrganization': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["roles"]) -> 'MembershipsGetMembershipInfoResponseRoles': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["user"]) -> 'MembershipsGetMembershipInfoResponseUser': ...
