...
class BankAccountsCloseAccountResponseBankAddresses(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['BankAccountsCloseAccountResponseBankAddressesItem']:
            return BankAccountsCloseAccountResponseBankAddressesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['BankAccountsCloseAccountResponseBankAddressesItem'], typing.List['BankAccountsCloseAccountResponseBankAddressesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'BankAccountsCloseAccountResponseBankAddresses':
    ...
    def __getitem__(self, i: int) -> 'BankAccountsCloseAccountResponseBankAddressesItem':
