...
class TransactionsGetTransactionByIdResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def balance_change() -> typing.Type['TransactionsGetTransactionByIdResponseBalanceChange']:
                return TransactionsGetTransactionByIdResponseBalanceChange
        
            @staticmethod
            def account_balance() -> typing.Type['TransactionsGetTransactionByIdResponseAccountBalance']:
                return TransactionsGetTransactionByIdResponseAccountBalance
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["balance-change"]) -> 'TransactionsGetTransactionByIdResponseBalanceChange': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["account-balance"]) -> 'TransactionsGetTransactionByIdResponseAccountBalance': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["balance-change"]) -> 'TransactionsGetTransactionByIdResponseBalanceChange': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["account-balance"]) -> 'TransactionsGetTransactionByIdResponseAccountBalance': ...
