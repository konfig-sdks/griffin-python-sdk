...
class EventsGetAllOrganizationEventsResponseEvents(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['EventsGetAllOrganizationEventsResponseEventsItem']:
            return EventsGetAllOrganizationEventsResponseEventsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['EventsGetAllOrganizationEventsResponseEventsItem'], typing.List['EventsGetAllOrganizationEventsResponseEventsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'EventsGetAllOrganizationEventsResponseEvents':
    ...
    def __getitem__(self, i: int) -> 'EventsGetAllOrganizationEventsResponseEventsItem':
