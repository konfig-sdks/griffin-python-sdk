...
class PaymentsListBankAccountAdmissionsResponseAdmissionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def admission_scheme_information() -> typing.Type['PaymentsListBankAccountAdmissionsResponseAdmissionsItemAdmissionSchemeInformation']:
                return PaymentsListBankAccountAdmissionsResponseAdmissionsItemAdmissionSchemeInformation
            payment_url = schemas.StrSchema
            created_at = schemas.DateTimeSchema
            admission_url = schemas.StrSchema
            __annotations__ = {
                "admission-status": admission_status,
                "admission-scheme-information": admission_scheme_information,
                "payment-url": payment_url,
                "created-at": created_at,
                "admission-url": admission_url,
            }
    
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["admission-status"]) -> MetaOapg.properties.admission_status: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["admission-scheme-information"]) -> 'PaymentsListBankAccountAdmissionsResponseAdmissionsItemAdmissionSchemeInformation': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["admission-url"]) -> MetaOapg.properties.admission_url: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["admission-status", "admission-scheme-information", "payment-url", "created-at", "admission-url", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["admission-status"]) -> MetaOapg.properties.admission_status: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["admission-scheme-information"]) -> 'PaymentsListBankAccountAdmissionsResponseAdmissionsItemAdmissionSchemeInformation': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["admission-url"]) -> MetaOapg.properties.admission_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["admission-status", "admission-scheme-information", "payment-url", "created-at", "admission-url", ], str]):
    ...
    ) -> 'PaymentsListBankAccountAdmissionsResponseAdmissionsItem':
