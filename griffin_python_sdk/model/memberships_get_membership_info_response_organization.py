...
class MembershipsGetMembershipInfoResponseOrganization(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available_roles() -> typing.Type['MembershipsGetMembershipInfoResponseOrganizationAvailableRoles']:
                return MembershipsGetMembershipInfoResponseOrganizationAvailableRoles
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available-roles"]) -> 'MembershipsGetMembershipInfoResponseOrganizationAvailableRoles': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available-roles"]) -> 'MembershipsGetMembershipInfoResponseOrganizationAvailableRoles': ...
    ...
    ) -> 'MembershipsGetMembershipInfoResponseOrganization':
