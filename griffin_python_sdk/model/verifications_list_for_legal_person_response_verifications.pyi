...
class VerificationsListForLegalPersonResponseVerifications(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['VerificationsListForLegalPersonResponseVerificationsItem']:
            return VerificationsListForLegalPersonResponseVerificationsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['VerificationsListForLegalPersonResponseVerificationsItem'], typing.List['VerificationsListForLegalPersonResponseVerificationsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'VerificationsListForLegalPersonResponseVerifications':
    ...
    def __getitem__(self, i: int) -> 'VerificationsListForLegalPersonResponseVerificationsItem':
