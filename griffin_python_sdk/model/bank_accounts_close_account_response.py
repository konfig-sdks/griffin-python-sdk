...
class BankAccountsCloseAccountResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available_balance() -> typing.Type['BankAccountsCloseAccountResponseAvailableBalance']:
                return BankAccountsCloseAccountResponseAvailableBalance
            account_transactions_url = schemas.StrSchema
            account_url = schemas.StrSchema
        
            @staticmethod
            def account_balance() -> typing.Type['BankAccountsCloseAccountResponseAccountBalance']:
                return BankAccountsCloseAccountResponseAccountBalance
            ...
            @staticmethod
            def bank_addresses() -> typing.Type['BankAccountsCloseAccountResponseBankAddresses']:
                return BankAccountsCloseAccountResponseBankAddresses
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available-balance"]) -> 'BankAccountsCloseAccountResponseAvailableBalance': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["account-balance"]) -> 'BankAccountsCloseAccountResponseAccountBalance': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["bank-addresses"]) -> 'BankAccountsCloseAccountResponseBankAddresses': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available-balance"]) -> 'BankAccountsCloseAccountResponseAvailableBalance': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["account-balance"]) -> 'BankAccountsCloseAccountResponseAccountBalance': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["bank-addresses"]) -> typing.Union['BankAccountsCloseAccountResponseBankAddresses', schemas.Unset]: ...
