...
class WebhooksGetAllResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def organization_webhooks() -> typing.Type['WebhooksGetAllResponseOrganizationWebhooks']:
                return WebhooksGetAllResponseOrganizationWebhooks
            __annotations__ = {
                "organization-webhooks": organization_webhooks,
            }
    
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["organization-webhooks"]) -> 'WebhooksGetAllResponseOrganizationWebhooks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["organization-webhooks", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["organization-webhooks"]) -> 'WebhooksGetAllResponseOrganizationWebhooks': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["organization-webhooks", ], str]):
