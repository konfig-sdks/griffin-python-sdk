...
class PaymentsListSubmissions200ResponseSubmissionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def submission_scheme_information() -> typing.Type['PaymentsListSubmissions200ResponseSubmissionsItemSubmissionSchemeInformation']:
                return PaymentsListSubmissions200ResponseSubmissionsItemSubmissionSchemeInformation
            payment_url = schemas.StrSchema
            created_at = schemas.DateTimeSchema
            submission_url = schemas.StrSchema
            __annotations__ = {
                "submission-status": submission_status,
                "submission-scheme-information": submission_scheme_information,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["submission-status"]) -> MetaOapg.properties.submission_status: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["submission-scheme-information"]) -> 'PaymentsListSubmissions200ResponseSubmissionsItemSubmissionSchemeInformation': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["submission-url"]) -> MetaOapg.properties.submission_url: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["submission-status", "submission-scheme-information", "payment-url", "created-at", "submission-url", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["submission-status"]) -> MetaOapg.properties.submission_status: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["submission-scheme-information"]) -> 'PaymentsListSubmissions200ResponseSubmissionsItemSubmissionSchemeInformation': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["submission-url"]) -> MetaOapg.properties.submission_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["submission-status", "submission-scheme-information", "payment-url", "created-at", "submission-url", ], str]):
    ...
    ) -> 'PaymentsListSubmissions200ResponseSubmissionsItem':
