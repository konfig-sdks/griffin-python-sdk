...
class BankAccountsGetAccountResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available_balance() -> typing.Type['BankAccountsGetAccountResponseAvailableBalance']:
                return BankAccountsGetAccountResponseAvailableBalance
            account_transactions_url = schemas.StrSchema
            account_url = schemas.StrSchema
        
            @staticmethod
            def account_balance() -> typing.Type['BankAccountsGetAccountResponseAccountBalance']:
                return BankAccountsGetAccountResponseAccountBalance
            ...
            @staticmethod
            def bank_addresses() -> typing.Type['BankAccountsGetAccountResponseBankAddresses']:
                return BankAccountsGetAccountResponseBankAddresses
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available-balance"]) -> 'BankAccountsGetAccountResponseAvailableBalance': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["account-balance"]) -> 'BankAccountsGetAccountResponseAccountBalance': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["bank-addresses"]) -> 'BankAccountsGetAccountResponseBankAddresses': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available-balance"]) -> 'BankAccountsGetAccountResponseAvailableBalance': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["account-balance"]) -> 'BankAccountsGetAccountResponseAccountBalance': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["bank-addresses"]) -> typing.Union['BankAccountsGetAccountResponseBankAddresses', schemas.Unset]: ...
