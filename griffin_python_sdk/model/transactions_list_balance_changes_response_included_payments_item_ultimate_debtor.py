...
class TransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account-number", "account-number-code", "bank-id", "bank-id-code", "account-holder", "account-url", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["account-holder"]) -> typing.Union[MetaOapg.properties.account_holder, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account-number", "account-number-code", "bank-id", "bank-id-code", "account-holder", "account-url", ], str]):
    ...
    ) -> 'TransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor':
