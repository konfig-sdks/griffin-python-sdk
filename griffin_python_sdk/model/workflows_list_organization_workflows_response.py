...
class WorkflowsListOrganizationWorkflowsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def workflows() -> typing.Type['WorkflowsListOrganizationWorkflowsResponseWorkflows']:
                return WorkflowsListOrganizationWorkflowsResponseWorkflows
        
            @staticmethod
            def links() -> typing.Type['WorkflowsListOrganizationWorkflowsResponseLinks']:
                return WorkflowsListOrganizationWorkflowsResponseLinks
            __annotations__ = {
                "workflows": workflows,
                "links": links,
            }
    
    links: 'WorkflowsListOrganizationWorkflowsResponseLinks'
    workflows: 'WorkflowsListOrganizationWorkflowsResponseWorkflows'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workflows"]) -> 'WorkflowsListOrganizationWorkflowsResponseWorkflows': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'WorkflowsListOrganizationWorkflowsResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["workflows", "links", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["workflows"]) -> 'WorkflowsListOrganizationWorkflowsResponseWorkflows': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'WorkflowsListOrganizationWorkflowsResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["workflows", "links", ], str]):
