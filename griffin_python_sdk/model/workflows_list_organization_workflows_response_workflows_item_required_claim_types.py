...
class WorkflowsListOrganizationWorkflowsResponseWorkflowsItemRequiredClaimTypes(
    schemas.DictSchema
):
    """
    ...
    ) -> 'WorkflowsListOrganizationWorkflowsResponseWorkflowsItemRequiredClaimTypes':
        return super().__new__(
            cls,
            *args,
            _configuration=_configuration,
