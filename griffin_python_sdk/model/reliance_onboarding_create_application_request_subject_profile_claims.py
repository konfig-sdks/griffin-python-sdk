...
class RelianceOnboardingCreateApplicationRequestSubjectProfileClaims(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RelianceOnboardingCreateApplicationRequestSubjectProfileClaimsItem']:
            return RelianceOnboardingCreateApplicationRequestSubjectProfileClaimsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['RelianceOnboardingCreateApplicationRequestSubjectProfileClaimsItem'], typing.List['RelianceOnboardingCreateApplicationRequestSubjectProfileClaimsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'RelianceOnboardingCreateApplicationRequestSubjectProfileClaims':
    ...
    def __getitem__(self, i: int) -> 'RelianceOnboardingCreateApplicationRequestSubjectProfileClaimsItem':
