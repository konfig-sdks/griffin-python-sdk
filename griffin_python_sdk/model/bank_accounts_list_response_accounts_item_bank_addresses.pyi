...
class BankAccountsListResponseAccountsItemBankAddresses(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['BankAccountsListResponseAccountsItemBankAddressesItem']:
            return BankAccountsListResponseAccountsItemBankAddressesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['BankAccountsListResponseAccountsItemBankAddressesItem'], typing.List['BankAccountsListResponseAccountsItemBankAddressesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'BankAccountsListResponseAccountsItemBankAddresses':
    ...
    def __getitem__(self, i: int) -> 'BankAccountsListResponseAccountsItemBankAddressesItem':
