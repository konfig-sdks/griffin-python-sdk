...
class PaymentsSubmitPaymentSubmissionRequest(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment-scheme"]) -> typing.Union[MetaOapg.properties.payment_scheme, schemas.Unset]: ...
