...
class LegalPersonsCreateNewLegalPersonRequestClaims(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['LegalPersonsCreateNewLegalPersonRequestClaimsItem']:
            return LegalPersonsCreateNewLegalPersonRequestClaimsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['LegalPersonsCreateNewLegalPersonRequestClaimsItem'], typing.List['LegalPersonsCreateNewLegalPersonRequestClaimsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'LegalPersonsCreateNewLegalPersonRequestClaims':
    ...
    def __getitem__(self, i: int) -> 'LegalPersonsCreateNewLegalPersonRequestClaimsItem':
