...
class WebhooksGetAllResponseOrganizationWebhooks(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['WebhooksGetAllResponseOrganizationWebhooksItem']:
            return WebhooksGetAllResponseOrganizationWebhooksItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['WebhooksGetAllResponseOrganizationWebhooksItem'], typing.List['WebhooksGetAllResponseOrganizationWebhooksItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'WebhooksGetAllResponseOrganizationWebhooks':
    ...
    def __getitem__(self, i: int) -> 'WebhooksGetAllResponseOrganizationWebhooksItem':
