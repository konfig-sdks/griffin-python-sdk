...
class RelianceOnboardingCreateApplicationRequestRelatedProfilesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def subject_association() -> typing.Type['RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociation']:
                return RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociation
        
            @staticmethod
            def claims() -> typing.Type['RelianceOnboardingCreateApplicationRequestRelatedProfilesItemClaims']:
                return RelianceOnboardingCreateApplicationRequestRelatedProfilesItemClaims
            __annotations__ = {
                "display-name": display_name,
                "subject-association": subject_association,
                "claims": claims,
            }
    
    claims: 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItemClaims'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["display-name"]) -> MetaOapg.properties.display_name: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subject-association"]) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociation': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["claims"]) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItemClaims': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["display-name", "subject-association", "claims", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subject-association"]) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItemSubjectAssociation': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["claims"]) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItemClaims': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["display-name", "subject-association", "claims", ], str]):
    ...
    ) -> 'RelianceOnboardingCreateApplicationRequestRelatedProfilesItem':
