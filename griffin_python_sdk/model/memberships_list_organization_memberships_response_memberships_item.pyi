...
class MembershipsListOrganizationMembershipsResponseMembershipsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            membership_url = schemas.StrSchema
            membership_roles_url = schemas.StrSchema
        
            @staticmethod
            def organization() -> typing.Type['MembershipsListOrganizationMembershipsResponseMembershipsItemOrganization']:
                return MembershipsListOrganizationMembershipsResponseMembershipsItemOrganization
        
            @staticmethod
            def roles() -> typing.Type['MembershipsListOrganizationMembershipsResponseMembershipsItemRoles']:
                return MembershipsListOrganizationMembershipsResponseMembershipsItemRoles
        
            @staticmethod
            def user() -> typing.Type['MembershipsListOrganizationMembershipsResponseMembershipsItemUser']:
                return MembershipsListOrganizationMembershipsResponseMembershipsItemUser
            created_at = schemas.DateTimeSchema
            __annotations__ = {
                "membership-url": membership_url,
                "membership-roles-url": membership_roles_url,
    ...
    organization: 'MembershipsListOrganizationMembershipsResponseMembershipsItemOrganization'
    roles: 'MembershipsListOrganizationMembershipsResponseMembershipsItemRoles'
    user: 'MembershipsListOrganizationMembershipsResponseMembershipsItemUser'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["membership-url"]) -> MetaOapg.properties.membership_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["membership-roles-url"]) -> MetaOapg.properties.membership_roles_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["organization"]) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItemOrganization': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["roles"]) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItemRoles': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["user"]) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItemUser': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["membership-url", "membership-roles-url", "organization", "roles", "user", "created-at", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["membership-url"]) -> MetaOapg.properties.membership_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["membership-roles-url"]) -> MetaOapg.properties.membership_roles_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["organization"]) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItemOrganization': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["roles"]) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItemRoles': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["user"]) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItemUser': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["membership-url", "membership-roles-url", "organization", "roles", "user", "created-at", ], str]):
    ...
    ) -> 'MembershipsListOrganizationMembershipsResponseMembershipsItem':
