...
class PaymentsGetSubmissionResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def submission_scheme_information() -> typing.Type['PaymentsGetSubmissionResponseSubmissionSchemeInformation']:
                return PaymentsGetSubmissionResponseSubmissionSchemeInformation
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["submission-scheme-information"]) -> 'PaymentsGetSubmissionResponseSubmissionSchemeInformation': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["submission-scheme-information"]) -> 'PaymentsGetSubmissionResponseSubmissionSchemeInformation': ...
