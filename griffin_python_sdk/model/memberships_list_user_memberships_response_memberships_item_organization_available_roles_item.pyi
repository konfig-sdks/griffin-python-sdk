...
class MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem':
