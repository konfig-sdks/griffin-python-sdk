...
class DecisionsListForLegalPersonResponseDecisions(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DecisionsListForLegalPersonResponseDecisionsItem']:
            return DecisionsListForLegalPersonResponseDecisionsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['DecisionsListForLegalPersonResponseDecisionsItem'], typing.List['DecisionsListForLegalPersonResponseDecisionsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'DecisionsListForLegalPersonResponseDecisions':
    ...
    def __getitem__(self, i: int) -> 'DecisionsListForLegalPersonResponseDecisionsItem':
