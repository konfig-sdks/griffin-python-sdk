...
class PaymentsCreateRequestRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def creditor() -> typing.Type['PaymentsCreateRequestRequestCreditor']:
                return PaymentsCreateRequestRequestCreditor
        
            @staticmethod
            def payment_amount() -> typing.Type['PaymentsCreateRequestRequestPaymentAmount']:
                return PaymentsCreateRequestRequestPaymentAmount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["creditor"]) -> 'PaymentsCreateRequestRequestCreditor': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment-amount"]) -> 'PaymentsCreateRequestRequestPaymentAmount': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["creditor", "payment-amount", "payment-reference", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["creditor"]) -> 'PaymentsCreateRequestRequestCreditor': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment-amount"]) -> 'PaymentsCreateRequestRequestPaymentAmount': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["creditor", "payment-amount", "payment-reference", ], str]):
