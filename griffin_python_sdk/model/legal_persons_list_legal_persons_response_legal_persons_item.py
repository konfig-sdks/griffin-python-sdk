...
class LegalPersonsListLegalPersonsResponseLegalPersonsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def latest_decision() -> typing.Type['LegalPersonsListLegalPersonsResponseLegalPersonsItemLatestDecision']:
                return LegalPersonsListLegalPersonsResponseLegalPersonsItemLatestDecision
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["latest-decision"]) -> 'LegalPersonsListLegalPersonsResponseLegalPersonsItemLatestDecision': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["latest-decision"]) -> typing.Union['LegalPersonsListLegalPersonsResponseLegalPersonsItemLatestDecision', schemas.Unset]: ...
    ...
    ) -> 'LegalPersonsListLegalPersonsResponseLegalPersonsItem':
