...
class LegalPersonsUpdateLegalPersonResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def latest_decision() -> typing.Type['LegalPersonsUpdateLegalPersonResponseLatestDecision']:
                return LegalPersonsUpdateLegalPersonResponseLatestDecision
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["latest-decision"]) -> 'LegalPersonsUpdateLegalPersonResponseLatestDecision': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["latest-decision"]) -> typing.Union['LegalPersonsUpdateLegalPersonResponseLatestDecision', schemas.Unset]: ...
    ...
    ) -> 'LegalPersonsUpdateLegalPersonResponse':
