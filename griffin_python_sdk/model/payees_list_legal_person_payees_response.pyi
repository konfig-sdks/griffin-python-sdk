...
class PayeesListLegalPersonPayeesResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payees() -> typing.Type['PayeesListLegalPersonPayeesResponsePayees']:
                return PayeesListLegalPersonPayeesResponsePayees
        
            @staticmethod
            def links() -> typing.Type['PayeesListLegalPersonPayeesResponseLinks']:
                return PayeesListLegalPersonPayeesResponseLinks
            __annotations__ = {
                "payees": payees,
                "links": links,
            }
    
    payees: 'PayeesListLegalPersonPayeesResponsePayees'
    links: 'PayeesListLegalPersonPayeesResponseLinks'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payees"]) -> 'PayeesListLegalPersonPayeesResponsePayees': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'PayeesListLegalPersonPayeesResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["payees", "links", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payees"]) -> 'PayeesListLegalPersonPayeesResponsePayees': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'PayeesListLegalPersonPayeesResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["payees", "links", ], str]):
