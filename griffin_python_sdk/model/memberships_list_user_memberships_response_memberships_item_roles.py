...
class MembershipsListUserMembershipsResponseMembershipsItemRoles(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MembershipsListUserMembershipsResponseMembershipsItemRolesItem']:
            return MembershipsListUserMembershipsResponseMembershipsItemRolesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['MembershipsListUserMembershipsResponseMembershipsItemRolesItem'], typing.List['MembershipsListUserMembershipsResponseMembershipsItemRolesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'MembershipsListUserMembershipsResponseMembershipsItemRoles':
    ...
    def __getitem__(self, i: int) -> 'MembershipsListUserMembershipsResponseMembershipsItemRolesItem':
