...
class PooledAccountMembershipListLegalPersonsResponsePoolMembers(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PooledAccountMembershipListLegalPersonsResponsePoolMembersItem']:
            return PooledAccountMembershipListLegalPersonsResponsePoolMembersItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PooledAccountMembershipListLegalPersonsResponsePoolMembersItem'], typing.List['PooledAccountMembershipListLegalPersonsResponsePoolMembersItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PooledAccountMembershipListLegalPersonsResponsePoolMembers':
    ...
    def __getitem__(self, i: int) -> 'PooledAccountMembershipListLegalPersonsResponsePoolMembersItem':
