...
class LegalPersonsListLegalPersonsResponseMetaPage(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def estimated_total() -> typing.Type['LegalPersonsListLegalPersonsResponseMetaPageEstimatedTotal']:
                return LegalPersonsListLegalPersonsResponseMetaPageEstimatedTotal
            __annotations__ = {
                "total": total,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["estimated-total"]) -> 'LegalPersonsListLegalPersonsResponseMetaPageEstimatedTotal': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["estimated-total"]) -> typing.Union['LegalPersonsListLegalPersonsResponseMetaPageEstimatedTotal', schemas.Unset]: ...
    ...
    ) -> 'LegalPersonsListLegalPersonsResponseMetaPage':
