...
class PaymentsListBankAccountAdmissionsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def admissions() -> typing.Type['PaymentsListBankAccountAdmissionsResponseAdmissions']:
                return PaymentsListBankAccountAdmissionsResponseAdmissions
        
            @staticmethod
            def links() -> typing.Type['PaymentsListBankAccountAdmissionsResponseLinks']:
                return PaymentsListBankAccountAdmissionsResponseLinks
            __annotations__ = {
                "admissions": admissions,
                "links": links,
            }
    
    admissions: 'PaymentsListBankAccountAdmissionsResponseAdmissions'
    links: 'PaymentsListBankAccountAdmissionsResponseLinks'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["admissions"]) -> 'PaymentsListBankAccountAdmissionsResponseAdmissions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'PaymentsListBankAccountAdmissionsResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["admissions", "links", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["admissions"]) -> 'PaymentsListBankAccountAdmissionsResponseAdmissions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'PaymentsListBankAccountAdmissionsResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["admissions", "links", ], str]):
