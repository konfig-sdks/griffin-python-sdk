...
class VerificationsListForLegalPersonResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def verifications() -> typing.Type['VerificationsListForLegalPersonResponseVerifications']:
                return VerificationsListForLegalPersonResponseVerifications
        
            @staticmethod
            def links() -> typing.Type['VerificationsListForLegalPersonResponseLinks']:
                return VerificationsListForLegalPersonResponseLinks
            __annotations__ = {
                "verifications": verifications,
                "links": links,
            }
    
    links: 'VerificationsListForLegalPersonResponseLinks'
    verifications: 'VerificationsListForLegalPersonResponseVerifications'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["verifications"]) -> 'VerificationsListForLegalPersonResponseVerifications': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'VerificationsListForLegalPersonResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["verifications", "links", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["verifications"]) -> 'VerificationsListForLegalPersonResponseVerifications': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'VerificationsListForLegalPersonResponseLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["verifications", "links", ], str]):
