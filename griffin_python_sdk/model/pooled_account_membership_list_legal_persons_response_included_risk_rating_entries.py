...
class PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntries(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem']:
            return PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem'], typing.List['PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntries':
    ...
    def __getitem__(self, i: int) -> 'PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem':
