...
class WebhooksGetAllResponseOrganizationWebhooksItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class webhook_url(
                ...
                class MetaOapg:
                    min_length = 1
            webhook_destination_url = schemas.StrSchema
            test_webhook_url = schemas.StrSchema
            activate_webhook_url = schemas.StrSchema
            deactivate_webhook_url = schemas.StrSchema
            
            
            class webhook_description(
                schemas.StrSchema
            ):
            ...
            __annotations__ = {
                ...
                "webhook-destination-url": webhook_destination_url,
                "test-webhook-url": test_webhook_url,
                "activate-webhook-url": activate_webhook_url,
                "deactivate-webhook-url": deactivate_webhook_url,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["webhook-url"]) -> MetaOapg.properties.webhook_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["webhook-destination-url"]) -> MetaOapg.properties.webhook_destination_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["test-webhook-url"]) -> MetaOapg.properties.test_webhook_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["activate-webhook-url"]) -> MetaOapg.properties.activate_webhook_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["deactivate-webhook-url"]) -> MetaOapg.properties.deactivate_webhook_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["webhook-description"]) -> MetaOapg.properties.webhook_description: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["organization-url", "webhook-url", "webhook-destination-url", "test-webhook-url", "activate-webhook-url", "deactivate-webhook-url", "webhook-description", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["webhook-url"]) -> MetaOapg.properties.webhook_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["webhook-destination-url"]) -> MetaOapg.properties.webhook_destination_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["test-webhook-url"]) -> MetaOapg.properties.test_webhook_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["activate-webhook-url"]) -> MetaOapg.properties.activate_webhook_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deactivate-webhook-url"]) -> MetaOapg.properties.deactivate_webhook_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["webhook-description"]) -> typing.Union[MetaOapg.properties.webhook_description, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["organization-url", "webhook-url", "webhook-destination-url", "test-webhook-url", "activate-webhook-url", "deactivate-webhook-url", "webhook-description", ], str]):
    ...
    ) -> 'WebhooksGetAllResponseOrganizationWebhooksItem':
