...
class BankAccountsUpdateBankAccountResponseBankAddressesItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account-holder", "bank-id-code", "bank-id", "account-number", "account-number-code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account-holder", "bank-id-code", "bank-id", "account-number", "account-number-code", ], str]):
    ...
    ) -> 'BankAccountsUpdateBankAccountResponseBankAddressesItem':
