...
RequiredPaymentsCreateRequestRequest = TypedDict("RequiredPaymentsCreateRequestRequest", {
    "creditor": PaymentsCreateRequestRequestCreditor,

    "payment-amount": PaymentsCreateRequestRequestPaymentAmount,
    })

OptionalPaymentsCreateRequestRequest = TypedDict("OptionalPaymentsCreateRequestRequest", {
    # Free-text field to help identify and categorise payments.
    "payment-reference": str,
    }, total=False)

class PaymentsCreateRequestRequest(RequiredPaymentsCreateRequestRequest, OptionalPaymentsCreateRequestRequest):
    pass
