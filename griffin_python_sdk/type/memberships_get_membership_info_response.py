...
from griffin_python_sdk.type.memberships_get_membership_info_response_organization import MembershipsGetMembershipInfoResponseOrganization
from griffin_python_sdk.type.memberships_get_membership_info_response_roles import MembershipsGetMembershipInfoResponseRoles
from griffin_python_sdk.type.memberships_get_membership_info_response_user import MembershipsGetMembershipInfoResponseUser

RequiredMembershipsGetMembershipInfoResponse = TypedDict("RequiredMembershipsGetMembershipInfoResponse", {
...
OptionalMembershipsGetMembershipInfoResponse = TypedDict("OptionalMembershipsGetMembershipInfoResponse", {
    }, total=False)

class MembershipsGetMembershipInfoResponse(RequiredMembershipsGetMembershipInfoResponse, OptionalMembershipsGetMembershipInfoResponse):
    pass
