...
RequiredApiKeysCreateKeyResponse = TypedDict("RequiredApiKeysCreateKeyResponse", {
...
OptionalApiKeysCreateKeyResponse = TypedDict("OptionalApiKeysCreateKeyResponse", {
    }, total=False)

class ApiKeysCreateKeyResponse(RequiredApiKeysCreateKeyResponse, OptionalApiKeysCreateKeyResponse):
    pass
