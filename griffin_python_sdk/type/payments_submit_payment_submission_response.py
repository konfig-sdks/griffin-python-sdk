...
from griffin_python_sdk.type.payments_submit_payment_submission_response_submission_scheme_information import PaymentsSubmitPaymentSubmissionResponseSubmissionSchemeInformation

RequiredPaymentsSubmitPaymentSubmissionResponse = TypedDict("RequiredPaymentsSubmitPaymentSubmissionResponse", {
    # Specifies the progress of the outbound payment.
    "submission-status": str,

    "submission-scheme-information": PaymentsSubmitPaymentSubmissionResponseSubmissionSchemeInformation,
...
OptionalPaymentsSubmitPaymentSubmissionResponse = TypedDict("OptionalPaymentsSubmitPaymentSubmissionResponse", {
    }, total=False)

class PaymentsSubmitPaymentSubmissionResponse(RequiredPaymentsSubmitPaymentSubmissionResponse, OptionalPaymentsSubmitPaymentSubmissionResponse):
    pass
