...
from griffin_python_sdk.type.companies_house_get_company_details_response_persons_with_significant_control_item_natures_of_control import CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItemNaturesOfControl

RequiredCompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem = TypedDict("RequiredCompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem", {
    # A human readable label for an entity
    "display-name": str,

    "natures-of-control": CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItemNaturesOfControl,

    # The URL of the entity in Companies House
    "companies-house-url": str,
    })

OptionalCompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem = TypedDict("OptionalCompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem", {
    "given-name": str,
...
class CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem(RequiredCompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem, OptionalCompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem):
    pass
