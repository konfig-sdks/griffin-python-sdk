...
RequiredLegalPersonsCreateNewLegalPersonRequest = TypedDict("RequiredLegalPersonsCreateNewLegalPersonRequest", {
...
OptionalLegalPersonsCreateNewLegalPersonRequest = TypedDict("OptionalLegalPersonsCreateNewLegalPersonRequest", {
    "claims": LegalPersonsCreateNewLegalPersonRequestClaims,
    }, total=False)

class LegalPersonsCreateNewLegalPersonRequest(RequiredLegalPersonsCreateNewLegalPersonRequest, OptionalLegalPersonsCreateNewLegalPersonRequest):
    pass
