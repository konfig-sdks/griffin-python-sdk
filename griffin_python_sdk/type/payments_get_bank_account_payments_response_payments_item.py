...
from griffin_python_sdk.type.payments_get_bank_account_payments_response_payments_item_creditor import PaymentsGetBankAccountPaymentsResponsePaymentsItemCreditor
from griffin_python_sdk.type.payments_get_bank_account_payments_response_payments_item_debtor import PaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor
from griffin_python_sdk.type.payments_get_bank_account_payments_response_payments_item_payment_amount import PaymentsGetBankAccountPaymentsResponsePaymentsItemPaymentAmount
from griffin_python_sdk.type.payments_get_bank_account_payments_response_payments_item_ultimate_debtor import PaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor

RequiredPaymentsGetBankAccountPaymentsResponsePaymentsItem = TypedDict("RequiredPaymentsGetBankAccountPaymentsResponsePaymentsItem", {
    ...
    "payment-amount": PaymentsGetBankAccountPaymentsResponsePaymentsItemPaymentAmount,

    "debtor": PaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor,
    })

OptionalPaymentsGetBankAccountPaymentsResponsePaymentsItem = TypedDict("OptionalPaymentsGetBankAccountPaymentsResponsePaymentsItem", {
    # Free-text field to help identify and categorise payments.
    "payment-reference": str,

    "ultimate-debtor": PaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor,
...
class PaymentsGetBankAccountPaymentsResponsePaymentsItem(RequiredPaymentsGetBankAccountPaymentsResponsePaymentsItem, OptionalPaymentsGetBankAccountPaymentsResponsePaymentsItem):
    pass
