...
from griffin_python_sdk.type.legal_persons_update_legal_person_response_latest_decision import LegalPersonsUpdateLegalPersonResponseLatestDecision

RequiredLegalPersonsUpdateLegalPersonResponse = TypedDict("RequiredLegalPersonsUpdateLegalPersonResponse", {
...
OptionalLegalPersonsUpdateLegalPersonResponse = TypedDict("OptionalLegalPersonsUpdateLegalPersonResponse", {
    "latest-decision": LegalPersonsUpdateLegalPersonResponseLatestDecision,
...
class LegalPersonsUpdateLegalPersonResponse(RequiredLegalPersonsUpdateLegalPersonResponse, OptionalLegalPersonsUpdateLegalPersonResponse):
    pass
