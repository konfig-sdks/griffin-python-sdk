...
from griffin_python_sdk.type.transactions_list_balance_changes_response_account_transactions_item_account_balance import TransactionsListBalanceChangesResponseAccountTransactionsItemAccountBalance
from griffin_python_sdk.type.transactions_list_balance_changes_response_account_transactions_item_balance_change import TransactionsListBalanceChangesResponseAccountTransactionsItemBalanceChange

RequiredTransactionsListBalanceChangesResponseAccountTransactionsItem = TypedDict("RequiredTransactionsListBalanceChangesResponseAccountTransactionsItem", {
    # Link to the transaction resource.
    "account-transaction-url": str,

    # When the transaction was posted.
    "post-datetime": datetime,

    # Specifies the direction of a balance change.
    "balance-change-direction": str,

    # Specifies the origin of a balance change, for example a payment
    "transaction-origin-type": str,

    # Link to the bank account resource.
    "account-url": str,

    "balance-change": TransactionsListBalanceChangesResponseAccountTransactionsItemBalanceChange,

    "account-balance": TransactionsListBalanceChangesResponseAccountTransactionsItemAccountBalance,
    })

OptionalTransactionsListBalanceChangesResponseAccountTransactionsItem = TypedDict("OptionalTransactionsListBalanceChangesResponseAccountTransactionsItem", {
...
class TransactionsListBalanceChangesResponseAccountTransactionsItem(RequiredTransactionsListBalanceChangesResponseAccountTransactionsItem, OptionalTransactionsListBalanceChangesResponseAccountTransactionsItem):
    pass
