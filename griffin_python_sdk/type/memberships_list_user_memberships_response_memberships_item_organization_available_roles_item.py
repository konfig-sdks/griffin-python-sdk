...
RequiredMembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem = TypedDict("RequiredMembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem", {
    "description": str,
...
OptionalMembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem = TypedDict("OptionalMembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem", {
    }, total=False)

class MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem(RequiredMembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem, OptionalMembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRolesItem):
    pass
