...
from griffin_python_sdk.type.workflows_get_workflow_response_required_claim_types import WorkflowsGetWorkflowResponseRequiredClaimTypes
from griffin_python_sdk.type.workflows_get_workflow_response_workflow_rules import WorkflowsGetWorkflowResponseWorkflowRules

RequiredWorkflowsGetWorkflowResponse = TypedDict("RequiredWorkflowsGetWorkflowResponse", {
...
OptionalWorkflowsGetWorkflowResponse = TypedDict("OptionalWorkflowsGetWorkflowResponse", {
    "required-claim-types": WorkflowsGetWorkflowResponseRequiredClaimTypes,

    "workflow-rules": WorkflowsGetWorkflowResponseWorkflowRules,
    }, total=False)

class WorkflowsGetWorkflowResponse(RequiredWorkflowsGetWorkflowResponse, OptionalWorkflowsGetWorkflowResponse):
    pass
