...
RequiredPaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor = TypedDict("RequiredPaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor", {
    # Must be a UK BBAN.
    "account-number": str,
...
OptionalPaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor = TypedDict("OptionalPaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor", {
...
class PaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor(RequiredPaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor, OptionalPaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor):
    pass
