...
RequiredPaymentsGetDetailsResponseDebtor = TypedDict("RequiredPaymentsGetDetailsResponseDebtor", {
    # Must be a UK BBAN.
    "account-number": str,
...
OptionalPaymentsGetDetailsResponseDebtor = TypedDict("OptionalPaymentsGetDetailsResponseDebtor", {
...
class PaymentsGetDetailsResponseDebtor(RequiredPaymentsGetDetailsResponseDebtor, OptionalPaymentsGetDetailsResponseDebtor):
    pass
