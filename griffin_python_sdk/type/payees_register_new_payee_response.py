...
RequiredPayeesRegisterNewPayeeResponse = TypedDict("RequiredPayeesRegisterNewPayeeResponse", {
...
OptionalPayeesRegisterNewPayeeResponse = TypedDict("OptionalPayeesRegisterNewPayeeResponse", {
    # Link to the bank account resource.
    "account-url": str,
    }, total=False)

class PayeesRegisterNewPayeeResponse(RequiredPayeesRegisterNewPayeeResponse, OptionalPayeesRegisterNewPayeeResponse):
    pass
