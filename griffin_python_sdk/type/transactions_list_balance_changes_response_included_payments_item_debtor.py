...
RequiredTransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor = TypedDict("RequiredTransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor", {
    # Must be a UK BBAN.
    "account-number": str,
...
OptionalTransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor = TypedDict("OptionalTransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor", {
...
class TransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor(RequiredTransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor, OptionalTransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor):
    pass
