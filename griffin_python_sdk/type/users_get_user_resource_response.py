...
RequiredUsersGetUserResourceResponse = TypedDict("RequiredUsersGetUserResourceResponse", {
...
OptionalUsersGetUserResourceResponse = TypedDict("OptionalUsersGetUserResourceResponse", {
    "given-name": str,

    "surname": str,
    }, total=False)

class UsersGetUserResourceResponse(RequiredUsersGetUserResourceResponse, OptionalUsersGetUserResourceResponse):
    pass
