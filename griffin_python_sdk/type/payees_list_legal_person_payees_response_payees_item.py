...
RequiredPayeesListLegalPersonPayeesResponsePayeesItem = TypedDict("RequiredPayeesListLegalPersonPayeesResponsePayeesItem", {
...
OptionalPayeesListLegalPersonPayeesResponsePayeesItem = TypedDict("OptionalPayeesListLegalPersonPayeesResponsePayeesItem", {
    # Link to the bank account resource.
    "account-url": str,
    }, total=False)

class PayeesListLegalPersonPayeesResponsePayeesItem(RequiredPayeesListLegalPersonPayeesResponsePayeesItem, OptionalPayeesListLegalPersonPayeesResponsePayeesItem):
    pass
