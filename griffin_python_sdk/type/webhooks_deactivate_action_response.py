...
RequiredWebhooksDeactivateActionResponse = TypedDict("RequiredWebhooksDeactivateActionResponse", {
...
OptionalWebhooksDeactivateActionResponse = TypedDict("OptionalWebhooksDeactivateActionResponse", {
    # A description of the webhook
    "webhook-description": str,
    }, total=False)

class WebhooksDeactivateActionResponse(RequiredWebhooksDeactivateActionResponse, OptionalWebhooksDeactivateActionResponse):
    pass
