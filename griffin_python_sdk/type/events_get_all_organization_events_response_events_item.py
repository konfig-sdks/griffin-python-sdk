...
RequiredEventsGetAllOrganizationEventsResponseEventsItem = TypedDict("RequiredEventsGetAllOrganizationEventsResponseEventsItem", {
    ...
    "event-payload": typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
    })

OptionalEventsGetAllOrganizationEventsResponseEventsItem = TypedDict("OptionalEventsGetAllOrganizationEventsResponseEventsItem", {
    # ISO 8601 formatted date-time.
    "created-at": datetime,
    }, total=False)

class EventsGetAllOrganizationEventsResponseEventsItem(RequiredEventsGetAllOrganizationEventsResponseEventsItem, OptionalEventsGetAllOrganizationEventsResponseEventsItem):
    pass
