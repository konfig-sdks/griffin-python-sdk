...
from griffin_python_sdk.type.memberships_list_organization_memberships_response_memberships_item_organization import MembershipsListOrganizationMembershipsResponseMembershipsItemOrganization
from griffin_python_sdk.type.memberships_list_organization_memberships_response_memberships_item_roles import MembershipsListOrganizationMembershipsResponseMembershipsItemRoles
from griffin_python_sdk.type.memberships_list_organization_memberships_response_memberships_item_user import MembershipsListOrganizationMembershipsResponseMembershipsItemUser

RequiredMembershipsListOrganizationMembershipsResponseMembershipsItem = TypedDict("RequiredMembershipsListOrganizationMembershipsResponseMembershipsItem", {
...
OptionalMembershipsListOrganizationMembershipsResponseMembershipsItem = TypedDict("OptionalMembershipsListOrganizationMembershipsResponseMembershipsItem", {
    }, total=False)

class MembershipsListOrganizationMembershipsResponseMembershipsItem(RequiredMembershipsListOrganizationMembershipsResponseMembershipsItem, OptionalMembershipsListOrganizationMembershipsResponseMembershipsItem):
    pass
