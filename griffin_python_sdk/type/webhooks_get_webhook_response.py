...
RequiredWebhooksGetWebhookResponse = TypedDict("RequiredWebhooksGetWebhookResponse", {
...
OptionalWebhooksGetWebhookResponse = TypedDict("OptionalWebhooksGetWebhookResponse", {
    # A description of the webhook
    "webhook-description": str,
    }, total=False)

class WebhooksGetWebhookResponse(RequiredWebhooksGetWebhookResponse, OptionalWebhooksGetWebhookResponse):
    pass
