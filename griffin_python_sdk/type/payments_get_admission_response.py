...
from griffin_python_sdk.type.payments_get_admission_response_admission_scheme_information import PaymentsGetAdmissionResponseAdmissionSchemeInformation

RequiredPaymentsGetAdmissionResponse = TypedDict("RequiredPaymentsGetAdmissionResponse", {
    # Specifies the progress of the inbound payment.
    "admission-status": str,

    "admission-scheme-information": PaymentsGetAdmissionResponseAdmissionSchemeInformation,
...
OptionalPaymentsGetAdmissionResponse = TypedDict("OptionalPaymentsGetAdmissionResponse", {
    }, total=False)

class PaymentsGetAdmissionResponse(RequiredPaymentsGetAdmissionResponse, OptionalPaymentsGetAdmissionResponse):
    pass
