...
from griffin_python_sdk.type.companies_house_get_company_details_response_company_address import CompaniesHouseGetCompanyDetailsResponseCompanyAddress
from griffin_python_sdk.type.companies_house_get_company_details_response_directors import CompaniesHouseGetCompanyDetailsResponseDirectors
from griffin_python_sdk.type.companies_house_get_company_details_response_persons_with_significant_control import CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControl
from griffin_python_sdk.type.companies_house_get_company_details_response_sic_codes import CompaniesHouseGetCompanyDetailsResponseSicCodes

RequiredCompaniesHouseGetCompanyDetailsResponse = TypedDict("RequiredCompaniesHouseGetCompanyDetailsResponse", {
    "entity-name": str,

    "directors": CompaniesHouseGetCompanyDetailsResponseDirectors,

    "corporation-type": str,

    "company-status": str,

    "persons-with-significant-control": CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControl,

    # ISO 8601 formatted date.
    "date-of-incorporation": date,

    # The entity number assigned by the local register. For UK companies that's the Companies House company number.
    "entity-registration-number": str,
    })

OptionalCompaniesHouseGetCompanyDetailsResponse = TypedDict("OptionalCompaniesHouseGetCompanyDetailsResponse", {
    "company-address": CompaniesHouseGetCompanyDetailsResponseCompanyAddress,

    # ISO 8601 formatted date.
    "date-of-latest-accounts": date,

    # ISO 8601 formatted date.
    "date-of-latest-confirmation-statement": date,

    "accounts-overdue": bool,

    "sic-codes": CompaniesHouseGetCompanyDetailsResponseSicCodes,

    "confirmation-statement-overdue": bool,
    }, total=False)

class CompaniesHouseGetCompanyDetailsResponse(RequiredCompaniesHouseGetCompanyDetailsResponse, OptionalCompaniesHouseGetCompanyDetailsResponse):
    pass
