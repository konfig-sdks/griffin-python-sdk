...
RequiredDecisionsCreateDecisionRequest = TypedDict("RequiredDecisionsCreateDecisionRequest", {
...
OptionalDecisionsCreateDecisionRequest = TypedDict("OptionalDecisionsCreateDecisionRequest", {
    }, total=False)

class DecisionsCreateDecisionRequest(RequiredDecisionsCreateDecisionRequest, OptionalDecisionsCreateDecisionRequest):
    pass
