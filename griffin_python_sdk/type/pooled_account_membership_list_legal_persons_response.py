...
from griffin_python_sdk.type.pooled_account_membership_list_legal_persons_response_included import PooledAccountMembershipListLegalPersonsResponseIncluded
from griffin_python_sdk.type.pooled_account_membership_list_legal_persons_response_links import PooledAccountMembershipListLegalPersonsResponseLinks
from griffin_python_sdk.type.pooled_account_membership_list_legal_persons_response_meta import PooledAccountMembershipListLegalPersonsResponseMeta
from griffin_python_sdk.type.pooled_account_membership_list_legal_persons_response_pool_members import PooledAccountMembershipListLegalPersonsResponsePoolMembers

RequiredPooledAccountMembershipListLegalPersonsResponse = TypedDict("RequiredPooledAccountMembershipListLegalPersonsResponse", {
    "pool-members": PooledAccountMembershipListLegalPersonsResponsePoolMembers,

    "links": PooledAccountMembershipListLegalPersonsResponseLinks,
    })

OptionalPooledAccountMembershipListLegalPersonsResponse = TypedDict("OptionalPooledAccountMembershipListLegalPersonsResponse", {
    "meta": PooledAccountMembershipListLegalPersonsResponseMeta,

    "included": PooledAccountMembershipListLegalPersonsResponseIncluded,
    }, total=False)

class PooledAccountMembershipListLegalPersonsResponse(RequiredPooledAccountMembershipListLegalPersonsResponse, OptionalPooledAccountMembershipListLegalPersonsResponse):
    pass
