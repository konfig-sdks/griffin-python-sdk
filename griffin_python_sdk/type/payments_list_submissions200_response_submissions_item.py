...
from griffin_python_sdk.type.payments_list_submissions200_response_submissions_item_submission_scheme_information import PaymentsListSubmissions200ResponseSubmissionsItemSubmissionSchemeInformation

RequiredPaymentsListSubmissions200ResponseSubmissionsItem = TypedDict("RequiredPaymentsListSubmissions200ResponseSubmissionsItem", {
    # Specifies the progress of the outbound payment.
    "submission-status": str,

    "submission-scheme-information": PaymentsListSubmissions200ResponseSubmissionsItemSubmissionSchemeInformation,
...
OptionalPaymentsListSubmissions200ResponseSubmissionsItem = TypedDict("OptionalPaymentsListSubmissions200ResponseSubmissionsItem", {
    }, total=False)

class PaymentsListSubmissions200ResponseSubmissionsItem(RequiredPaymentsListSubmissions200ResponseSubmissionsItem, OptionalPaymentsListSubmissions200ResponseSubmissionsItem):
    pass
