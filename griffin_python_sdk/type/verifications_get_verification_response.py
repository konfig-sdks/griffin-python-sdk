...
RequiredVerificationsGetVerificationResponse = TypedDict("RequiredVerificationsGetVerificationResponse", {
...
OptionalVerificationsGetVerificationResponse = TypedDict("OptionalVerificationsGetVerificationResponse", {
    # ISO 8601 formatted date-time.
    "updated-at": datetime,
...
class VerificationsGetVerificationResponse(RequiredVerificationsGetVerificationResponse, OptionalVerificationsGetVerificationResponse):
    pass
