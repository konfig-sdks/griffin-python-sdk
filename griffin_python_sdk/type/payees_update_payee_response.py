...
RequiredPayeesUpdatePayeeResponse = TypedDict("RequiredPayeesUpdatePayeeResponse", {
...
OptionalPayeesUpdatePayeeResponse = TypedDict("OptionalPayeesUpdatePayeeResponse", {
    # Link to the bank account resource.
    "account-url": str,
    }, total=False)

class PayeesUpdatePayeeResponse(RequiredPayeesUpdatePayeeResponse, OptionalPayeesUpdatePayeeResponse):
    pass
