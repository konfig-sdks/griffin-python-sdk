...
from griffin_python_sdk.type.legal_persons_list_legal_persons_response_included_risk_rating_entries_item_manually_created_by import LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItemManuallyCreatedBy

RequiredLegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItem = TypedDict("RequiredLegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItem", {
...
OptionalLegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItem = TypedDict("OptionalLegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItem", {
    # Rationale for overriding the risk rating.
    "notes": str,

    "manually-created-by": LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItemManuallyCreatedBy,
...
class LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItem(RequiredLegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItem, OptionalLegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItem):
    pass
