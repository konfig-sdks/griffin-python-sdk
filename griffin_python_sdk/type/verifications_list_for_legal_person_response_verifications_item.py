...
RequiredVerificationsListForLegalPersonResponseVerificationsItem = TypedDict("RequiredVerificationsListForLegalPersonResponseVerificationsItem", {
...
OptionalVerificationsListForLegalPersonResponseVerificationsItem = TypedDict("OptionalVerificationsListForLegalPersonResponseVerificationsItem", {
    # ISO 8601 formatted date-time.
    "updated-at": datetime,
...
class VerificationsListForLegalPersonResponseVerificationsItem(RequiredVerificationsListForLegalPersonResponseVerificationsItem, OptionalVerificationsListForLegalPersonResponseVerificationsItem):
    pass
