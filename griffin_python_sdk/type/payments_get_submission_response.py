...
from griffin_python_sdk.type.payments_get_submission_response_submission_scheme_information import PaymentsGetSubmissionResponseSubmissionSchemeInformation

RequiredPaymentsGetSubmissionResponse = TypedDict("RequiredPaymentsGetSubmissionResponse", {
    # Specifies the progress of the outbound payment.
    "submission-status": str,

    "submission-scheme-information": PaymentsGetSubmissionResponseSubmissionSchemeInformation,
...
OptionalPaymentsGetSubmissionResponse = TypedDict("OptionalPaymentsGetSubmissionResponse", {
    }, total=False)

class PaymentsGetSubmissionResponse(RequiredPaymentsGetSubmissionResponse, OptionalPaymentsGetSubmissionResponse):
    pass
