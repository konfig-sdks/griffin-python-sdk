...
RequiredWebhooksGetAllResponseOrganizationWebhooksItem = TypedDict("RequiredWebhooksGetAllResponseOrganizationWebhooksItem", {
    ...
    "webhook-destination-url": str,

    # Test a webhook
    "test-webhook-url": str,

    # Activate a webhook
    "activate-webhook-url": str,

    # Deactivate a webhook
    "deactivate-webhook-url": str,
    })

OptionalWebhooksGetAllResponseOrganizationWebhooksItem = TypedDict("OptionalWebhooksGetAllResponseOrganizationWebhooksItem", {
    # A description of the webhook
    "webhook-description": str,
    }, total=False)

class WebhooksGetAllResponseOrganizationWebhooksItem(RequiredWebhooksGetAllResponseOrganizationWebhooksItem, OptionalWebhooksGetAllResponseOrganizationWebhooksItem):
    pass
