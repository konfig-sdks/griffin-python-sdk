...
RequiredWebhooksUpdateWebhookResponse = TypedDict("RequiredWebhooksUpdateWebhookResponse", {
...
OptionalWebhooksUpdateWebhookResponse = TypedDict("OptionalWebhooksUpdateWebhookResponse", {
    # A description of the webhook
    "webhook-description": str,
    }, total=False)

class WebhooksUpdateWebhookResponse(RequiredWebhooksUpdateWebhookResponse, OptionalWebhooksUpdateWebhookResponse):
    pass
