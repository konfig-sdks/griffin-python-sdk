...
from griffin_python_sdk.type.organizations_get_details_response_available_roles import OrganizationsGetDetailsResponseAvailableRoles

RequiredOrganizationsGetDetailsResponse = TypedDict("RequiredOrganizationsGetDetailsResponse", {
    ...
    "available-roles": OrganizationsGetDetailsResponseAvailableRoles,
...
OptionalOrganizationsGetDetailsResponse = TypedDict("OptionalOrganizationsGetDetailsResponse", {
    # Link to the [Reliance onboarding](http://docs.griffin.com).
    "organization-onboarding-applications-url": str,
    }, total=False)

class OrganizationsGetDetailsResponse(RequiredOrganizationsGetDetailsResponse, OptionalOrganizationsGetDetailsResponse):
    pass
