...
RequiredCompaniesHouseGetCompanyDetailsResponseCompanyAddress = TypedDict("RequiredCompaniesHouseGetCompanyDetailsResponseCompanyAddress", {
    })

OptionalCompaniesHouseGetCompanyDetailsResponseCompanyAddress = TypedDict("OptionalCompaniesHouseGetCompanyDetailsResponseCompanyAddress", {
    "building-number": str,
    ...
    "country-code": typing.Union[bool, date, datetime, dict, float, int, list, str, None],
    }, total=False)

class CompaniesHouseGetCompanyDetailsResponseCompanyAddress(RequiredCompaniesHouseGetCompanyDetailsResponseCompanyAddress, OptionalCompaniesHouseGetCompanyDetailsResponseCompanyAddress):
    pass
