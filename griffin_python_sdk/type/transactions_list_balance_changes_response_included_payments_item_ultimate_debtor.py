...
RequiredTransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor = TypedDict("RequiredTransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor", {
    # Must be a UK BBAN.
    "account-number": str,
...
OptionalTransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor = TypedDict("OptionalTransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor", {
...
class TransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor(RequiredTransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor, OptionalTransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor):
    pass
