...
from griffin_python_sdk.type.payments_get_details_response_creditor import PaymentsGetDetailsResponseCreditor
from griffin_python_sdk.type.payments_get_details_response_debtor import PaymentsGetDetailsResponseDebtor
from griffin_python_sdk.type.payments_get_details_response_payment_amount import PaymentsGetDetailsResponsePaymentAmount
from griffin_python_sdk.type.payments_get_details_response_ultimate_debtor import PaymentsGetDetailsResponseUltimateDebtor

RequiredPaymentsGetDetailsResponse = TypedDict("RequiredPaymentsGetDetailsResponse", {
    ...
    "payment-amount": PaymentsGetDetailsResponsePaymentAmount,

    "debtor": PaymentsGetDetailsResponseDebtor,
    })

OptionalPaymentsGetDetailsResponse = TypedDict("OptionalPaymentsGetDetailsResponse", {
    # Free-text field to help identify and categorise payments.
    "payment-reference": str,

    "ultimate-debtor": PaymentsGetDetailsResponseUltimateDebtor,
...
class PaymentsGetDetailsResponse(RequiredPaymentsGetDetailsResponse, OptionalPaymentsGetDetailsResponse):
    pass
