...
RequiredPaymentsCreateRequestResponseDebtor = TypedDict("RequiredPaymentsCreateRequestResponseDebtor", {
    # Must be a UK BBAN.
    "account-number": str,
...
OptionalPaymentsCreateRequestResponseDebtor = TypedDict("OptionalPaymentsCreateRequestResponseDebtor", {
...
class PaymentsCreateRequestResponseDebtor(RequiredPaymentsCreateRequestResponseDebtor, OptionalPaymentsCreateRequestResponseDebtor):
    pass
