...
from griffin_python_sdk.type.bank_accounts_list_response_included_legal_persons_item_latest_decision import BankAccountsListResponseIncludedLegalPersonsItemLatestDecision

RequiredBankAccountsListResponseIncludedLegalPersonsItem = TypedDict("RequiredBankAccountsListResponseIncludedLegalPersonsItem", {
...
OptionalBankAccountsListResponseIncludedLegalPersonsItem = TypedDict("OptionalBankAccountsListResponseIncludedLegalPersonsItem", {
    "latest-decision": BankAccountsListResponseIncludedLegalPersonsItemLatestDecision,
...
class BankAccountsListResponseIncludedLegalPersonsItem(RequiredBankAccountsListResponseIncludedLegalPersonsItem, OptionalBankAccountsListResponseIncludedLegalPersonsItem):
    pass
