...
RequiredPooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision = TypedDict("RequiredPooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision", {
...
OptionalPooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision = TypedDict("OptionalPooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision", {
    # Link to the [user](http://docs.griffin.com) that made the decision (if applicable).
    "decision-user-url": str,

    # Username of the [user](http://docs.griffin.com) that made the decision (if applicable).
    "decision-user-username": str,

    # Indicates that an Ops user has created the decision.
    "decision-ops-user": str,
    }, total=False)

class PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision(RequiredPooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision, OptionalPooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision):
    pass
