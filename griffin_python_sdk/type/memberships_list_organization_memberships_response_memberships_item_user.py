...
RequiredMembershipsListOrganizationMembershipsResponseMembershipsItemUser = TypedDict("RequiredMembershipsListOrganizationMembershipsResponseMembershipsItemUser", {
    ...
    # Link to the user's [api keys](http://docs.griffin.com).
    "api-keys-url": str,

    # Link to the user's [memberships](http://docs.griffin.com).
    "user-memberships-url": str,
    })

OptionalMembershipsListOrganizationMembershipsResponseMembershipsItemUser = TypedDict("OptionalMembershipsListOrganizationMembershipsResponseMembershipsItemUser", {
    "given-name": str,

    "surname": str,
    }, total=False)

class MembershipsListOrganizationMembershipsResponseMembershipsItemUser(RequiredMembershipsListOrganizationMembershipsResponseMembershipsItemUser, OptionalMembershipsListOrganizationMembershipsResponseMembershipsItemUser):
    pass
