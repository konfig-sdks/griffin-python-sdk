...
from griffin_python_sdk.type.legal_persons_create_new_legal_person_response_latest_decision import LegalPersonsCreateNewLegalPersonResponseLatestDecision

RequiredLegalPersonsCreateNewLegalPersonResponse = TypedDict("RequiredLegalPersonsCreateNewLegalPersonResponse", {
...
OptionalLegalPersonsCreateNewLegalPersonResponse = TypedDict("OptionalLegalPersonsCreateNewLegalPersonResponse", {
    "latest-decision": LegalPersonsCreateNewLegalPersonResponseLatestDecision,
...
class LegalPersonsCreateNewLegalPersonResponse(RequiredLegalPersonsCreateNewLegalPersonResponse, OptionalLegalPersonsCreateNewLegalPersonResponse):
    pass
