...
RequiredApiKeysGetKeyDetailsResponse = TypedDict("RequiredApiKeysGetKeyDetailsResponse", {
...
OptionalApiKeysGetKeyDetailsResponse = TypedDict("OptionalApiKeysGetKeyDetailsResponse", {
    }, total=False)

class ApiKeysGetKeyDetailsResponse(RequiredApiKeysGetKeyDetailsResponse, OptionalApiKeysGetKeyDetailsResponse):
    pass
