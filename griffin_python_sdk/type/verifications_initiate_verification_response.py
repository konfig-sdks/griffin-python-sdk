...
RequiredVerificationsInitiateVerificationResponse = TypedDict("RequiredVerificationsInitiateVerificationResponse", {
...
OptionalVerificationsInitiateVerificationResponse = TypedDict("OptionalVerificationsInitiateVerificationResponse", {
    # ISO 8601 formatted date-time.
    "updated-at": datetime,
...
class VerificationsInitiateVerificationResponse(RequiredVerificationsInitiateVerificationResponse, OptionalVerificationsInitiateVerificationResponse):
    pass
