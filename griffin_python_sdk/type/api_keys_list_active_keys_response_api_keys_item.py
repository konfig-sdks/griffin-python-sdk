...
RequiredApiKeysListActiveKeysResponseApiKeysItem = TypedDict("RequiredApiKeysListActiveKeysResponseApiKeysItem", {
...
OptionalApiKeysListActiveKeysResponseApiKeysItem = TypedDict("OptionalApiKeysListActiveKeysResponseApiKeysItem", {
    }, total=False)

class ApiKeysListActiveKeysResponseApiKeysItem(RequiredApiKeysListActiveKeysResponseApiKeysItem, OptionalApiKeysListActiveKeysResponseApiKeysItem):
    pass
