...
from griffin_python_sdk.type.workflows_list_organization_workflows_response_workflows_item_required_claim_types import WorkflowsListOrganizationWorkflowsResponseWorkflowsItemRequiredClaimTypes
from griffin_python_sdk.type.workflows_list_organization_workflows_response_workflows_item_workflow_rules import WorkflowsListOrganizationWorkflowsResponseWorkflowsItemWorkflowRules

RequiredWorkflowsListOrganizationWorkflowsResponseWorkflowsItem = TypedDict("RequiredWorkflowsListOrganizationWorkflowsResponseWorkflowsItem", {
...
OptionalWorkflowsListOrganizationWorkflowsResponseWorkflowsItem = TypedDict("OptionalWorkflowsListOrganizationWorkflowsResponseWorkflowsItem", {
    "required-claim-types": WorkflowsListOrganizationWorkflowsResponseWorkflowsItemRequiredClaimTypes,

    "workflow-rules": WorkflowsListOrganizationWorkflowsResponseWorkflowsItemWorkflowRules,
    }, total=False)

class WorkflowsListOrganizationWorkflowsResponseWorkflowsItem(RequiredWorkflowsListOrganizationWorkflowsResponseWorkflowsItem, OptionalWorkflowsListOrganizationWorkflowsResponseWorkflowsItem):
    pass
