...
from griffin_python_sdk.type.transactions_list_balance_changes_response_included_payments_item_creditor import TransactionsListBalanceChangesResponseIncludedPaymentsItemCreditor
from griffin_python_sdk.type.transactions_list_balance_changes_response_included_payments_item_debtor import TransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor
from griffin_python_sdk.type.transactions_list_balance_changes_response_included_payments_item_payment_amount import TransactionsListBalanceChangesResponseIncludedPaymentsItemPaymentAmount
from griffin_python_sdk.type.transactions_list_balance_changes_response_included_payments_item_ultimate_debtor import TransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor

RequiredTransactionsListBalanceChangesResponseIncludedPaymentsItem = TypedDict("RequiredTransactionsListBalanceChangesResponseIncludedPaymentsItem", {
    ...
    "payment-amount": TransactionsListBalanceChangesResponseIncludedPaymentsItemPaymentAmount,

    "debtor": TransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor,
    })

OptionalTransactionsListBalanceChangesResponseIncludedPaymentsItem = TypedDict("OptionalTransactionsListBalanceChangesResponseIncludedPaymentsItem", {
    # Free-text field to help identify and categorise payments.
    "payment-reference": str,

    "ultimate-debtor": TransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor,

    # Link to the endpoint for listing payment admissions.
    "payment-admissions-url": str,

    # Link to the endpoint for creating and listing payment submissions.
    "payment-submissions-url": str,
    }, total=False)

class TransactionsListBalanceChangesResponseIncludedPaymentsItem(RequiredTransactionsListBalanceChangesResponseIncludedPaymentsItem, OptionalTransactionsListBalanceChangesResponseIncludedPaymentsItem):
    pass
