...
RequiredEventsGetEventResponse = TypedDict("RequiredEventsGetEventResponse", {
...
OptionalEventsGetEventResponse = TypedDict("OptionalEventsGetEventResponse", {
    # ISO 8601 formatted date-time.
    "created-at": datetime,
    }, total=False)

class EventsGetEventResponse(RequiredEventsGetEventResponse, OptionalEventsGetEventResponse):
    pass
