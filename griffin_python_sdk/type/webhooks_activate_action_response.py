...
RequiredWebhooksActivateActionResponse = TypedDict("RequiredWebhooksActivateActionResponse", {
...
OptionalWebhooksActivateActionResponse = TypedDict("OptionalWebhooksActivateActionResponse", {
    # A description of the webhook
    "webhook-description": str,
    }, total=False)

class WebhooksActivateActionResponse(RequiredWebhooksActivateActionResponse, OptionalWebhooksActivateActionResponse):
    pass
