...
RequiredApiKeysListActiveKeys200ResponseApiKeysItem = TypedDict("RequiredApiKeysListActiveKeys200ResponseApiKeysItem", {
    # The resource path for the API key
    "api-key-url": str,

    # The immutable display name for the API key
    "api-key-name": typing.Union[bool, date, datetime, dict, float, int, list, str, None],
...
OptionalApiKeysListActiveKeys200ResponseApiKeysItem = TypedDict("OptionalApiKeysListActiveKeys200ResponseApiKeysItem", {
    }, total=False)

class ApiKeysListActiveKeys200ResponseApiKeysItem(RequiredApiKeysListActiveKeys200ResponseApiKeysItem, OptionalApiKeysListActiveKeys200ResponseApiKeysItem):
    pass
