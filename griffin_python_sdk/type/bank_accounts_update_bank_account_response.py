...
from griffin_python_sdk.type.bank_accounts_update_bank_account_response_account_balance import BankAccountsUpdateBankAccountResponseAccountBalance
from griffin_python_sdk.type.bank_accounts_update_bank_account_response_available_balance import BankAccountsUpdateBankAccountResponseAvailableBalance
from griffin_python_sdk.type.bank_accounts_update_bank_account_response_bank_addresses import BankAccountsUpdateBankAccountResponseBankAddresses

RequiredBankAccountsUpdateBankAccountResponse = TypedDict("RequiredBankAccountsUpdateBankAccountResponse", {
    # Link to the [payment submissions](http://docs.griffin.com) debiting from this account.
    "account-submissions-url": str,

    # Specifies whether the bank account has restrictions applied by Griffin.
    "account-restricted": bool,

    # Link to the [payments](http://docs.griffin.com) associated with this account.
    "account-payments-url": str,

    # Link to the [payment admissions](http://docs.griffin.com) crediting to this account.
    "account-admissions-url": str,
    ...
    "close-account-url": str,

    "available-balance": BankAccountsUpdateBankAccountResponseAvailableBalance,

    # Link to the [transactions](http://docs.griffin.com) associated with this account.
    "account-transactions-url": str,

    # Link to the bank account resource.
    "account-url": str,

    "account-balance": BankAccountsUpdateBankAccountResponseAccountBalance,
    })

OptionalBankAccountsUpdateBankAccountResponse = TypedDict("OptionalBankAccountsUpdateBankAccountResponse", {
    # Link to the list of [pool members](http://docs.griffin.com) associated with this account.
    "pooled-account-memberships-url": str,

    # Specifies the type of client money account.
    "client-money-type": str,

    # Link to manage [pooled account membership](http://docs.griffin.com).
    "pooled-account-membership-updates-url": str,

    "bank-addresses": BankAccountsUpdateBankAccountResponseBankAddresses,
...
class BankAccountsUpdateBankAccountResponse(RequiredBankAccountsUpdateBankAccountResponse, OptionalBankAccountsUpdateBankAccountResponse):
    pass
