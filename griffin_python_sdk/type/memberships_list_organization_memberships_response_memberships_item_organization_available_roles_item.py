...
RequiredMembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem = TypedDict("RequiredMembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem", {
    "description": str,

    # The mutable display name for the Organisation
    "display-name": str,

    # Link to the [role](http://docs.griffin.com).
    "role-url": str,
    })

OptionalMembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem = TypedDict("OptionalMembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem", {
    }, total=False)

class MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem(RequiredMembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem, OptionalMembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRolesItem):
    pass
