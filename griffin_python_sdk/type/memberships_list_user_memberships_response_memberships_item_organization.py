...
from griffin_python_sdk.type.memberships_list_user_memberships_response_memberships_item_organization_available_roles import MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRoles

RequiredMembershipsListUserMembershipsResponseMembershipsItemOrganization = TypedDict("RequiredMembershipsListUserMembershipsResponseMembershipsItemOrganization", {
    ...
    "available-roles": MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRoles,
...
OptionalMembershipsListUserMembershipsResponseMembershipsItemOrganization = TypedDict("OptionalMembershipsListUserMembershipsResponseMembershipsItemOrganization", {
    # Link to the [Reliance onboarding](http://docs.griffin.com).
    "organization-onboarding-applications-url": str,
    }, total=False)

class MembershipsListUserMembershipsResponseMembershipsItemOrganization(RequiredMembershipsListUserMembershipsResponseMembershipsItemOrganization, OptionalMembershipsListUserMembershipsResponseMembershipsItemOrganization):
    pass
