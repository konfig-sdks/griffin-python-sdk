...
RequiredRolesGetRoleResponse = TypedDict("RequiredRolesGetRoleResponse", {
    "description": str,
...
OptionalRolesGetRoleResponse = TypedDict("OptionalRolesGetRoleResponse", {
    }, total=False)

class RolesGetRoleResponse(RequiredRolesGetRoleResponse, OptionalRolesGetRoleResponse):
    pass
