...
from griffin_python_sdk.type.payments_list_submissions_response_submissions_item_submission_scheme_information import PaymentsListSubmissionsResponseSubmissionsItemSubmissionSchemeInformation

RequiredPaymentsListSubmissionsResponseSubmissionsItem = TypedDict("RequiredPaymentsListSubmissionsResponseSubmissionsItem", {
    # Specifies the progress of the outbound payment.
    "submission-status": str,

    "submission-scheme-information": PaymentsListSubmissionsResponseSubmissionsItemSubmissionSchemeInformation,
...
OptionalPaymentsListSubmissionsResponseSubmissionsItem = TypedDict("OptionalPaymentsListSubmissionsResponseSubmissionsItem", {
    }, total=False)

class PaymentsListSubmissionsResponseSubmissionsItem(RequiredPaymentsListSubmissionsResponseSubmissionsItem, OptionalPaymentsListSubmissionsResponseSubmissionsItem):
    pass
