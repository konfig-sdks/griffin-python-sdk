...
from griffin_python_sdk.type.payments_create_request_response_creditor import PaymentsCreateRequestResponseCreditor
from griffin_python_sdk.type.payments_create_request_response_debtor import PaymentsCreateRequestResponseDebtor
from griffin_python_sdk.type.payments_create_request_response_payment_amount import PaymentsCreateRequestResponsePaymentAmount
from griffin_python_sdk.type.payments_create_request_response_ultimate_debtor import PaymentsCreateRequestResponseUltimateDebtor

RequiredPaymentsCreateRequestResponse = TypedDict("RequiredPaymentsCreateRequestResponse", {
    ...
    "payment-amount": PaymentsCreateRequestResponsePaymentAmount,

    "debtor": PaymentsCreateRequestResponseDebtor,
    })

OptionalPaymentsCreateRequestResponse = TypedDict("OptionalPaymentsCreateRequestResponse", {
    # Free-text field to help identify and categorise payments.
    "payment-reference": str,

    "ultimate-debtor": PaymentsCreateRequestResponseUltimateDebtor,
...
class PaymentsCreateRequestResponse(RequiredPaymentsCreateRequestResponse, OptionalPaymentsCreateRequestResponse):
    pass
