...
RequiredPayeesGetDetailsResponse = TypedDict("RequiredPayeesGetDetailsResponse", {
...
OptionalPayeesGetDetailsResponse = TypedDict("OptionalPayeesGetDetailsResponse", {
    # Link to the bank account resource.
    "account-url": str,
    }, total=False)

class PayeesGetDetailsResponse(RequiredPayeesGetDetailsResponse, OptionalPayeesGetDetailsResponse):
    pass
