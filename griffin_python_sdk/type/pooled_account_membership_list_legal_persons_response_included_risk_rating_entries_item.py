...
from griffin_python_sdk.type.pooled_account_membership_list_legal_persons_response_included_risk_rating_entries_item_manually_created_by import PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItemManuallyCreatedBy

RequiredPooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem = TypedDict("RequiredPooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem", {
...
OptionalPooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem = TypedDict("OptionalPooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem", {
    # Rationale for overriding the risk rating.
    "notes": str,

    "manually-created-by": PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItemManuallyCreatedBy,

    # A link to the [verification](http://docs.griffin.com).
    "verification-url": str,

    "previous-risk-rating": str,
    }, total=False)

class PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem(RequiredPooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem, OptionalPooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem):
    pass
