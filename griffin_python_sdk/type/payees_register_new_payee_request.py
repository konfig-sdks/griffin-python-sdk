...
RequiredPayeesRegisterNewPayeeRequest = TypedDict("RequiredPayeesRegisterNewPayeeRequest", {
...
OptionalPayeesRegisterNewPayeeRequest = TypedDict("OptionalPayeesRegisterNewPayeeRequest", {
    }, total=False)

class PayeesRegisterNewPayeeRequest(RequiredPayeesRegisterNewPayeeRequest, OptionalPayeesRegisterNewPayeeRequest):
    pass
