...
RequiredMembershipsGetMembershipInfoResponseUser = TypedDict("RequiredMembershipsGetMembershipInfoResponseUser", {
...
OptionalMembershipsGetMembershipInfoResponseUser = TypedDict("OptionalMembershipsGetMembershipInfoResponseUser", {
    "given-name": str,

    "surname": str,
    }, total=False)

class MembershipsGetMembershipInfoResponseUser(RequiredMembershipsGetMembershipInfoResponseUser, OptionalMembershipsGetMembershipInfoResponseUser):
    pass
