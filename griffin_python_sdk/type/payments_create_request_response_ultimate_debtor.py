...
RequiredPaymentsCreateRequestResponseUltimateDebtor = TypedDict("RequiredPaymentsCreateRequestResponseUltimateDebtor", {
    # Must be a UK BBAN.
    "account-number": str,
...
OptionalPaymentsCreateRequestResponseUltimateDebtor = TypedDict("OptionalPaymentsCreateRequestResponseUltimateDebtor", {
...
class PaymentsCreateRequestResponseUltimateDebtor(RequiredPaymentsCreateRequestResponseUltimateDebtor, OptionalPaymentsCreateRequestResponseUltimateDebtor):
    pass
