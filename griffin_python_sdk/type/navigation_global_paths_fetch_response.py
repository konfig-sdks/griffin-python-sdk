...
RequiredNavigationGlobalPathsFetchResponse = TypedDict("RequiredNavigationGlobalPathsFetchResponse", {
    # Link to the [organization](http://docs.griffin.com).
    "organizations-url": str,
...
OptionalNavigationGlobalPathsFetchResponse = TypedDict("OptionalNavigationGlobalPathsFetchResponse", {
    "session-url": str,
...
class NavigationGlobalPathsFetchResponse(RequiredNavigationGlobalPathsFetchResponse, OptionalNavigationGlobalPathsFetchResponse):
    pass
