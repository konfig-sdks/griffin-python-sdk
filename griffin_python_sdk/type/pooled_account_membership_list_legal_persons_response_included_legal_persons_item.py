...
from griffin_python_sdk.type.pooled_account_membership_list_legal_persons_response_included_legal_persons_item_latest_decision import PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision

RequiredPooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem = TypedDict("RequiredPooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem", {
    # Specifies if the legal person is an `individual` or a `corporation`.
    "legal-person-type": str,

    # A human readable label for an entity
    "display-name": str,

    # A contextual link to the [legal person](http://docs.griffin.com).
    "legal-person-url": str,

    # Link to [decisions](http://docs.griffin.com) for this [legal person](http://docs.griffin.com).
    "legal-person-decisions-url": str,

    # ISO 8601 formatted date-time.
    "created-at": datetime,

    # Link to all [verifications](http://docs.griffin.com) run against this [legal person](http://docs.griffin.com).
    "legal-person-verifications-url": str,

    # Link to all evidence documents associated with this [legal person](http://docs.griffin.com).
    "legal-person-documents-url": str,
    })

OptionalPooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem = TypedDict("OptionalPooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem", {
    "latest-decision": PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision,

    # A contextual link to the risk rating.
    "latest-risk-rating-url": str,

    # Status of the current [application](http://docs.griffin.com)
    "application-status": str,

    # ISO 8601 formatted date-time.
    "status-changed-at": datetime,

    # Link to the [claims](http://docs.griffin.com) for this [legal person](http://docs.griffin.com).
    "legal-person-claims-url": str,

    # Link to the [payees](http://docs.griffin.com) for this [legal person](http://docs.griffin.com).
    "legal-person-bank-payees-url": str,
    }, total=False)

class PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem(RequiredPooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem, OptionalPooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem):
    pass
