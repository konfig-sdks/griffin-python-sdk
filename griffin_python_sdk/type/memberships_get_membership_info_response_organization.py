...
from griffin_python_sdk.type.memberships_get_membership_info_response_organization_available_roles import MembershipsGetMembershipInfoResponseOrganizationAvailableRoles

RequiredMembershipsGetMembershipInfoResponseOrganization = TypedDict("RequiredMembershipsGetMembershipInfoResponseOrganization", {
    ...
    "available-roles": MembershipsGetMembershipInfoResponseOrganizationAvailableRoles,
...
OptionalMembershipsGetMembershipInfoResponseOrganization = TypedDict("OptionalMembershipsGetMembershipInfoResponseOrganization", {
    # Link to the [Reliance onboarding](http://docs.griffin.com).
    "organization-onboarding-applications-url": str,
    }, total=False)

class MembershipsGetMembershipInfoResponseOrganization(RequiredMembershipsGetMembershipInfoResponseOrganization, OptionalMembershipsGetMembershipInfoResponseOrganization):
    pass
