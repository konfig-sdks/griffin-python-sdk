...
RequiredMembershipsGetMembershipInfoResponseOrganizationAvailableRolesItem = TypedDict("RequiredMembershipsGetMembershipInfoResponseOrganizationAvailableRolesItem", {
    "description": str,
...
OptionalMembershipsGetMembershipInfoResponseOrganizationAvailableRolesItem = TypedDict("OptionalMembershipsGetMembershipInfoResponseOrganizationAvailableRolesItem", {
    }, total=False)

class MembershipsGetMembershipInfoResponseOrganizationAvailableRolesItem(RequiredMembershipsGetMembershipInfoResponseOrganizationAvailableRolesItem, OptionalMembershipsGetMembershipInfoResponseOrganizationAvailableRolesItem):
    pass
