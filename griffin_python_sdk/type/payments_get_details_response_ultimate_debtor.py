...
RequiredPaymentsGetDetailsResponseUltimateDebtor = TypedDict("RequiredPaymentsGetDetailsResponseUltimateDebtor", {
    # Must be a UK BBAN.
    "account-number": str,
...
OptionalPaymentsGetDetailsResponseUltimateDebtor = TypedDict("OptionalPaymentsGetDetailsResponseUltimateDebtor", {
...
class PaymentsGetDetailsResponseUltimateDebtor(RequiredPaymentsGetDetailsResponseUltimateDebtor, OptionalPaymentsGetDetailsResponseUltimateDebtor):
    pass
