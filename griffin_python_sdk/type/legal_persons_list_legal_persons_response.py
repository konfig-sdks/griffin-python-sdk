...
from griffin_python_sdk.type.legal_persons_list_legal_persons_response_included import LegalPersonsListLegalPersonsResponseIncluded
from griffin_python_sdk.type.legal_persons_list_legal_persons_response_legal_persons import LegalPersonsListLegalPersonsResponseLegalPersons
from griffin_python_sdk.type.legal_persons_list_legal_persons_response_links import LegalPersonsListLegalPersonsResponseLinks
from griffin_python_sdk.type.legal_persons_list_legal_persons_response_meta import LegalPersonsListLegalPersonsResponseMeta

RequiredLegalPersonsListLegalPersonsResponse = TypedDict("RequiredLegalPersonsListLegalPersonsResponse", {
    "legal-persons": LegalPersonsListLegalPersonsResponseLegalPersons,

    "links": LegalPersonsListLegalPersonsResponseLinks,
    })

OptionalLegalPersonsListLegalPersonsResponse = TypedDict("OptionalLegalPersonsListLegalPersonsResponse", {
    "meta": LegalPersonsListLegalPersonsResponseMeta,

    "included": LegalPersonsListLegalPersonsResponseIncluded,
    }, total=False)

class LegalPersonsListLegalPersonsResponse(RequiredLegalPersonsListLegalPersonsResponse, OptionalLegalPersonsListLegalPersonsResponse):
    pass
