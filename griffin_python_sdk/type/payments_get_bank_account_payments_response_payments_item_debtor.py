...
RequiredPaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor = TypedDict("RequiredPaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor", {
    # Must be a UK BBAN.
    "account-number": str,
...
OptionalPaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor = TypedDict("OptionalPaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor", {
...
class PaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor(RequiredPaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor, OptionalPaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor):
    pass
