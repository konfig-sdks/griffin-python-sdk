...
RequiredLegalPersonsListLegalPersonsResponseIncludedVerificationsItem = TypedDict("RequiredLegalPersonsListLegalPersonsResponseIncludedVerificationsItem", {
...
OptionalLegalPersonsListLegalPersonsResponseIncludedVerificationsItem = TypedDict("OptionalLegalPersonsListLegalPersonsResponseIncludedVerificationsItem", {
    # ISO 8601 formatted date-time.
    "updated-at": datetime,
...
class LegalPersonsListLegalPersonsResponseIncludedVerificationsItem(RequiredLegalPersonsListLegalPersonsResponseIncludedVerificationsItem, OptionalLegalPersonsListLegalPersonsResponseIncludedVerificationsItem):
    pass
