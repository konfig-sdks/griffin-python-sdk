...
RequiredBankAccountsGetAccountResponseBankAddressesItem = TypedDict("RequiredBankAccountsGetAccountResponseBankAddressesItem", {
...
OptionalBankAccountsGetAccountResponseBankAddressesItem = TypedDict("OptionalBankAccountsGetAccountResponseBankAddressesItem", {
    }, total=False)

class BankAccountsGetAccountResponseBankAddressesItem(RequiredBankAccountsGetAccountResponseBankAddressesItem, OptionalBankAccountsGetAccountResponseBankAddressesItem):
    pass
