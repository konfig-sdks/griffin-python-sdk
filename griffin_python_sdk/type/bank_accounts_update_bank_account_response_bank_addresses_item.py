...
RequiredBankAccountsUpdateBankAccountResponseBankAddressesItem = TypedDict("RequiredBankAccountsUpdateBankAccountResponseBankAddressesItem", {
...
OptionalBankAccountsUpdateBankAccountResponseBankAddressesItem = TypedDict("OptionalBankAccountsUpdateBankAccountResponseBankAddressesItem", {
    }, total=False)

class BankAccountsUpdateBankAccountResponseBankAddressesItem(RequiredBankAccountsUpdateBankAccountResponseBankAddressesItem, OptionalBankAccountsUpdateBankAccountResponseBankAddressesItem):
    pass
