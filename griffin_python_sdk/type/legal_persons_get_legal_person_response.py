...
from griffin_python_sdk.type.legal_persons_get_legal_person_response_latest_decision import LegalPersonsGetLegalPersonResponseLatestDecision

RequiredLegalPersonsGetLegalPersonResponse = TypedDict("RequiredLegalPersonsGetLegalPersonResponse", {
...
OptionalLegalPersonsGetLegalPersonResponse = TypedDict("OptionalLegalPersonsGetLegalPersonResponse", {
    "latest-decision": LegalPersonsGetLegalPersonResponseLatestDecision,
...
class LegalPersonsGetLegalPersonResponse(RequiredLegalPersonsGetLegalPersonResponse, OptionalLegalPersonsGetLegalPersonResponse):
    pass
