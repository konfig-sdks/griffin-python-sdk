...
from griffin_python_sdk.type.memberships_list_organization_memberships_response_memberships_item_organization_available_roles import MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRoles

RequiredMembershipsListOrganizationMembershipsResponseMembershipsItemOrganization = TypedDict("RequiredMembershipsListOrganizationMembershipsResponseMembershipsItemOrganization", {
    ...
    "organization-invitations-url": str,

    # The mutable display name for the Organisation
    "display-name": str,

    "organization-api-keys-url": str,

    # Link to the resource that enables you to request live access.
    "organization-live-access-url": str,

    # Link to the endpoint which enables webhook creation.
    "organization-webhooks-url": str,

    # Link to the onboarding [workflows](http://docs.griffin.com) configured for this [organization](http://docs.griffin.com).
    "organization-workflows-url": str,

    # Link to the [bank accounts](http://docs.griffin.com) managed by this [organization](http://docs.griffin.com).
    "organization-bank-accounts-url": str,

    "available-roles": MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRoles,

    # Is this organization able to make manual decisions on verifications?
    "can-decide-on-verifications?": bool,

    # Link to the [organization](http://docs.griffin.com).
    "organization-url": str,

    "organization-individuals-url": str,

    "organization-corporations-url": str,

    # Link to the [legal persons](http://docs.griffin.com) grouped under this [organization](http://docs.griffin.com).
    "organization-legal-persons-url": str,

    # Link to the endpoint which lists an organization's events.
    "organization-events-url": str,
    })

OptionalMembershipsListOrganizationMembershipsResponseMembershipsItemOrganization = TypedDict("OptionalMembershipsListOrganizationMembershipsResponseMembershipsItemOrganization", {
    # Link to the [Reliance onboarding](http://docs.griffin.com).
    "organization-onboarding-applications-url": str,
    }, total=False)

class MembershipsListOrganizationMembershipsResponseMembershipsItemOrganization(RequiredMembershipsListOrganizationMembershipsResponseMembershipsItemOrganization, OptionalMembershipsListOrganizationMembershipsResponseMembershipsItemOrganization):
    pass
