...
RequiredPooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem = TypedDict("RequiredPooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem", {
    ...
    "verification-checks-url": str,

    "verification-status": str,
    })

OptionalPooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem = TypedDict("OptionalPooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem", {
    # ISO 8601 formatted date-time.
    "updated-at": datetime,
    ...
    "verification-risk-assessments-url": str,
    }, total=False)

class PooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem(RequiredPooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem, OptionalPooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem):
    pass
