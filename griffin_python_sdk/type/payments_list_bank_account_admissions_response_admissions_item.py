...
from griffin_python_sdk.type.payments_list_bank_account_admissions_response_admissions_item_admission_scheme_information import PaymentsListBankAccountAdmissionsResponseAdmissionsItemAdmissionSchemeInformation

RequiredPaymentsListBankAccountAdmissionsResponseAdmissionsItem = TypedDict("RequiredPaymentsListBankAccountAdmissionsResponseAdmissionsItem", {
    # Specifies the progress of the inbound payment.
    "admission-status": str,

    "admission-scheme-information": PaymentsListBankAccountAdmissionsResponseAdmissionsItemAdmissionSchemeInformation,
...
OptionalPaymentsListBankAccountAdmissionsResponseAdmissionsItem = TypedDict("OptionalPaymentsListBankAccountAdmissionsResponseAdmissionsItem", {
    }, total=False)

class PaymentsListBankAccountAdmissionsResponseAdmissionsItem(RequiredPaymentsListBankAccountAdmissionsResponseAdmissionsItem, OptionalPaymentsListBankAccountAdmissionsResponseAdmissionsItem):
    pass
