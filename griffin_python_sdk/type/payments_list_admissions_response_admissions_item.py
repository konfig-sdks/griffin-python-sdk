...
from griffin_python_sdk.type.payments_list_admissions_response_admissions_item_admission_scheme_information import PaymentsListAdmissionsResponseAdmissionsItemAdmissionSchemeInformation

RequiredPaymentsListAdmissionsResponseAdmissionsItem = TypedDict("RequiredPaymentsListAdmissionsResponseAdmissionsItem", {
    # Specifies the progress of the inbound payment.
    "admission-status": str,

    "admission-scheme-information": PaymentsListAdmissionsResponseAdmissionsItemAdmissionSchemeInformation,
...
OptionalPaymentsListAdmissionsResponseAdmissionsItem = TypedDict("OptionalPaymentsListAdmissionsResponseAdmissionsItem", {
    }, total=False)

class PaymentsListAdmissionsResponseAdmissionsItem(RequiredPaymentsListAdmissionsResponseAdmissionsItem, OptionalPaymentsListAdmissionsResponseAdmissionsItem):
    pass
