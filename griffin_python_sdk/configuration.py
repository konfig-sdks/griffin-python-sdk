...
from griffin_python_sdk.exceptions_base import ApiValueError
from griffin_python_sdk.exceptions import ClientConfigurationError
...
conf = griffin_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.griffin.com" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if api_key_auth:
            self.api_key['api-key-auth'] = api_key_auth
        else:
            raise ClientConfigurationError('API Key "api-key-auth" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("griffin_python_sdk")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'api-key-auth' in self.api_key:
            auth['api-key-auth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
