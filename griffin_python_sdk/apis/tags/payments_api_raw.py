...
from griffin_python_sdk.paths.v0_bank_accounts_bank_account_id_payments.post import CreateRequestRaw
from griffin_python_sdk.paths.v0_admissions_admission_id.get import GetAdmissionRaw
from griffin_python_sdk.paths.v0_bank_accounts_bank_account_id_payments.get import GetBankAccountPaymentsRaw
from griffin_python_sdk.paths.v0_payments_payment_id.get import GetDetailsRaw
from griffin_python_sdk.paths.v0_submissions_submission_id.get import GetSubmissionRaw
from griffin_python_sdk.paths.v0_payments_payment_id_admissions.get import ListAdmissionsRaw
from griffin_python_sdk.paths.v0_bank_accounts_bank_account_id_admissions.get import ListBankAccountAdmissionsRaw
from griffin_python_sdk.paths.v0_bank_accounts_bank_account_id_submissions.get import ListSubmissionsRaw
from griffin_python_sdk.paths.v0_payments_payment_id_submissions.get import ListSubmissions0Raw
from griffin_python_sdk.paths.v0_payments_payment_id_submissions.post import SubmitPaymentSubmissionRaw


class PaymentsApiRaw(
    CreateRequestRaw,
    GetAdmissionRaw,
    GetBankAccountPaymentsRaw,
    GetDetailsRaw,
    GetSubmissionRaw,
    ListAdmissionsRaw,
    ListBankAccountAdmissionsRaw,
    ListSubmissionsRaw,
    ListSubmissions0Raw,
    SubmitPaymentSubmissionRaw,
):
    """NOTE:
