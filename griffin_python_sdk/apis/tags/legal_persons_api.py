...
from griffin_python_sdk.paths.v0_organizations_organization_id_legal_persons.post import CreateNewLegalPerson
from griffin_python_sdk.paths.v0_legal_persons_legal_person_id.get import GetLegalPerson
from griffin_python_sdk.paths.v0_organizations_organization_id_legal_persons.get import ListLegalPersons
from griffin_python_sdk.paths.v0_legal_persons_legal_person_id.put import UpdateLegalPerson
from griffin_python_sdk.apis.tags.legal_persons_api_raw import LegalPersonsApiRaw


class LegalPersonsApi(
    ...
    """
    raw: LegalPersonsApiRaw

    def __init__(self, api_client=None):
        super().__init__(api_client)
        self.raw = LegalPersonsApiRaw(api_client)
