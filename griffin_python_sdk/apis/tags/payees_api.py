...
from griffin_python_sdk.paths.v0_payees_payee_id.get import GetDetails
from griffin_python_sdk.paths.v0_legal_persons_legal_person_id_bank_payees.get import ListLegalPersonPayees
from griffin_python_sdk.paths.v0_legal_persons_legal_person_id_bank_payees.post import RegisterNewPayee
from griffin_python_sdk.paths.v0_payees_payee_id.patch import UpdatePayee
from griffin_python_sdk.apis.tags.payees_api_raw import PayeesApiRaw
...
class PayeesApi(
    ...
    def __init__(self, api_client=None):
        ...
        self.raw = PayeesApiRaw(api_client)
