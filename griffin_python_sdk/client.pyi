...
from griffin_python_sdk.client_custom import ClientCustom
from griffin_python_sdk.configuration import Configuration
from griffin_python_sdk.api_client import ApiClient
from griffin_python_sdk.type_util import copy_signature
...
class Griffin(ClientCustom):
    ...
    def __init__(self, configuration: typing.Union[Configuration, None] = None, **kwargs):
        ...
        self.claims: ClaimsApi = ClaimsApi(api_client)
        self.companies_house: CompaniesHouseApi = CompaniesHouseApi(api_client)
        self.connectivity: ConnectivityApi = ConnectivityApi(api_client)
        self.decisions: DecisionsApi = DecisionsApi(api_client)
        self.events: EventsApi = EventsApi(api_client)
        self.invitations: InvitationsApi = InvitationsApi(api_client)
        self.legal_person_history: LegalPersonHistoryApi = LegalPersonHistoryApi(api_client)
        self.legal_persons: LegalPersonsApi = LegalPersonsApi(api_client)
        self.memberships: MembershipsApi = MembershipsApi(api_client)
        self.navigation: NavigationApi = NavigationApi(api_client)
        ...
        self.pooled_account_membership: PooledAccountMembershipApi = PooledAccountMembershipApi(api_client)
        self.reliance_onboarding: RelianceOnboardingApi = RelianceOnboardingApi(api_client)
