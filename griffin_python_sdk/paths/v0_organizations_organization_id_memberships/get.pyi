...
from griffin_python_sdk.model.memberships_list_organization_memberships_response import MembershipsListOrganizationMembershipsResponse as MembershipsListOrganizationMembershipsResponseSchema

from griffin_python_sdk.type.memberships_list_organization_memberships_response import MembershipsListOrganizationMembershipsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.memberships_list_organization_memberships_response import MembershipsListOrganizationMembershipsResponse as MembershipsListOrganizationMembershipsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = MembershipsListOrganizationMembershipsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MembershipsListOrganizationMembershipsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_organization_memberships_mapped_args(
        self,
        organization_id: str,
    ...
    async def _alist_organization_memberships_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/organizations/{organization-id}/memberships',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_organization_memberships_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListOrganizationMembershipsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_organization_memberships(
        self,
        organization_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_organization_memberships_mapped_args(
        ...
        return await self._alist_organization_memberships_oapg(
    ...
    def list_organization_memberships(
        ...
        return self._list_organization_memberships_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListOrganizationMemberships(BaseApi):
    ...
    async def alist_organization_memberships(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MembershipsListOrganizationMembershipsResponsePydantic:
        raw_response = await self.raw.alist_organization_memberships(
            organization_id=organization_id,
            sort=sort,
            page_size=page_size,
            page_after=page_after,
        ...
        if validate:
            return MembershipsListOrganizationMembershipsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MembershipsListOrganizationMembershipsResponsePydantic, raw_response.body)
    ...
    def list_organization_memberships(
        ...
        raw_response = self.raw.list_organization_memberships(
            organization_id=organization_id,
            sort=sort,
            page_size=page_size,
            page_after=page_after,
