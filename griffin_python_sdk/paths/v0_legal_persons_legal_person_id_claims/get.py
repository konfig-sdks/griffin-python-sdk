...
from griffin_python_sdk.model.claims_get_all_claims_response import ClaimsGetAllClaimsResponse as ClaimsGetAllClaimsResponseSchema

from griffin_python_sdk.type.claims_get_all_claims_response import ClaimsGetAllClaimsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.claims_get_all_claims_response import ClaimsGetAllClaimsResponse as ClaimsGetAllClaimsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ClaimsGetAllClaimsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ClaimsGetAllClaimsResponse
...
class GetAllClaims(BaseApi):
    ...
    async def aget_all_claims(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ClaimsGetAllClaimsResponsePydantic:
        ...
        if validate:
            return ClaimsGetAllClaimsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ClaimsGetAllClaimsResponsePydantic, raw_response.body)
