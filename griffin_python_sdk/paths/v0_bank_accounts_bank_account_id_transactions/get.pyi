...
from griffin_python_sdk.model.transactions_list_balance_changes_response import TransactionsListBalanceChangesResponse as TransactionsListBalanceChangesResponseSchema

from griffin_python_sdk.type.transactions_list_balance_changes_response import TransactionsListBalanceChangesResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.transactions_list_balance_changes_response import TransactionsListBalanceChangesResponse as TransactionsListBalanceChangesResponsePydantic
...
class IncludeSchema(
    ...
    def PAYMENT(cls):
        return cls("payment")
FilterPostDatetimeLteSchema = schemas.DateTimeSchema
FilterPostDatetimeLtSchema = schemas.DateTimeSchema
FilterPostDatetimeGteSchema = schemas.DateTimeSchema
FilterPostDatetimeGtSchema = schemas.DateTimeSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'filter[post-datetime][lte]': typing.Union[FilterPostDatetimeLteSchema, str, datetime, ],
        'filter[post-datetime][lt]': typing.Union[FilterPostDatetimeLtSchema, str, datetime, ],
        'filter[post-datetime][gte]': typing.Union[FilterPostDatetimeGteSchema, str, datetime, ],
        'filter[post-datetime][gt]': typing.Union[FilterPostDatetimeGtSchema, str, datetime, ],
    },
    total=False
)
...
request_query_filter_post_datetime_lte = api_client.QueryParameter(
    name="filter[post-datetime][lte]",
    style=api_client.ParameterStyle.FORM,
    schema=FilterPostDatetimeLteSchema,
    explode=True,
)
request_query_filter_post_datetime_lt = api_client.QueryParameter(
    name="filter[post-datetime][lt]",
    style=api_client.ParameterStyle.FORM,
    schema=FilterPostDatetimeLtSchema,
    explode=True,
)
request_query_filter_post_datetime_gte = api_client.QueryParameter(
    name="filter[post-datetime][gte]",
    style=api_client.ParameterStyle.FORM,
    schema=FilterPostDatetimeGteSchema,
    explode=True,
)
request_query_filter_post_datetime_gt = api_client.QueryParameter(
    name="filter[post-datetime][gt]",
    style=api_client.ParameterStyle.FORM,
    schema=FilterPostDatetimeGtSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = TransactionsListBalanceChangesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TransactionsListBalanceChangesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_balance_changes_mapped_args(
        self,
        bank_account_id: str,
        ...
        filter_post_datetime_lte: typing.Optional[datetime] = None,
        filter_post_datetime_lt: typing.Optional[datetime] = None,
        filter_post_datetime_gte: typing.Optional[datetime] = None,
        filter_post_datetime_gt: typing.Optional[datetime] = None,
        ...
        if filter_post_datetime_lte is not None:
            _query_params["filter[post-datetime][lte]"] = filter_post_datetime_lte
        if filter_post_datetime_lt is not None:
            _query_params["filter[post-datetime][lt]"] = filter_post_datetime_lt
        if filter_post_datetime_gte is not None:
            _query_params["filter[post-datetime][gte]"] = filter_post_datetime_gte
        if filter_post_datetime_gt is not None:
            _query_params["filter[post-datetime][gt]"] = filter_post_datetime_gt
    ...
    async def _alist_balance_changes_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_filter_post_datetime_lte,
            request_query_filter_post_datetime_lt,
            request_query_filter_post_datetime_gte,
            request_query_filter_post_datetime_gt,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v0/bank/accounts/{bank-account-id}/transactions',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_balance_changes_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListBalanceChangesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_balance_changes(
        self,
        bank_account_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_balance_changes_mapped_args(
            ...
            include=include,
            filter_post_datetime_lte=filter_post_datetime_lte,
            filter_post_datetime_lt=filter_post_datetime_lt,
            filter_post_datetime_gte=filter_post_datetime_gte,
            filter_post_datetime_gt=filter_post_datetime_gt,
        )
        return await self._alist_balance_changes_oapg(
    ...
    def list_balance_changes(
        ...
        return self._list_balance_changes_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListBalanceChanges(BaseApi):
    ...
    async def alist_balance_changes(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TransactionsListBalanceChangesResponsePydantic:
        raw_response = await self.raw.alist_balance_changes(
            bank_account_id=bank_account_id,
            sort=sort,
            page_size=page_size,
            page_before=page_before,
        ...
        if validate:
            return TransactionsListBalanceChangesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TransactionsListBalanceChangesResponsePydantic, raw_response.body)
    ...
    def list_balance_changes(
        ...
        raw_response = self.raw.list_balance_changes(
            bank_account_id=bank_account_id,
            sort=sort,
            page_size=page_size,
            page_before=page_before,
