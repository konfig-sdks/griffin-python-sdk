...
from griffin_python_sdk.model.memberships_list_user_memberships_response import MembershipsListUserMembershipsResponse as MembershipsListUserMembershipsResponseSchema

from griffin_python_sdk.type.memberships_list_user_memberships_response import MembershipsListUserMembershipsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.memberships_list_user_memberships_response import MembershipsListUserMembershipsResponse as MembershipsListUserMembershipsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = MembershipsListUserMembershipsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MembershipsListUserMembershipsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_user_memberships_mapped_args(
        self,
        user_id: str,
    ...
    async def _alist_user_memberships_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/users/{user-id}/memberships',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_user_memberships_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListUserMembershipsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_user_memberships(
        self,
        user_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_user_memberships_mapped_args(
            user_id=user_id,
            sort=sort,
            page_size=page_size,
        ...
        return await self._alist_user_memberships_oapg(
    ...
    def list_user_memberships(
        ...
        return self._list_user_memberships_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListUserMemberships(BaseApi):
    ...
    async def alist_user_memberships(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MembershipsListUserMembershipsResponsePydantic:
        raw_response = await self.raw.alist_user_memberships(
            user_id=user_id,
            sort=sort,
            page_size=page_size,
            page_after=page_after,
        ...
        if validate:
            return MembershipsListUserMembershipsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MembershipsListUserMembershipsResponsePydantic, raw_response.body)
    ...
    def list_user_memberships(
        ...
        raw_response = self.raw.list_user_memberships(
            user_id=user_id,
            sort=sort,
            page_size=page_size,
            page_after=page_after,
