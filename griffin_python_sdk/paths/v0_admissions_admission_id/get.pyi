...
from griffin_python_sdk.model.payments_get_admission_response import PaymentsGetAdmissionResponse as PaymentsGetAdmissionResponseSchema

from griffin_python_sdk.type.payments_get_admission_response import PaymentsGetAdmissionResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.payments_get_admission_response import PaymentsGetAdmissionResponse as PaymentsGetAdmissionResponsePydantic

# Path params
AdmissionIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'admission-id': typing.Union[AdmissionIdSchema, str, ],
    }
)
...
request_path_admission_id = api_client.PathParameter(
    name="admission-id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AdmissionIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = PaymentsGetAdmissionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentsGetAdmissionResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_admission_mapped_args(
        self,
        admission_id: str,
        ...
        if admission_id is not None:
            _path_params["admission-id"] = admission_id
        args.path = _path_params
        return args

    async def _aget_admission_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/admissions/{admission-id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAdmissionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_admission(
        self,
        admission_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_admission_mapped_args(
            admission_id=admission_id,
        )
        return await self._aget_admission_oapg(
    ...
    def get_admission(
        ...
        return self._get_admission_oapg(
            path_params=args.path,
        )

class GetAdmission(BaseApi):
    ...
    async def aget_admission(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaymentsGetAdmissionResponsePydantic:
        raw_response = await self.raw.aget_admission(
            admission_id=admission_id,
            **kwargs,
        )
        if validate:
            return PaymentsGetAdmissionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PaymentsGetAdmissionResponsePydantic, raw_response.body)
    ...
    def get_admission(
        ...
        raw_response = self.raw.get_admission(
            admission_id=admission_id,
        )
        if validate:
            return PaymentsGetAdmissionResponsePydantic(**raw_response.body)
