...
from griffin_python_sdk.model.api_keys_list_active_keys200_response import ApiKeysListActiveKeys200Response as ApiKeysListActiveKeys200ResponseSchema

from griffin_python_sdk.type.api_keys_list_active_keys200_response import ApiKeysListActiveKeys200Response

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.api_keys_list_active_keys200_response import ApiKeysListActiveKeys200Response as ApiKeysListActiveKeys200ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ApiKeysListActiveKeys200ResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ApiKeysListActiveKeys200Response
...
class BaseApi(api_client.Api):
    ...
    def _list_active_keys_0_mapped_args(
        self,
        user_id: str,
    ...
    async def _alist_active_keys_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/users/{user-id}/api-keys',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListActiveKeys0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_active_keys_0(
        self,
        user_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_active_keys_0_mapped_args(
            user_id=user_id,
            sort=sort,
            page_size=page_size,
        ...
        return await self._alist_active_keys_0_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_active_keys_0(
        self,
        user_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        return self._list_active_keys_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListActiveKeys0(BaseApi):
    ...
    async def alist_active_keys_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ApiKeysListActiveKeys200ResponsePydantic:
        raw_response = await self.raw.alist_active_keys_0(
            user_id=user_id,
            sort=sort,
            page_size=page_size,
            page_after=page_after,
        ...
        if validate:
            return ApiKeysListActiveKeys200ResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ApiKeysListActiveKeys200ResponsePydantic, raw_response.body)
    ...
    def list_active_keys_0(
        ...
        raw_response = self.raw.list_active_keys_0(
            user_id=user_id,
            sort=sort,
            page_size=page_size,
            page_after=page_after,
