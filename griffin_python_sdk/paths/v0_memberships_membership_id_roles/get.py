...
from griffin_python_sdk.model.roles_get_membership_roles_response import RolesGetMembershipRolesResponse as RolesGetMembershipRolesResponseSchema

from griffin_python_sdk.type.roles_get_membership_roles_response import RolesGetMembershipRolesResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.roles_get_membership_roles_response import RolesGetMembershipRolesResponse as RolesGetMembershipRolesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = RolesGetMembershipRolesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RolesGetMembershipRolesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_membership_roles_mapped_args(
        self,
        membership_id: str,
    ...
    async def _aget_membership_roles_oapg(
        self,
    ...
    def _get_membership_roles_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetMembershipRolesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_membership_roles(
        self,
        membership_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_membership_roles_mapped_args(
            membership_id=membership_id,
        )
        return await self._aget_membership_roles_oapg(
    ...
    def get_membership_roles(
        ...
        return self._get_membership_roles_oapg(
            path_params=args.path,
        )

class GetMembershipRoles(BaseApi):
    ...
    async def aget_membership_roles(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RolesGetMembershipRolesResponsePydantic:
        raw_response = await self.raw.aget_membership_roles(
            membership_id=membership_id,
            **kwargs,
        )
        if validate:
            return RolesGetMembershipRolesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RolesGetMembershipRolesResponsePydantic, raw_response.body)
    ...
    def get_membership_roles(
        ...
        raw_response = self.raw.get_membership_roles(
            membership_id=membership_id,
        )
        if validate:
            return RolesGetMembershipRolesResponsePydantic(**raw_response.body)
