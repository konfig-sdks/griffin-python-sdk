...
from griffin_python_sdk.model.roles_assign_membership_roles_request import RolesAssignMembershipRolesRequest as RolesAssignMembershipRolesRequestSchema
from griffin_python_sdk.model.roles_assign_membership_roles_request_role_urls import RolesAssignMembershipRolesRequestRoleUrls as RolesAssignMembershipRolesRequestRoleUrlsSchema
from griffin_python_sdk.model.roles_assign_membership_roles_response import RolesAssignMembershipRolesResponse as RolesAssignMembershipRolesResponseSchema

from griffin_python_sdk.type.roles_assign_membership_roles_request_role_urls import RolesAssignMembershipRolesRequestRoleUrls
from griffin_python_sdk.type.roles_assign_membership_roles_request import RolesAssignMembershipRolesRequest
from griffin_python_sdk.type.roles_assign_membership_roles_response import RolesAssignMembershipRolesResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.roles_assign_membership_roles_request_role_urls import RolesAssignMembershipRolesRequestRoleUrls as RolesAssignMembershipRolesRequestRoleUrlsPydantic
from griffin_python_sdk.pydantic.roles_assign_membership_roles_response import RolesAssignMembershipRolesResponse as RolesAssignMembershipRolesResponsePydantic
from griffin_python_sdk.pydantic.roles_assign_membership_roles_request import RolesAssignMembershipRolesRequest as RolesAssignMembershipRolesRequestPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'membership-id': typing.Union[MembershipIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = RolesAssignMembershipRolesRequestSchema


request_body_roles_assign_membership_roles_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = RolesAssignMembershipRolesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RolesAssignMembershipRolesResponse
...
class BaseApi(api_client.Api):
    ...
    def _assign_membership_roles_mapped_args(
        self,
        role_urls: RolesAssignMembershipRolesRequestRoleUrls,
        membership_id: str,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if role_urls is not None:
            _body["role-urls"] = role_urls
        args.body = _body
        if membership_id is not None:
            _path_params["membership-id"] = membership_id
        args.path = _path_params
        return args

    async def _aassign_membership_roles_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/memberships/{membership-id}/roles',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_roles_assign_membership_roles_request.serialize(body, content_type)
    ...
    def _assign_membership_roles_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AssignMembershipRolesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aassign_membership_roles(
        self,
        role_urls: RolesAssignMembershipRolesRequestRoleUrls,
        membership_id: str,
        **kwargs,
        ...
        args = self._assign_membership_roles_mapped_args(
            role_urls=role_urls,
            membership_id=membership_id,
        )
        return await self._aassign_membership_roles_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def assign_membership_roles(
        self,
        role_urls: RolesAssignMembershipRolesRequestRoleUrls,
        membership_id: str,
    ) -> typing.Union[
        ...
        return self._assign_membership_roles_oapg(
            body=args.body,
            path_params=args.path,
        )

class AssignMembershipRoles(BaseApi):
    ...
    async def aassign_membership_roles(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RolesAssignMembershipRolesResponsePydantic:
        raw_response = await self.raw.aassign_membership_roles(
            role_urls=role_urls,
            membership_id=membership_id,
            **kwargs,
        )
        if validate:
            return RolesAssignMembershipRolesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RolesAssignMembershipRolesResponsePydantic, raw_response.body)
    ...
    def assign_membership_roles(
        ...
        raw_response = self.raw.assign_membership_roles(
            role_urls=role_urls,
            membership_id=membership_id,
        )
        if validate:
