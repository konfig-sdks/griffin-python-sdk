...
from griffin_python_sdk.model.pooled_account_membership_list_legal_persons_response import PooledAccountMembershipListLegalPersonsResponse as PooledAccountMembershipListLegalPersonsResponseSchema

from griffin_python_sdk.type.pooled_account_membership_list_legal_persons_response import PooledAccountMembershipListLegalPersonsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.pooled_account_membership_list_legal_persons_response import PooledAccountMembershipListLegalPersonsResponse as PooledAccountMembershipListLegalPersonsResponsePydantic
...
class IncludeSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    "latest-risk-rating": "LATESTRISKRATING",
                    "legal-person": "LEGALPERSON",
                    "latest-verification": "LATESTVERIFICATION",
                }
            
            @schemas.classproperty
            def LATESTRISKRATING(cls):
                return cls("latest-risk-rating")
            
            @schemas.classproperty
            def LEGALPERSON(cls):
                return cls("legal-person")
            
            @schemas.classproperty
            def LATESTVERIFICATION(cls):
...
SchemaFor200ResponseBodyApplicationJson = PooledAccountMembershipListLegalPersonsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PooledAccountMembershipListLegalPersonsResponse
    ...
    async def _alist_legal_persons_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/bank/accounts/{bank-account-id}/membership',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListLegalPersons(BaseApi):
    ...
    async def alist_legal_persons(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PooledAccountMembershipListLegalPersonsResponsePydantic:
        ...
        if validate:
            return PooledAccountMembershipListLegalPersonsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PooledAccountMembershipListLegalPersonsResponsePydantic, raw_response.body)
