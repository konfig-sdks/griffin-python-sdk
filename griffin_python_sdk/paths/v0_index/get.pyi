...
from griffin_python_sdk.model.navigation_global_paths_fetch_response import NavigationGlobalPathsFetchResponse as NavigationGlobalPathsFetchResponseSchema

from griffin_python_sdk.type.navigation_global_paths_fetch_response import NavigationGlobalPathsFetchResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.navigation_global_paths_fetch_response import NavigationGlobalPathsFetchResponse as NavigationGlobalPathsFetchResponsePydantic

SchemaFor200ResponseBodyApplicationJson = NavigationGlobalPathsFetchResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: NavigationGlobalPathsFetchResponse
...
class BaseApi(api_client.Api):
    ...
    def _global_paths_fetch_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aglobal_paths_fetch_oapg(
        self,
...
class GlobalPathsFetchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aglobal_paths_fetch(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._global_paths_fetch_mapped_args(
        )
        return await self._aglobal_paths_fetch_oapg(
            **kwargs,
        )
    
    def global_paths_fetch(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._global_paths_fetch_oapg(
        )

class GlobalPathsFetch(BaseApi):

    async def aglobal_paths_fetch(
        self,
        validate: bool = False,
        **kwargs,
    ) -> NavigationGlobalPathsFetchResponsePydantic:
        raw_response = await self.raw.aglobal_paths_fetch(
            **kwargs,
        )
        if validate:
            return NavigationGlobalPathsFetchResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NavigationGlobalPathsFetchResponsePydantic, raw_response.body)
    ...
    def global_paths_fetch(
        ...
        raw_response = self.raw.global_paths_fetch(
        )
        if validate:
            return NavigationGlobalPathsFetchResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NavigationGlobalPathsFetchResponsePydantic, raw_response.body)
