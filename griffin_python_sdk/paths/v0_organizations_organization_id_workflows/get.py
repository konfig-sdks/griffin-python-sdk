...
from griffin_python_sdk.model.workflows_list_organization_workflows_response import WorkflowsListOrganizationWorkflowsResponse as WorkflowsListOrganizationWorkflowsResponseSchema

from griffin_python_sdk.type.workflows_list_organization_workflows_response import WorkflowsListOrganizationWorkflowsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.workflows_list_organization_workflows_response import WorkflowsListOrganizationWorkflowsResponse as WorkflowsListOrganizationWorkflowsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WorkflowsListOrganizationWorkflowsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkflowsListOrganizationWorkflowsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_organization_workflows_mapped_args(
        self,
        organization_id: str,
    ...
    async def _alist_organization_workflows_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/organizations/{organization-id}/workflows',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_organization_workflows_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListOrganizationWorkflowsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_organization_workflows(
        self,
        organization_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_organization_workflows_mapped_args(
        ...
        return await self._alist_organization_workflows_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_organization_workflows(
        self,
        organization_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        return self._list_organization_workflows_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListOrganizationWorkflows(BaseApi):
    ...
    async def alist_organization_workflows(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkflowsListOrganizationWorkflowsResponsePydantic:
        raw_response = await self.raw.alist_organization_workflows(
            organization_id=organization_id,
            sort=sort,
            page_size=page_size,
            page_after=page_after,
        ...
        if validate:
            return WorkflowsListOrganizationWorkflowsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkflowsListOrganizationWorkflowsResponsePydantic, raw_response.body)
    ...
    def list_organization_workflows(
        ...
        raw_response = self.raw.list_organization_workflows(
            organization_id=organization_id,
            sort=sort,
            page_size=page_size,
            page_after=page_after,
