...
from griffin_python_sdk.model.invitations_send_email_request import InvitationsSendEmailRequest as InvitationsSendEmailRequestSchema

from griffin_python_sdk.type.invitations_send_email_request import InvitationsSendEmailRequest

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.invitations_send_email_request import InvitationsSendEmailRequest as InvitationsSendEmailRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = InvitationsSendEmailRequestSchema


request_body_invitations_send_email_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _send_email_mapped_args(
        self,
        email_address: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
        organization_id: str,
    ...
    async def _asend_email_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/organizations/{organization-id}/invitations',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_invitations_send_email_request.serialize(body, content_type)
