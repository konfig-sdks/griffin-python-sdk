...
from griffin_python_sdk.model.payments_list_submissions200_response import PaymentsListSubmissions200Response as PaymentsListSubmissions200ResponseSchema

from griffin_python_sdk.type.payments_list_submissions200_response import PaymentsListSubmissions200Response

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.payments_list_submissions200_response import PaymentsListSubmissions200Response as PaymentsListSubmissions200ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PaymentsListSubmissions200ResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentsListSubmissions200Response
...
class BaseApi(api_client.Api):
    ...
    def _list_submissions_0_mapped_args(
        self,
        payment_id: str,
    ...
    async def _alist_submissions_0_oapg(
        self,
...
class ListSubmissions0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_submissions_0(
        self,
        payment_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_submissions_0_mapped_args(
            payment_id=payment_id,
        )
        return await self._alist_submissions_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_submissions_0(
        self,
        payment_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._list_submissions_0_oapg(
            path_params=args.path,
        )

class ListSubmissions0(BaseApi):
    ...
    async def alist_submissions_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaymentsListSubmissions200ResponsePydantic:
        raw_response = await self.raw.alist_submissions_0(
            payment_id=payment_id,
            **kwargs,
        )
        if validate:
            return PaymentsListSubmissions200ResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PaymentsListSubmissions200ResponsePydantic, raw_response.body)
    ...
    def list_submissions_0(
        ...
        raw_response = self.raw.list_submissions_0(
            payment_id=payment_id,
        )
        if validate:
            return PaymentsListSubmissions200ResponsePydantic(**raw_response.body)
