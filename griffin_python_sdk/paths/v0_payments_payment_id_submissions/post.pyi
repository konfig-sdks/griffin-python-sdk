...
from griffin_python_sdk.model.payments_submit_payment_submission_response import PaymentsSubmitPaymentSubmissionResponse as PaymentsSubmitPaymentSubmissionResponseSchema
from griffin_python_sdk.model.payments_submit_payment_submission_request import PaymentsSubmitPaymentSubmissionRequest as PaymentsSubmitPaymentSubmissionRequestSchema

from griffin_python_sdk.type.payments_submit_payment_submission_response import PaymentsSubmitPaymentSubmissionResponse
from griffin_python_sdk.type.payments_submit_payment_submission_request import PaymentsSubmitPaymentSubmissionRequest

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.payments_submit_payment_submission_response import PaymentsSubmitPaymentSubmissionResponse as PaymentsSubmitPaymentSubmissionResponsePydantic
from griffin_python_sdk.pydantic.payments_submit_payment_submission_request import PaymentsSubmitPaymentSubmissionRequest as PaymentsSubmitPaymentSubmissionRequestPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'payment-id': typing.Union[PaymentIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = PaymentsSubmitPaymentSubmissionRequestSchema


request_body_payments_submit_payment_submission_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PaymentsSubmitPaymentSubmissionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentsSubmitPaymentSubmissionResponse
...
class BaseApi(api_client.Api):
    ...
    def _submit_payment_submission_mapped_args(
        self,
        payment_id: str,
        payment_scheme: typing.Optional[str] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if payment_scheme is not None:
            _body["payment-scheme"] = payment_scheme
        args.body = _body
        if payment_id is not None:
            _path_params["payment-id"] = payment_id
        args.path = _path_params
        return args

    async def _asubmit_payment_submission_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/payments/{payment-id}/submissions',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_payments_submit_payment_submission_request.serialize(body, content_type)
    ...
    def _submit_payment_submission_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SubmitPaymentSubmissionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asubmit_payment_submission(
        self,
        payment_id: str,
        payment_scheme: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._submit_payment_submission_mapped_args(
            payment_id=payment_id,
            payment_scheme=payment_scheme,
        )
        return await self._asubmit_payment_submission_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def submit_payment_submission(
        self,
        payment_id: str,
        payment_scheme: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._submit_payment_submission_oapg(
            body=args.body,
            path_params=args.path,
        )

class SubmitPaymentSubmission(BaseApi):
    ...
    async def asubmit_payment_submission(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaymentsSubmitPaymentSubmissionResponsePydantic:
        raw_response = await self.raw.asubmit_payment_submission(
            payment_id=payment_id,
            payment_scheme=payment_scheme,
            **kwargs,
        )
        if validate:
            return PaymentsSubmitPaymentSubmissionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PaymentsSubmitPaymentSubmissionResponsePydantic, raw_response.body)
    ...
    def submit_payment_submission(
        ...
        raw_response = self.raw.submit_payment_submission(
            payment_id=payment_id,
            payment_scheme=payment_scheme,
        )
        if validate:
