...
from griffin_python_sdk.model.organizations_get_details_response import OrganizationsGetDetailsResponse as OrganizationsGetDetailsResponseSchema

from griffin_python_sdk.type.organizations_get_details_response import OrganizationsGetDetailsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.organizations_get_details_response import OrganizationsGetDetailsResponse as OrganizationsGetDetailsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OrganizationsGetDetailsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: OrganizationsGetDetailsResponse
    ...
    async def _aget_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/organizations/{organization-id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrganizationsGetDetailsResponsePydantic:
        raw_response = await self.raw.aget_details(
            organization_id=organization_id,
            **kwargs,
        )
        if validate:
            return OrganizationsGetDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OrganizationsGetDetailsResponsePydantic, raw_response.body)
