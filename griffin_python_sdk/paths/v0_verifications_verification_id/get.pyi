...
from griffin_python_sdk.model.verifications_get_verification_response import VerificationsGetVerificationResponse as VerificationsGetVerificationResponseSchema

from griffin_python_sdk.type.verifications_get_verification_response import VerificationsGetVerificationResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.verifications_get_verification_response import VerificationsGetVerificationResponse as VerificationsGetVerificationResponsePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'verification-id': typing.Union[VerificationIdSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = VerificationsGetVerificationResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: VerificationsGetVerificationResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_verification_mapped_args(
        self,
        verification_id: str,
        ...
        if verification_id is not None:
            _path_params["verification-id"] = verification_id
        args.path = _path_params
        return args

    async def _aget_verification_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/verifications/{verification-id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetVerificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_verification(
        self,
        verification_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_verification_mapped_args(
            verification_id=verification_id,
        )
        return await self._aget_verification_oapg(
    ...
    def get_verification(
        ...
        return self._get_verification_oapg(
            path_params=args.path,
        )

class GetVerification(BaseApi):
    ...
    async def aget_verification(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VerificationsGetVerificationResponsePydantic:
        raw_response = await self.raw.aget_verification(
            verification_id=verification_id,
            **kwargs,
        )
        if validate:
            return VerificationsGetVerificationResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VerificationsGetVerificationResponsePydantic, raw_response.body)
    ...
    def get_verification(
        ...
        raw_response = self.raw.get_verification(
            verification_id=verification_id,
        )
        if validate:
            return VerificationsGetVerificationResponsePydantic(**raw_response.body)
