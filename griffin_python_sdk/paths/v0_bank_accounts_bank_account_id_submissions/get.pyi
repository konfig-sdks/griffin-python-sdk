...
from griffin_python_sdk.model.payments_list_submissions_response import PaymentsListSubmissionsResponse as PaymentsListSubmissionsResponseSchema

from griffin_python_sdk.type.payments_list_submissions_response import PaymentsListSubmissionsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.payments_list_submissions_response import PaymentsListSubmissionsResponse as PaymentsListSubmissionsResponsePydantic
...
class FilterSubmissionStatusInSchema(
    schemas.ListSchema
):
    ...
    ) -> 'FilterSubmissionStatusInSchema':
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'filter[submission-status][in]': typing.Union[FilterSubmissionStatusInSchema, list, tuple, ],
...
request_query_filter_submission_status_in = api_client.QueryParameter(
    name="filter[submission-status][in]",
    style=api_client.ParameterStyle.FORM,
    schema=FilterSubmissionStatusInSchema,
)
...
SchemaFor200ResponseBodyApplicationJson = PaymentsListSubmissionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentsListSubmissionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_submissions_mapped_args(
        self,
        bank_account_id: str,
        ...
        filter_submission_status_in: typing.Optional[typing.List[str]] = None,
        ...
        if filter_submission_status_in is not None:
            _query_params["filter[submission-status][in]"] = filter_submission_status_in
    ...
    async def _alist_submissions_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_filter_submission_status_in,
        ...
        request_before_hook(
            ...
            path_template='/v0/bank/accounts/{bank-account-id}/submissions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListSubmissionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_submissions(
        self,
        bank_account_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_submissions_mapped_args(
            bank_account_id=bank_account_id,
            sort=sort,
            page_size=page_size,
            page_before=page_before,
            page_after=page_after,
            filter_submission_status_in=filter_submission_status_in,
        ...
        return await self._alist_submissions_oapg(
    ...
    def list_submissions(
        ...
        return self._list_submissions_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListSubmissions(BaseApi):
    ...
    async def alist_submissions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaymentsListSubmissionsResponsePydantic:
        raw_response = await self.raw.alist_submissions(
            bank_account_id=bank_account_id,
            sort=sort,
            page_size=page_size,
            page_before=page_before,
        ...
        if validate:
            return PaymentsListSubmissionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PaymentsListSubmissionsResponsePydantic, raw_response.body)
    ...
    def list_submissions(
        ...
        raw_response = self.raw.list_submissions(
            bank_account_id=bank_account_id,
            sort=sort,
            page_size=page_size,
            page_before=page_before,
