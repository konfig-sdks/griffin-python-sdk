...
from griffin_python_sdk.model.companies_house_get_company_details_response import CompaniesHouseGetCompanyDetailsResponse as CompaniesHouseGetCompanyDetailsResponseSchema

from griffin_python_sdk.type.companies_house_get_company_details_response import CompaniesHouseGetCompanyDetailsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.companies_house_get_company_details_response import CompaniesHouseGetCompanyDetailsResponse as CompaniesHouseGetCompanyDetailsResponsePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'company-number': typing.Union[CompanyNumberSchema, str, ],
    }
)
...
request_path_company_number = api_client.PathParameter(
    name="company-number",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CompanyNumberSchema,
    required=True,
)
_auth = [
    'api-key-auth',
]
SchemaFor200ResponseBodyApplicationJson = CompaniesHouseGetCompanyDetailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CompaniesHouseGetCompanyDetailsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_company_details_mapped_args(
        ...
        if company_number is not None:
            _path_params["company-number"] = company_number
    ...
    async def _aget_company_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/companies-house/companies/{company-number}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetCompanyDetails(BaseApi):
    ...
    async def aget_company_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CompaniesHouseGetCompanyDetailsResponsePydantic:
        raw_response = await self.raw.aget_company_details(
            company_number=company_number,
            **kwargs,
        )
        if validate:
            return CompaniesHouseGetCompanyDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CompaniesHouseGetCompanyDetailsResponsePydantic, raw_response.body)
