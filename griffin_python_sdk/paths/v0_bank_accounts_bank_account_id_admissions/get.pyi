...
from griffin_python_sdk.model.payments_list_bank_account_admissions_response import PaymentsListBankAccountAdmissionsResponse as PaymentsListBankAccountAdmissionsResponseSchema

from griffin_python_sdk.type.payments_list_bank_account_admissions_response import PaymentsListBankAccountAdmissionsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.payments_list_bank_account_admissions_response import PaymentsListBankAccountAdmissionsResponse as PaymentsListBankAccountAdmissionsResponsePydantic
...
class FilterAdmissionStatusInSchema(
    schemas.ListSchema
):
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'filter[admission-status][in]': typing.Union[FilterAdmissionStatusInSchema, list, tuple, ],
    },
    total=False
)
...
request_query_filter_admission_status_in = api_client.QueryParameter(
    name="filter[admission-status][in]",
    style=api_client.ParameterStyle.FORM,
    schema=FilterAdmissionStatusInSchema,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = PaymentsListBankAccountAdmissionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentsListBankAccountAdmissionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_bank_account_admissions_mapped_args(
        self,
        bank_account_id: str,
        ...
        filter_admission_status_in: typing.Optional[typing.List[str]] = None,
        ...
        if filter_admission_status_in is not None:
            _query_params["filter[admission-status][in]"] = filter_admission_status_in
    ...
    async def _alist_bank_account_admissions_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_filter_admission_status_in,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v0/bank/accounts/{bank-account-id}/admissions',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_bank_account_admissions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListBankAccountAdmissionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_bank_account_admissions(
        self,
        bank_account_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_bank_account_admissions_mapped_args(
            ...
            filter_admission_status_in=filter_admission_status_in,
        )
        return await self._alist_bank_account_admissions_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_bank_account_admissions(
        self,
        bank_account_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        return self._list_bank_account_admissions_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListBankAccountAdmissions(BaseApi):
    ...
    async def alist_bank_account_admissions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaymentsListBankAccountAdmissionsResponsePydantic:
        raw_response = await self.raw.alist_bank_account_admissions(
            bank_account_id=bank_account_id,
            sort=sort,
            page_size=page_size,
            page_before=page_before,
        ...
        if validate:
            return PaymentsListBankAccountAdmissionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PaymentsListBankAccountAdmissionsResponsePydantic, raw_response.body)
    ...
    def list_bank_account_admissions(
        ...
        raw_response = self.raw.list_bank_account_admissions(
            bank_account_id=bank_account_id,
            sort=sort,
            page_size=page_size,
            page_before=page_before,
