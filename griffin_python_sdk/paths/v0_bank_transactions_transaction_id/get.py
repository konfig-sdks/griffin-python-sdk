...
from griffin_python_sdk.model.transactions_get_transaction_by_id_response import TransactionsGetTransactionByIdResponse as TransactionsGetTransactionByIdResponseSchema

from griffin_python_sdk.type.transactions_get_transaction_by_id_response import TransactionsGetTransactionByIdResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.transactions_get_transaction_by_id_response import TransactionsGetTransactionByIdResponse as TransactionsGetTransactionByIdResponsePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'transaction-id': typing.Union[TransactionIdSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = TransactionsGetTransactionByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TransactionsGetTransactionByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_transaction_by_id_mapped_args(
        self,
        transaction_id: str,
    ...
    async def _aget_transaction_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/bank/transactions/{transaction-id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetTransactionByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_transaction_by_id(
        self,
        transaction_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_transaction_by_id_mapped_args(
            transaction_id=transaction_id,
        )
        return await self._aget_transaction_by_id_oapg(
...
class GetTransactionById(BaseApi):
    ...
    async def aget_transaction_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TransactionsGetTransactionByIdResponsePydantic:
        raw_response = await self.raw.aget_transaction_by_id(
            transaction_id=transaction_id,
            **kwargs,
        )
        if validate:
            return TransactionsGetTransactionByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TransactionsGetTransactionByIdResponsePydantic, raw_response.body)
    ...
    def get_transaction_by_id(
        ...
        raw_response = self.raw.get_transaction_by_id(
            transaction_id=transaction_id,
        )
        if validate:
            return TransactionsGetTransactionByIdResponsePydantic(**raw_response.body)
