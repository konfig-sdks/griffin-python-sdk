...
from griffin_python_sdk.model.reliance_onboarding_create_application_request_related_profiles import RelianceOnboardingCreateApplicationRequestRelatedProfiles as RelianceOnboardingCreateApplicationRequestRelatedProfilesSchema
from griffin_python_sdk.model.reliance_onboarding_create_application_request_subject_profile import RelianceOnboardingCreateApplicationRequestSubjectProfile as RelianceOnboardingCreateApplicationRequestSubjectProfileSchema
from griffin_python_sdk.model.reliance_onboarding_create_application_response import RelianceOnboardingCreateApplicationResponse as RelianceOnboardingCreateApplicationResponseSchema
from griffin_python_sdk.model.reliance_onboarding_create_application_request import RelianceOnboardingCreateApplicationRequest as RelianceOnboardingCreateApplicationRequestSchema

from griffin_python_sdk.type.reliance_onboarding_create_application_request_subject_profile import RelianceOnboardingCreateApplicationRequestSubjectProfile
from griffin_python_sdk.type.reliance_onboarding_create_application_response import RelianceOnboardingCreateApplicationResponse
from griffin_python_sdk.type.reliance_onboarding_create_application_request_related_profiles import RelianceOnboardingCreateApplicationRequestRelatedProfiles
from griffin_python_sdk.type.reliance_onboarding_create_application_request import RelianceOnboardingCreateApplicationRequest

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.reliance_onboarding_create_application_request import RelianceOnboardingCreateApplicationRequest as RelianceOnboardingCreateApplicationRequestPydantic
from griffin_python_sdk.pydantic.reliance_onboarding_create_application_response import RelianceOnboardingCreateApplicationResponse as RelianceOnboardingCreateApplicationResponsePydantic
from griffin_python_sdk.pydantic.reliance_onboarding_create_application_request_subject_profile import RelianceOnboardingCreateApplicationRequestSubjectProfile as RelianceOnboardingCreateApplicationRequestSubjectProfilePydantic
from griffin_python_sdk.pydantic.reliance_onboarding_create_application_request_related_profiles import RelianceOnboardingCreateApplicationRequestRelatedProfiles as RelianceOnboardingCreateApplicationRequestRelatedProfilesPydantic
...
# body param
SchemaForRequestBodyApplicationJson = RelianceOnboardingCreateApplicationRequestSchema


request_body_reliance_onboarding_create_application_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = RelianceOnboardingCreateApplicationResponseSchema
...
class ApiResponseFor201(api_client.ApiResponse):
    body: RelianceOnboardingCreateApplicationResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_application_mapped_args(
        self,
        workflow_url: str,
        subject_profile: RelianceOnboardingCreateApplicationRequestSubjectProfile,
        organization_id: str,
        related_profiles: typing.Optional[RelianceOnboardingCreateApplicationRequestRelatedProfiles] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if workflow_url is not None:
            _body["workflow-url"] = workflow_url
        if subject_profile is not None:
            _body["subject-profile"] = subject_profile
        if related_profiles is not None:
            _body["related-profiles"] = related_profiles
        args.body = _body
    ...
    async def _acreate_application_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/organizations/{organization-id}/onboarding/applications',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_reliance_onboarding_create_application_request.serialize(body, content_type)
...
class CreateApplicationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_application(
        self,
        workflow_url: str,
        subject_profile: RelianceOnboardingCreateApplicationRequestSubjectProfile,
        organization_id: str,
        ...
        **kwargs,
        ...
        args = self._create_application_mapped_args(
            workflow_url=workflow_url,
            subject_profile=subject_profile,
            organization_id=organization_id,
            related_profiles=related_profiles,
        )
        return await self._acreate_application_oapg(
            body=args.body,
...
class CreateApplication(BaseApi):
    ...
    async def acreate_application(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RelianceOnboardingCreateApplicationResponsePydantic:
        raw_response = await self.raw.acreate_application(
            workflow_url=workflow_url,
            subject_profile=subject_profile,
            organization_id=organization_id,
            related_profiles=related_profiles,
        ...
        if validate:
            return RelianceOnboardingCreateApplicationResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RelianceOnboardingCreateApplicationResponsePydantic, raw_response.body)
    ...
    def create_application(
        ...
        raw_response = self.raw.create_application(
            workflow_url=workflow_url,
            subject_profile=subject_profile,
            organization_id=organization_id,
            related_profiles=related_profiles,
