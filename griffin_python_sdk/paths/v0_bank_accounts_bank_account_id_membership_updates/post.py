...
from griffin_python_sdk.model.pooled_account_membership_manage_legal_persons_response import PooledAccountMembershipManageLegalPersonsResponse as PooledAccountMembershipManageLegalPersonsResponseSchema
from griffin_python_sdk.model.pooled_account_membership_manage_legal_persons_request_additions import PooledAccountMembershipManageLegalPersonsRequestAdditions as PooledAccountMembershipManageLegalPersonsRequestAdditionsSchema
from griffin_python_sdk.model.pooled_account_membership_manage_legal_persons_request import PooledAccountMembershipManageLegalPersonsRequest as PooledAccountMembershipManageLegalPersonsRequestSchema
from griffin_python_sdk.model.pooled_account_membership_manage_legal_persons_request_deletions import PooledAccountMembershipManageLegalPersonsRequestDeletions as PooledAccountMembershipManageLegalPersonsRequestDeletionsSchema

from griffin_python_sdk.type.pooled_account_membership_manage_legal_persons_request_additions import PooledAccountMembershipManageLegalPersonsRequestAdditions
from griffin_python_sdk.type.pooled_account_membership_manage_legal_persons_request import PooledAccountMembershipManageLegalPersonsRequest
from griffin_python_sdk.type.pooled_account_membership_manage_legal_persons_response import PooledAccountMembershipManageLegalPersonsResponse
from griffin_python_sdk.type.pooled_account_membership_manage_legal_persons_request_deletions import PooledAccountMembershipManageLegalPersonsRequestDeletions

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.pooled_account_membership_manage_legal_persons_request import PooledAccountMembershipManageLegalPersonsRequest as PooledAccountMembershipManageLegalPersonsRequestPydantic
from griffin_python_sdk.pydantic.pooled_account_membership_manage_legal_persons_response import PooledAccountMembershipManageLegalPersonsResponse as PooledAccountMembershipManageLegalPersonsResponsePydantic
from griffin_python_sdk.pydantic.pooled_account_membership_manage_legal_persons_request_additions import PooledAccountMembershipManageLegalPersonsRequestAdditions as PooledAccountMembershipManageLegalPersonsRequestAdditionsPydantic
from griffin_python_sdk.pydantic.pooled_account_membership_manage_legal_persons_request_deletions import PooledAccountMembershipManageLegalPersonsRequestDeletions as PooledAccountMembershipManageLegalPersonsRequestDeletionsPydantic

from . import path

# Path params
BankAccountIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'bank-account-id': typing.Union[BankAccountIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = PooledAccountMembershipManageLegalPersonsRequestSchema


request_body_pooled_account_membership_manage_legal_persons_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PooledAccountMembershipManageLegalPersonsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PooledAccountMembershipManageLegalPersonsResponse
...
class BaseApi(api_client.Api):
    ...
    def _manage_legal_persons_mapped_args(
        self,
        ...
        if additions is not None:
            _body["additions"] = additions
        if deletions is not None:
            _body["deletions"] = deletions
        args.body = _body
        if bank_account_id is not None:
            _path_params["bank-account-id"] = bank_account_id
        args.path = _path_params
        return args

    async def _amanage_legal_persons_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/bank/accounts/{bank-account-id}/membership-updates',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_pooled_account_membership_manage_legal_persons_request.serialize(body, content_type)
    ...
    def _manage_legal_persons_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ManageLegalPersonsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amanage_legal_persons(
        self,
        additions: PooledAccountMembershipManageLegalPersonsRequestAdditions,
        deletions: PooledAccountMembershipManageLegalPersonsRequestDeletions,
        bank_account_id: str,
        **kwargs,
        ...
        args = self._manage_legal_persons_mapped_args(
            additions=additions,
            deletions=deletions,
            bank_account_id=bank_account_id,
        )
        return await self._amanage_legal_persons_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def manage_legal_persons(
        self,
        additions: PooledAccountMembershipManageLegalPersonsRequestAdditions,
        deletions: PooledAccountMembershipManageLegalPersonsRequestDeletions,
        bank_account_id: str,
        ...
        return self._manage_legal_persons_oapg(
            body=args.body,
            path_params=args.path,
        )

class ManageLegalPersons(BaseApi):
    ...
    async def amanage_legal_persons(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PooledAccountMembershipManageLegalPersonsResponsePydantic:
        raw_response = await self.raw.amanage_legal_persons(
            additions=additions,
            deletions=deletions,
            bank_account_id=bank_account_id,
            **kwargs,
        ...
        if validate:
            return PooledAccountMembershipManageLegalPersonsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PooledAccountMembershipManageLegalPersonsResponsePydantic, raw_response.body)
    ...
    def manage_legal_persons(
        ...
        raw_response = self.raw.manage_legal_persons(
            additions=additions,
            deletions=deletions,
            bank_account_id=bank_account_id,
        )
