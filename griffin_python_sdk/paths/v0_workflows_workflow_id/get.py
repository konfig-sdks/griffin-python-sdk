...
from griffin_python_sdk.model.workflows_get_workflow_response import WorkflowsGetWorkflowResponse as WorkflowsGetWorkflowResponseSchema

from griffin_python_sdk.type.workflows_get_workflow_response import WorkflowsGetWorkflowResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.workflows_get_workflow_response import WorkflowsGetWorkflowResponse as WorkflowsGetWorkflowResponsePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'workflow-id': typing.Union[WorkflowIdSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = WorkflowsGetWorkflowResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkflowsGetWorkflowResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_workflow_mapped_args(
        ...
        if workflow_id is not None:
            _path_params["workflow-id"] = workflow_id
        args.path = _path_params
        return args

    async def _aget_workflow_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/workflows/{workflow-id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetWorkflowRaw(BaseApi):
    ...
    async def aget_workflow(
        ...
        **kwargs,
        ...
        args = self._get_workflow_mapped_args(
            workflow_id=workflow_id,
        )
        return await self._aget_workflow_oapg(
...
class GetWorkflow(BaseApi):
    ...
    async def aget_workflow(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkflowsGetWorkflowResponsePydantic:
        raw_response = await self.raw.aget_workflow(
            workflow_id=workflow_id,
            **kwargs,
        )
        if validate:
            return WorkflowsGetWorkflowResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkflowsGetWorkflowResponsePydantic, raw_response.body)
    ...
    def get_workflow(
        ...
        raw_response = self.raw.get_workflow(
            workflow_id=workflow_id,
        )
        if validate:
            return WorkflowsGetWorkflowResponsePydantic(**raw_response.body)
