...
from griffin_python_sdk.model.webhooks_create_webhook_request import WebhooksCreateWebhookRequest as WebhooksCreateWebhookRequestSchema
from griffin_python_sdk.model.webhooks_create_webhook_response import WebhooksCreateWebhookResponse as WebhooksCreateWebhookResponseSchema

from griffin_python_sdk.type.webhooks_create_webhook_request import WebhooksCreateWebhookRequest
from griffin_python_sdk.type.webhooks_create_webhook_response import WebhooksCreateWebhookResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.webhooks_create_webhook_response import WebhooksCreateWebhookResponse as WebhooksCreateWebhookResponsePydantic
from griffin_python_sdk.pydantic.webhooks_create_webhook_request import WebhooksCreateWebhookRequest as WebhooksCreateWebhookRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = WebhooksCreateWebhookRequestSchema


request_body_webhooks_create_webhook_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = WebhooksCreateWebhookResponseSchema
...
class ApiResponseFor201(api_client.ApiResponse):
    body: WebhooksCreateWebhookResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_webhook_mapped_args(
        self,
        webhook_destination_url: str,
        organization_id: str,
        webhook_description: typing.Optional[str] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if webhook_destination_url is not None:
            _body["webhook-destination-url"] = webhook_destination_url
        if webhook_description is not None:
            _body["webhook-description"] = webhook_description
        args.body = _body
    ...
    async def _acreate_webhook_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/organizations/{organization-id}/webhooks',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_webhooks_create_webhook_request.serialize(body, content_type)
    ...
    async def acreate_webhook(
        ...
        **kwargs,
        ...
        args = self._create_webhook_mapped_args(
            webhook_destination_url=webhook_destination_url,
...
class CreateWebhook(BaseApi):
    ...
    async def acreate_webhook(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksCreateWebhookResponsePydantic:
        ...
        if validate:
            return WebhooksCreateWebhookResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhooksCreateWebhookResponsePydantic, raw_response.body)
