...
from griffin_python_sdk.model.webhooks_get_all_response import WebhooksGetAllResponse as WebhooksGetAllResponseSchema

from griffin_python_sdk.type.webhooks_get_all_response import WebhooksGetAllResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.webhooks_get_all_response import WebhooksGetAllResponse as WebhooksGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WebhooksGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebhooksGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksGetAllResponsePydantic:
        raw_response = await self.raw.aget_all(
            organization_id=organization_id,
            **kwargs,
        )
        if validate:
            return WebhooksGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhooksGetAllResponsePydantic, raw_response.body)
