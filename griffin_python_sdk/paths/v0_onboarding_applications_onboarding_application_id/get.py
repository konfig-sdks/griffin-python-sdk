...
from griffin_python_sdk.model.reliance_onboarding_get_application_response import RelianceOnboardingGetApplicationResponse as RelianceOnboardingGetApplicationResponseSchema

from griffin_python_sdk.type.reliance_onboarding_get_application_response import RelianceOnboardingGetApplicationResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.reliance_onboarding_get_application_response import RelianceOnboardingGetApplicationResponse as RelianceOnboardingGetApplicationResponsePydantic

from . import path

# Path params
OnboardingApplicationIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'onboarding-application-id': typing.Union[OnboardingApplicationIdSchema, str, ],
    }
)
...
request_path_onboarding_application_id = api_client.PathParameter(
    name="onboarding-application-id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=OnboardingApplicationIdSchema,
    required=True,
)
_auth = [
    'api-key-auth',
]
SchemaFor200ResponseBodyApplicationJson = RelianceOnboardingGetApplicationResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RelianceOnboardingGetApplicationResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_application_mapped_args(
        self,
        onboarding_application_id: str,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        if onboarding_application_id is not None:
            _path_params["onboarding-application-id"] = onboarding_application_id
        args.path = _path_params
        return args

    async def _aget_application_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_onboarding_application_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v0/onboarding/applications/{onboarding-application-id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetApplicationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_application(
        self,
        onboarding_application_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_application_mapped_args(
            onboarding_application_id=onboarding_application_id,
        )
        return await self._aget_application_oapg(
...
class GetApplication(BaseApi):
    ...
    async def aget_application(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RelianceOnboardingGetApplicationResponsePydantic:
        raw_response = await self.raw.aget_application(
            onboarding_application_id=onboarding_application_id,
            **kwargs,
        )
        if validate:
            return RootModel[RelianceOnboardingGetApplicationResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(RelianceOnboardingGetApplicationResponsePydantic, raw_response.body)
    ...
    def get_application(
        ...
        raw_response = self.raw.get_application(
            onboarding_application_id=onboarding_application_id,
        )
        if validate:
            return RootModel[RelianceOnboardingGetApplicationResponsePydantic](raw_response.body).root
