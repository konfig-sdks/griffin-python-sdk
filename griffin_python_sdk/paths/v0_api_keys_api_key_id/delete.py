...
class BaseApi(api_client.Api):
    ...
    def _remove_api_key_mapped_args(
        self,
        api_key_id: str,
    ...
    async def _aremove_api_key_oapg(
        self,
...
class RemoveApiKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_api_key(
        self,
        api_key_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_api_key_mapped_args(
            api_key_id=api_key_id,
        )
        return await self._aremove_api_key_oapg(
    ...
    def remove_api_key(
        ...
        return self._remove_api_key_oapg(
            path_params=args.path,
        )

class RemoveApiKey(BaseApi):
    ...
    async def aremove_api_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_api_key(
            api_key_id=api_key_id,
            **kwargs,
        )
    ...
    def remove_api_key(
        ...
        raw_response = self.raw.remove_api_key(
            api_key_id=api_key_id,
        )
