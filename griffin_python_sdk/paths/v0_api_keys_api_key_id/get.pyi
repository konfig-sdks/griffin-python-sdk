...
from griffin_python_sdk.model.api_keys_get_key_details_response import ApiKeysGetKeyDetailsResponse as ApiKeysGetKeyDetailsResponseSchema

from griffin_python_sdk.type.api_keys_get_key_details_response import ApiKeysGetKeyDetailsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.api_keys_get_key_details_response import ApiKeysGetKeyDetailsResponse as ApiKeysGetKeyDetailsResponsePydantic

# Path params
ApiKeyIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'api-key-id': typing.Union[ApiKeyIdSchema, str, ],
    }
)
...
request_path_api_key_id = api_client.PathParameter(
    name="api-key-id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ApiKeyIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = ApiKeysGetKeyDetailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ApiKeysGetKeyDetailsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_key_details_mapped_args(
        self,
        api_key_id: str,
        ...
        if api_key_id is not None:
            _path_params["api-key-id"] = api_key_id
        args.path = _path_params
        return args

    async def _aget_key_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/api-keys/{api-key-id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetKeyDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_key_details(
        self,
        api_key_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_key_details_mapped_args(
            api_key_id=api_key_id,
        )
        return await self._aget_key_details_oapg(
    ...
    def get_key_details(
        ...
        return self._get_key_details_oapg(
            path_params=args.path,
        )

class GetKeyDetails(BaseApi):
    ...
    async def aget_key_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ApiKeysGetKeyDetailsResponsePydantic:
        raw_response = await self.raw.aget_key_details(
            api_key_id=api_key_id,
            **kwargs,
        )
        if validate:
            return ApiKeysGetKeyDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ApiKeysGetKeyDetailsResponsePydantic, raw_response.body)
    ...
    def get_key_details(
        ...
        raw_response = self.raw.get_key_details(
            api_key_id=api_key_id,
        )
        if validate:
            return ApiKeysGetKeyDetailsResponsePydantic(**raw_response.body)
