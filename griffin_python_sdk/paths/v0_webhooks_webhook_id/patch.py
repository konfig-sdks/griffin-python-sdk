...
from griffin_python_sdk.model.webhooks_update_webhook_response import WebhooksUpdateWebhookResponse as WebhooksUpdateWebhookResponseSchema
from griffin_python_sdk.model.webhooks_update_webhook_request import WebhooksUpdateWebhookRequest as WebhooksUpdateWebhookRequestSchema

from griffin_python_sdk.type.webhooks_update_webhook_response import WebhooksUpdateWebhookResponse
from griffin_python_sdk.type.webhooks_update_webhook_request import WebhooksUpdateWebhookRequest

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.webhooks_update_webhook_response import WebhooksUpdateWebhookResponse as WebhooksUpdateWebhookResponsePydantic
from griffin_python_sdk.pydantic.webhooks_update_webhook_request import WebhooksUpdateWebhookRequest as WebhooksUpdateWebhookRequestPydantic
...
SchemaFor200ResponseBodyApplicationJson = WebhooksUpdateWebhookResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebhooksUpdateWebhookResponse
    ...
    async def _aupdate_webhook_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/webhooks/{webhook-id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class UpdateWebhook(BaseApi):
    ...
    async def aupdate_webhook(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksUpdateWebhookResponsePydantic:
        ...
        if validate:
            return WebhooksUpdateWebhookResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhooksUpdateWebhookResponsePydantic, raw_response.body)
