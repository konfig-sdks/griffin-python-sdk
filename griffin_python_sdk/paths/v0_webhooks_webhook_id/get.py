...
from griffin_python_sdk.model.webhooks_get_webhook_response import WebhooksGetWebhookResponse as WebhooksGetWebhookResponseSchema

from griffin_python_sdk.type.webhooks_get_webhook_response import WebhooksGetWebhookResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.webhooks_get_webhook_response import WebhooksGetWebhookResponse as WebhooksGetWebhookResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WebhooksGetWebhookResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebhooksGetWebhookResponse
...
class GetWebhook(BaseApi):
    ...
    async def aget_webhook(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksGetWebhookResponsePydantic:
        raw_response = await self.raw.aget_webhook(
            webhook_id=webhook_id,
            **kwargs,
        )
        if validate:
            return WebhooksGetWebhookResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhooksGetWebhookResponsePydantic, raw_response.body)
