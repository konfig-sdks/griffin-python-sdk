...
from griffin_python_sdk.model.payments_list_admissions_response import PaymentsListAdmissionsResponse as PaymentsListAdmissionsResponseSchema

from griffin_python_sdk.type.payments_list_admissions_response import PaymentsListAdmissionsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.payments_list_admissions_response import PaymentsListAdmissionsResponse as PaymentsListAdmissionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PaymentsListAdmissionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentsListAdmissionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_admissions_mapped_args(
        self,
        payment_id: str,
    ...
    async def _alist_admissions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/payments/{payment-id}/admissions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListAdmissionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_admissions(
        self,
        payment_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_admissions_mapped_args(
            payment_id=payment_id,
        )
        return await self._alist_admissions_oapg(
    ...
    def list_admissions(
        ...
        return self._list_admissions_oapg(
            path_params=args.path,
        )

class ListAdmissions(BaseApi):
    ...
    async def alist_admissions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaymentsListAdmissionsResponsePydantic:
        raw_response = await self.raw.alist_admissions(
            payment_id=payment_id,
            **kwargs,
        )
        if validate:
            return PaymentsListAdmissionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PaymentsListAdmissionsResponsePydantic, raw_response.body)
    ...
    def list_admissions(
        ...
        raw_response = self.raw.list_admissions(
            payment_id=payment_id,
        )
        if validate:
            return PaymentsListAdmissionsResponsePydantic(**raw_response.body)
