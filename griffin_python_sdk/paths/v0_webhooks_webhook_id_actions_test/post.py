...
from griffin_python_sdk.model.webhooks_send_test_event_response import WebhooksSendTestEventResponse as WebhooksSendTestEventResponseSchema

from griffin_python_sdk.type.webhooks_send_test_event_response import WebhooksSendTestEventResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.webhooks_send_test_event_response import WebhooksSendTestEventResponse as WebhooksSendTestEventResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = WebhooksSendTestEventResponseSchema
...
class ApiResponseFor201(api_client.ApiResponse):
    body: WebhooksSendTestEventResponse
...
class BaseApi(api_client.Api):
    ...
    def _send_test_event_mapped_args(
        self,
        webhook_id: str,
    ...
    async def _asend_test_event_oapg(
        self,
...
class SendTestEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asend_test_event(
        self,
        webhook_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._send_test_event_mapped_args(
            webhook_id=webhook_id,
        )
        return await self._asend_test_event_oapg(
    ...
    def send_test_event(
        ...
        return self._send_test_event_oapg(
            path_params=args.path,
        )

class SendTestEvent(BaseApi):
    ...
    async def asend_test_event(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksSendTestEventResponsePydantic:
        raw_response = await self.raw.asend_test_event(
            webhook_id=webhook_id,
            **kwargs,
        )
        if validate:
            return RootModel[WebhooksSendTestEventResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(WebhooksSendTestEventResponsePydantic, raw_response.body)
    ...
    def send_test_event(
        ...
        raw_response = self.raw.send_test_event(
            webhook_id=webhook_id,
        )
        if validate:
            return RootModel[WebhooksSendTestEventResponsePydantic](raw_response.body).root
