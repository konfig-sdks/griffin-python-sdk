...
from griffin_python_sdk.model.webhooks_get_latest_test_status_response import WebhooksGetLatestTestStatusResponse as WebhooksGetLatestTestStatusResponseSchema

from griffin_python_sdk.type.webhooks_get_latest_test_status_response import WebhooksGetLatestTestStatusResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.webhooks_get_latest_test_status_response import WebhooksGetLatestTestStatusResponse as WebhooksGetLatestTestStatusResponsePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'webhook-id': typing.Union[WebhookIdSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = WebhooksGetLatestTestStatusResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebhooksGetLatestTestStatusResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_latest_test_status_mapped_args(
        self,
        webhook_id: str,
    ...
    async def _aget_latest_test_status_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/webhooks/{webhook-id}/actions/test',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_latest_test_status_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetLatestTestStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_latest_test_status(
        self,
        webhook_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_latest_test_status_mapped_args(
            webhook_id=webhook_id,
        )
        return await self._aget_latest_test_status_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_latest_test_status(
        self,
        webhook_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_latest_test_status_oapg(
            path_params=args.path,
        )

class GetLatestTestStatus(BaseApi):
    ...
    async def aget_latest_test_status(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksGetLatestTestStatusResponsePydantic:
        raw_response = await self.raw.aget_latest_test_status(
            webhook_id=webhook_id,
            **kwargs,
        )
        if validate:
            return RootModel[WebhooksGetLatestTestStatusResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(WebhooksGetLatestTestStatusResponsePydantic, raw_response.body)
    ...
    def get_latest_test_status(
        ...
        raw_response = self.raw.get_latest_test_status(
            webhook_id=webhook_id,
        )
        if validate:
            return RootModel[WebhooksGetLatestTestStatusResponsePydantic](raw_response.body).root
