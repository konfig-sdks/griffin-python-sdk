...
from griffin_python_sdk.model.users_get_user_resource_response import UsersGetUserResourceResponse as UsersGetUserResourceResponseSchema

from griffin_python_sdk.type.users_get_user_resource_response import UsersGetUserResourceResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.users_get_user_resource_response import UsersGetUserResourceResponse as UsersGetUserResourceResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UsersGetUserResourceResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UsersGetUserResourceResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_user_resource_mapped_args(
        self,
        user_id: str,
    ...
    async def _aget_user_resource_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/users/{user-id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetUserResourceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_resource(
        self,
        user_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_user_resource_mapped_args(
            user_id=user_id,
        )
        return await self._aget_user_resource_oapg(
    ...
    def get_user_resource(
        ...
        return self._get_user_resource_oapg(
            path_params=args.path,
        )

class GetUserResource(BaseApi):
    ...
    async def aget_user_resource(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UsersGetUserResourceResponsePydantic:
        raw_response = await self.raw.aget_user_resource(
            user_id=user_id,
            **kwargs,
        )
        if validate:
            return UsersGetUserResourceResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UsersGetUserResourceResponsePydantic, raw_response.body)
    ...
    def get_user_resource(
        ...
        raw_response = self.raw.get_user_resource(
            user_id=user_id,
        )
        if validate:
            return UsersGetUserResourceResponsePydantic(**raw_response.body)
