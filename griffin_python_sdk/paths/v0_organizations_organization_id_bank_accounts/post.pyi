...
from griffin_python_sdk.model.bank_accounts_create_new_account_response import BankAccountsCreateNewAccountResponse as BankAccountsCreateNewAccountResponseSchema
from griffin_python_sdk.model.bank_accounts_create_new_account_request import BankAccountsCreateNewAccountRequest as BankAccountsCreateNewAccountRequestSchema

from griffin_python_sdk.type.bank_accounts_create_new_account_response import BankAccountsCreateNewAccountResponse
from griffin_python_sdk.type.bank_accounts_create_new_account_request import BankAccountsCreateNewAccountRequest

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.bank_accounts_create_new_account_request import BankAccountsCreateNewAccountRequest as BankAccountsCreateNewAccountRequestPydantic
from griffin_python_sdk.pydantic.bank_accounts_create_new_account_response import BankAccountsCreateNewAccountResponse as BankAccountsCreateNewAccountResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = BankAccountsCreateNewAccountRequestSchema


request_body_bank_accounts_create_new_account_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = BankAccountsCreateNewAccountResponseSchema
...
class ApiResponseFor201(api_client.ApiResponse):
    body: BankAccountsCreateNewAccountResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_new_account_mapped_args(
        self,
        bank_product_type: str,
        organization_id: str,
        owner_url: typing.Optional[str] = None,
        savings_type: typing.Optional[str] = None,
        display_name: typing.Optional[str] = None,
        client_money_type: typing.Optional[str] = None,
        pooled_funds: typing.Optional[str] = None,
        beneficiary_url: typing.Optional[str] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if owner_url is not None:
            _body["owner-url"] = owner_url
        if savings_type is not None:
            _body["savings-type"] = savings_type
        if display_name is not None:
            _body["display-name"] = display_name
        if bank_product_type is not None:
            _body["bank-product-type"] = bank_product_type
        if client_money_type is not None:
            _body["client-money-type"] = client_money_type
        if pooled_funds is not None:
            _body["pooled-funds"] = pooled_funds
        if beneficiary_url is not None:
            _body["beneficiary-url"] = beneficiary_url
        args.body = _body
    ...
    async def _acreate_new_account_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_bank_accounts_create_new_account_request.serialize(body, content_type)
    ...
    async def acreate_new_account(
        ...
        **kwargs,
        ...
        args = self._create_new_account_mapped_args(
            bank_product_type=bank_product_type,
            organization_id=organization_id,
            owner_url=owner_url,
            savings_type=savings_type,
            display_name=display_name,
            client_money_type=client_money_type,
            pooled_funds=pooled_funds,
...
class CreateNewAccount(BaseApi):
    ...
    async def acreate_new_account(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BankAccountsCreateNewAccountResponsePydantic:
        ...
        if validate:
            return BankAccountsCreateNewAccountResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(BankAccountsCreateNewAccountResponsePydantic, raw_response.body)
