...
from griffin_python_sdk.model.api_keys_list_active_keys_response import ApiKeysListActiveKeysResponse as ApiKeysListActiveKeysResponseSchema

from griffin_python_sdk.type.api_keys_list_active_keys_response import ApiKeysListActiveKeysResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.api_keys_list_active_keys_response import ApiKeysListActiveKeysResponse as ApiKeysListActiveKeysResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ApiKeysListActiveKeysResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ApiKeysListActiveKeysResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_active_keys_mapped_args(
        self,
        organization_id: str,
    ...
    async def _alist_active_keys_oapg(
        self,
...
class ListActiveKeysRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_active_keys(
        self,
        organization_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_active_keys_mapped_args(
        ...
        return await self._alist_active_keys_oapg(
    ...
    def list_active_keys(
        ...
        return self._list_active_keys_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListActiveKeys(BaseApi):
    ...
    async def alist_active_keys(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ApiKeysListActiveKeysResponsePydantic:
        raw_response = await self.raw.alist_active_keys(
            organization_id=organization_id,
            sort=sort,
            page_size=page_size,
            page_after=page_after,
        ...
        if validate:
            return ApiKeysListActiveKeysResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ApiKeysListActiveKeysResponsePydantic, raw_response.body)
    ...
    def list_active_keys(
        ...
        raw_response = self.raw.list_active_keys(
            organization_id=organization_id,
            sort=sort,
            page_size=page_size,
            page_after=page_after,
