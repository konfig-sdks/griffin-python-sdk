...
from griffin_python_sdk.model.api_keys_create_key_request import ApiKeysCreateKeyRequest as ApiKeysCreateKeyRequestSchema
from griffin_python_sdk.model.api_keys_create_key_response import ApiKeysCreateKeyResponse as ApiKeysCreateKeyResponseSchema

from griffin_python_sdk.type.api_keys_create_key_request import ApiKeysCreateKeyRequest
from griffin_python_sdk.type.api_keys_create_key_response import ApiKeysCreateKeyResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.api_keys_create_key_request import ApiKeysCreateKeyRequest as ApiKeysCreateKeyRequestPydantic
from griffin_python_sdk.pydantic.api_keys_create_key_response import ApiKeysCreateKeyResponse as ApiKeysCreateKeyResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ApiKeysCreateKeyRequestSchema


request_body_api_keys_create_key_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ApiKeysCreateKeyResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_key_mapped_args(
        self,
        api_key_name: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
        organization_id: str,
        ...
        if api_key_name is not None:
            _body["api-key-name"] = api_key_name
        args.body = _body
    ...
    async def _acreate_key_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/organizations/{organization-id}/api-keys',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_api_keys_create_key_request.serialize(body, content_type)
...
class CreateKey(BaseApi):
    ...
    async def acreate_key(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ApiKeysCreateKeyResponsePydantic:
        ...
        if validate:
            return ApiKeysCreateKeyResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ApiKeysCreateKeyResponsePydantic, raw_response.body)
