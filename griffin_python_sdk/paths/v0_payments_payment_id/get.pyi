...
from griffin_python_sdk.model.payments_get_details_response import PaymentsGetDetailsResponse as PaymentsGetDetailsResponseSchema

from griffin_python_sdk.type.payments_get_details_response import PaymentsGetDetailsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.payments_get_details_response import PaymentsGetDetailsResponse as PaymentsGetDetailsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PaymentsGetDetailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentsGetDetailsResponse
    ...
    async def _aget_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/payments/{payment-id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaymentsGetDetailsResponsePydantic:
        raw_response = await self.raw.aget_details(
            payment_id=payment_id,
            **kwargs,
        )
        if validate:
            return PaymentsGetDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PaymentsGetDetailsResponsePydantic, raw_response.body)
