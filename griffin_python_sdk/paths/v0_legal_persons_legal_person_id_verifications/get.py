...
from griffin_python_sdk.model.verifications_list_for_legal_person_response import VerificationsListForLegalPersonResponse as VerificationsListForLegalPersonResponseSchema

from griffin_python_sdk.type.verifications_list_for_legal_person_response import VerificationsListForLegalPersonResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.verifications_list_for_legal_person_response import VerificationsListForLegalPersonResponse as VerificationsListForLegalPersonResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = VerificationsListForLegalPersonResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: VerificationsListForLegalPersonResponse
...
class ListForLegalPerson(BaseApi):
    ...
    async def alist_for_legal_person(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VerificationsListForLegalPersonResponsePydantic:
        ...
        if validate:
            return VerificationsListForLegalPersonResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VerificationsListForLegalPersonResponsePydantic, raw_response.body)
