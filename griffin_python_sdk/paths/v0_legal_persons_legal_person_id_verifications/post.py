...
from griffin_python_sdk.model.verifications_initiate_verification_request import VerificationsInitiateVerificationRequest as VerificationsInitiateVerificationRequestSchema
from griffin_python_sdk.model.verifications_initiate_verification_response import VerificationsInitiateVerificationResponse as VerificationsInitiateVerificationResponseSchema

from griffin_python_sdk.type.verifications_initiate_verification_response import VerificationsInitiateVerificationResponse
from griffin_python_sdk.type.verifications_initiate_verification_request import VerificationsInitiateVerificationRequest

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.verifications_initiate_verification_request import VerificationsInitiateVerificationRequest as VerificationsInitiateVerificationRequestPydantic
from griffin_python_sdk.pydantic.verifications_initiate_verification_response import VerificationsInitiateVerificationResponse as VerificationsInitiateVerificationResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = VerificationsInitiateVerificationRequestSchema


request_body_verifications_initiate_verification_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = VerificationsInitiateVerificationResponseSchema
...
class ApiResponseFor201(api_client.ApiResponse):
    body: VerificationsInitiateVerificationResponse
...
class BaseApi(api_client.Api):
    ...
    def _initiate_verification_mapped_args(
        self,
        workflow_url: str,
        legal_person_id: str,
    ...
    async def _ainitiate_verification_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/legal-persons/{legal-person-id}/verifications',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_verifications_initiate_verification_request.serialize(body, content_type)
    ...
    def _initiate_verification_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class InitiateVerificationRaw(BaseApi):
    ...
    async def ainitiate_verification(
        ...
        **kwargs,
        ...
        args = self._initiate_verification_mapped_args(
            workflow_url=workflow_url,
            legal_person_id=legal_person_id,
        )
        return await self._ainitiate_verification_oapg(
            body=args.body,
    ...
    def initiate_verification(
        ...
        return self._initiate_verification_oapg(
            body=args.body,
            path_params=args.path,
        )

class InitiateVerification(BaseApi):
    ...
    async def ainitiate_verification(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VerificationsInitiateVerificationResponsePydantic:
        raw_response = await self.raw.ainitiate_verification(
            workflow_url=workflow_url,
            legal_person_id=legal_person_id,
            **kwargs,
        )
        if validate:
            return VerificationsInitiateVerificationResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VerificationsInitiateVerificationResponsePydantic, raw_response.body)
    ...
    def initiate_verification(
        ...
        raw_response = self.raw.initiate_verification(
            workflow_url=workflow_url,
            legal_person_id=legal_person_id,
        )
        if validate:
