...
from griffin_python_sdk.model.bank_accounts_close_account_response import BankAccountsCloseAccountResponse as BankAccountsCloseAccountResponseSchema

from griffin_python_sdk.type.bank_accounts_close_account_response import BankAccountsCloseAccountResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.bank_accounts_close_account_response import BankAccountsCloseAccountResponse as BankAccountsCloseAccountResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BankAccountsCloseAccountResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: BankAccountsCloseAccountResponse
...
class BaseApi(api_client.Api):
    ...
    def _close_account_mapped_args(
        self,
        bank_account_id: str,
    ...
    async def _aclose_account_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/bank/accounts/{bank-account-id}/actions/close',
            auth_settings=_auth,
            headers=_headers,
        )
...
class CloseAccountRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aclose_account(
        self,
        bank_account_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._close_account_mapped_args(
            bank_account_id=bank_account_id,
        )
        return await self._aclose_account_oapg(
    ...
    def close_account(
        ...
        return self._close_account_oapg(
            path_params=args.path,
        )

class CloseAccount(BaseApi):
    ...
    async def aclose_account(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BankAccountsCloseAccountResponsePydantic:
        raw_response = await self.raw.aclose_account(
            bank_account_id=bank_account_id,
            **kwargs,
        )
        if validate:
            return BankAccountsCloseAccountResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(BankAccountsCloseAccountResponsePydantic, raw_response.body)
    ...
    def close_account(
        ...
        raw_response = self.raw.close_account(
            bank_account_id=bank_account_id,
        )
        if validate:
            return BankAccountsCloseAccountResponsePydantic(**raw_response.body)
