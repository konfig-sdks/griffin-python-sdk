...
class BaseApi(api_client.Api):
    ...
    def _check_connection_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _acheck_connection_oapg(
        self,
...
class CheckConnectionRaw(BaseApi):
    ...
    async def acheck_connection(
        ...
        **kwargs,
        ...
        args = self._check_connection_mapped_args(
        )
        return await self._acheck_connection_oapg(
            **kwargs,
        )
    ...
    def check_connection(
        ...
        return self._check_connection_oapg(
        )
...
class CheckConnection(BaseApi):
    ...
    async def acheck_connection(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_connection(
            **kwargs,
        )
    ...
    def check_connection(
        ...
        raw_response = self.raw.check_connection(
        )
