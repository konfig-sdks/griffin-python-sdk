...
from griffin_python_sdk.model.payments_get_submission_response import PaymentsGetSubmissionResponse as PaymentsGetSubmissionResponseSchema

from griffin_python_sdk.type.payments_get_submission_response import PaymentsGetSubmissionResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.payments_get_submission_response import PaymentsGetSubmissionResponse as PaymentsGetSubmissionResponsePydantic

# Path params
SubmissionIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'submission-id': typing.Union[SubmissionIdSchema, str, ],
    }
)
...
request_path_submission_id = api_client.PathParameter(
    name="submission-id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SubmissionIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = PaymentsGetSubmissionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentsGetSubmissionResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_submission_mapped_args(
        self,
        submission_id: str,
        ...
        if submission_id is not None:
            _path_params["submission-id"] = submission_id
        args.path = _path_params
        return args

    async def _aget_submission_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/submissions/{submission-id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetSubmissionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_submission(
        self,
        submission_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_submission_mapped_args(
            submission_id=submission_id,
        )
        return await self._aget_submission_oapg(
...
class GetSubmission(BaseApi):
    ...
    async def aget_submission(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaymentsGetSubmissionResponsePydantic:
        raw_response = await self.raw.aget_submission(
            submission_id=submission_id,
            **kwargs,
        )
        if validate:
            return PaymentsGetSubmissionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PaymentsGetSubmissionResponsePydantic, raw_response.body)
    ...
    def get_submission(
        ...
        raw_response = self.raw.get_submission(
            submission_id=submission_id,
        )
        if validate:
            return PaymentsGetSubmissionResponsePydantic(**raw_response.body)
