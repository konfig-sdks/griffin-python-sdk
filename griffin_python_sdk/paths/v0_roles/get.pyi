...
from griffin_python_sdk.model.roles_list_all_roles_response import RolesListAllRolesResponse as RolesListAllRolesResponseSchema

from griffin_python_sdk.type.roles_list_all_roles_response import RolesListAllRolesResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.roles_list_all_roles_response import RolesListAllRolesResponse as RolesListAllRolesResponsePydantic

SchemaFor200ResponseBodyApplicationJson = RolesListAllRolesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RolesListAllRolesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_all_roles_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_all_roles_oapg(
        self,
...
class ListAllRolesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_all_roles(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_all_roles_mapped_args(
        )
        return await self._alist_all_roles_oapg(
            **kwargs,
        )
    ...
    def list_all_roles(
        ...
        return self._list_all_roles_oapg(
        )

class ListAllRoles(BaseApi):

    async def alist_all_roles(
        self,
        validate: bool = False,
        **kwargs,
    ) -> RolesListAllRolesResponsePydantic:
        raw_response = await self.raw.alist_all_roles(
            **kwargs,
        )
        if validate:
            return RolesListAllRolesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RolesListAllRolesResponsePydantic, raw_response.body)
    ...
    def list_all_roles(
        ...
        raw_response = self.raw.list_all_roles(
        )
        if validate:
            return RolesListAllRolesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RolesListAllRolesResponsePydantic, raw_response.body)
