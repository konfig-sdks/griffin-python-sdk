...
from griffin_python_sdk.model.webhooks_deactivate_action_response import WebhooksDeactivateActionResponse as WebhooksDeactivateActionResponseSchema

from griffin_python_sdk.type.webhooks_deactivate_action_response import WebhooksDeactivateActionResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.webhooks_deactivate_action_response import WebhooksDeactivateActionResponse as WebhooksDeactivateActionResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WebhooksDeactivateActionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebhooksDeactivateActionResponse
...
class BaseApi(api_client.Api):
    ...
    def _deactivate_action_mapped_args(
        self,
        webhook_id: str,
    ...
    async def _adeactivate_action_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/webhooks/{webhook-id}/actions/deactivate',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeactivateActionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adeactivate_action(
        self,
        webhook_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._deactivate_action_mapped_args(
            webhook_id=webhook_id,
        )
        return await self._adeactivate_action_oapg(
    ...
    def deactivate_action(
        ...
        return self._deactivate_action_oapg(
            path_params=args.path,
        )

class DeactivateAction(BaseApi):
    ...
    async def adeactivate_action(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksDeactivateActionResponsePydantic:
        raw_response = await self.raw.adeactivate_action(
            webhook_id=webhook_id,
            **kwargs,
        )
        if validate:
            return WebhooksDeactivateActionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhooksDeactivateActionResponsePydantic, raw_response.body)
    ...
    def deactivate_action(
        ...
        raw_response = self.raw.deactivate_action(
            webhook_id=webhook_id,
        )
        if validate:
            return WebhooksDeactivateActionResponsePydantic(**raw_response.body)
