...
from griffin_python_sdk.model.legal_person_history_list_events_response import LegalPersonHistoryListEventsResponse as LegalPersonHistoryListEventsResponseSchema

from griffin_python_sdk.type.legal_person_history_list_events_response import LegalPersonHistoryListEventsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.legal_person_history_list_events_response import LegalPersonHistoryListEventsResponse as LegalPersonHistoryListEventsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LegalPersonHistoryListEventsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LegalPersonHistoryListEventsResponse
    ...
    async def _alist_events_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/legal-persons/{legal-person-id}/history',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListEventsRaw(BaseApi):
    ...
    async def alist_events(
        ...
        **kwargs,
        ...
        args = self._list_events_mapped_args(
            legal_person_id=legal_person_id,
            page_size=page_size,
            page_after=page_after,
            page_before=page_before,
        )
        return await self._alist_events_oapg(
    ...
    def list_events(
        ...
        return self._list_events_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListEvents(BaseApi):
    ...
    async def alist_events(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LegalPersonHistoryListEventsResponsePydantic:
        raw_response = await self.raw.alist_events(
            legal_person_id=legal_person_id,
            page_size=page_size,
            page_after=page_after,
            page_before=page_before,
        ...
        if validate:
            return LegalPersonHistoryListEventsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LegalPersonHistoryListEventsResponsePydantic, raw_response.body)
    ...
    def list_events(
        ...
        raw_response = self.raw.list_events(
            legal_person_id=legal_person_id,
            page_size=page_size,
            page_after=page_after,
            page_before=page_before,
