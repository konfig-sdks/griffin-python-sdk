...
from griffin_python_sdk.model.legal_persons_get_legal_person_response import LegalPersonsGetLegalPersonResponse as LegalPersonsGetLegalPersonResponseSchema

from griffin_python_sdk.type.legal_persons_get_legal_person_response import LegalPersonsGetLegalPersonResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.legal_persons_get_legal_person_response import LegalPersonsGetLegalPersonResponse as LegalPersonsGetLegalPersonResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LegalPersonsGetLegalPersonResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LegalPersonsGetLegalPersonResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_legal_person_mapped_args(
        self,
        legal_person_id: str,
    ...
    async def _aget_legal_person_oapg(
        self,
...
class GetLegalPersonRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_legal_person(
        self,
        legal_person_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_legal_person_mapped_args(
            legal_person_id=legal_person_id,
        )
        return await self._aget_legal_person_oapg(
    ...
    def get_legal_person(
        ...
        return self._get_legal_person_oapg(
            path_params=args.path,
        )

class GetLegalPerson(BaseApi):
    ...
    async def aget_legal_person(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LegalPersonsGetLegalPersonResponsePydantic:
        raw_response = await self.raw.aget_legal_person(
            legal_person_id=legal_person_id,
            **kwargs,
        )
        if validate:
            return LegalPersonsGetLegalPersonResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LegalPersonsGetLegalPersonResponsePydantic, raw_response.body)
    ...
    def get_legal_person(
        ...
        raw_response = self.raw.get_legal_person(
            legal_person_id=legal_person_id,
        )
        if validate:
            return LegalPersonsGetLegalPersonResponsePydantic(**raw_response.body)
