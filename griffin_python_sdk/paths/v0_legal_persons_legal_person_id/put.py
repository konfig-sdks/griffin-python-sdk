...
from griffin_python_sdk.model.legal_persons_update_legal_person_request import LegalPersonsUpdateLegalPersonRequest as LegalPersonsUpdateLegalPersonRequestSchema
from griffin_python_sdk.model.legal_persons_update_legal_person_response import LegalPersonsUpdateLegalPersonResponse as LegalPersonsUpdateLegalPersonResponseSchema

from griffin_python_sdk.type.legal_persons_update_legal_person_request import LegalPersonsUpdateLegalPersonRequest
from griffin_python_sdk.type.legal_persons_update_legal_person_response import LegalPersonsUpdateLegalPersonResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.legal_persons_update_legal_person_response import LegalPersonsUpdateLegalPersonResponse as LegalPersonsUpdateLegalPersonResponsePydantic
from griffin_python_sdk.pydantic.legal_persons_update_legal_person_request import LegalPersonsUpdateLegalPersonRequest as LegalPersonsUpdateLegalPersonRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = LegalPersonsUpdateLegalPersonRequestSchema


request_body_legal_persons_update_legal_person_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = LegalPersonsUpdateLegalPersonResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: LegalPersonsUpdateLegalPersonResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_legal_person_mapped_args(
        self,
        display_name: str,
        legal_person_id: str,
    ...
    async def _aupdate_legal_person_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/legal-persons/{legal-person-id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_legal_persons_update_legal_person_request.serialize(body, content_type)
...
class UpdateLegalPersonRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_legal_person(
        self,
        display_name: str,
        legal_person_id: str,
        **kwargs,
        ...
        args = self._update_legal_person_mapped_args(
            display_name=display_name,
            legal_person_id=legal_person_id,
        )
        return await self._aupdate_legal_person_oapg(
            body=args.body,
    ...
    def update_legal_person(
        ...
        return self._update_legal_person_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateLegalPerson(BaseApi):
    ...
    async def aupdate_legal_person(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LegalPersonsUpdateLegalPersonResponsePydantic:
        raw_response = await self.raw.aupdate_legal_person(
            display_name=display_name,
            legal_person_id=legal_person_id,
            **kwargs,
        )
        if validate:
            return LegalPersonsUpdateLegalPersonResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LegalPersonsUpdateLegalPersonResponsePydantic, raw_response.body)
    ...
    def update_legal_person(
        ...
        raw_response = self.raw.update_legal_person(
            display_name=display_name,
            legal_person_id=legal_person_id,
        )
        if validate:
