...
from griffin_python_sdk.model.events_get_event_response import EventsGetEventResponse as EventsGetEventResponseSchema

from griffin_python_sdk.type.events_get_event_response import EventsGetEventResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.events_get_event_response import EventsGetEventResponse as EventsGetEventResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = EventsGetEventResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EventsGetEventResponse
    ...
    async def _aget_event_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/events/{event-id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetEventRaw(BaseApi):
    ...
    async def aget_event(
        ...
        **kwargs,
        ...
        args = self._get_event_mapped_args(
            event_id=event_id,
        )
        return await self._aget_event_oapg(
...
class GetEvent(BaseApi):
    ...
    async def aget_event(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EventsGetEventResponsePydantic:
        raw_response = await self.raw.aget_event(
            event_id=event_id,
            **kwargs,
        )
        if validate:
            return EventsGetEventResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(EventsGetEventResponsePydantic, raw_response.body)
    ...
    def get_event(
        ...
        raw_response = self.raw.get_event(
            event_id=event_id,
        )
        if validate:
            return EventsGetEventResponsePydantic(**raw_response.body)
