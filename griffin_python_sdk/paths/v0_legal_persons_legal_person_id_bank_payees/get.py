...
from griffin_python_sdk.model.payees_list_legal_person_payees_response import PayeesListLegalPersonPayeesResponse as PayeesListLegalPersonPayeesResponseSchema

from griffin_python_sdk.type.payees_list_legal_person_payees_response import PayeesListLegalPersonPayeesResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.payees_list_legal_person_payees_response import PayeesListLegalPersonPayeesResponse as PayeesListLegalPersonPayeesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PayeesListLegalPersonPayeesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PayeesListLegalPersonPayeesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_legal_person_payees_mapped_args(
        self,
        legal_person_id: str,
    ...
    async def _alist_legal_person_payees_oapg(
        self,
    ...
    def _list_legal_person_payees_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListLegalPersonPayeesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_legal_person_payees(
        self,
        legal_person_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_legal_person_payees_mapped_args(
        ...
        return await self._alist_legal_person_payees_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_legal_person_payees(
        self,
        legal_person_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        return self._list_legal_person_payees_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListLegalPersonPayees(BaseApi):
    ...
    async def alist_legal_person_payees(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PayeesListLegalPersonPayeesResponsePydantic:
        raw_response = await self.raw.alist_legal_person_payees(
            legal_person_id=legal_person_id,
            sort=sort,
            page_size=page_size,
            page_after=page_after,
        ...
        if validate:
            return PayeesListLegalPersonPayeesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PayeesListLegalPersonPayeesResponsePydantic, raw_response.body)
    ...
    def list_legal_person_payees(
        ...
        raw_response = self.raw.list_legal_person_payees(
            legal_person_id=legal_person_id,
            sort=sort,
            page_size=page_size,
            page_after=page_after,
