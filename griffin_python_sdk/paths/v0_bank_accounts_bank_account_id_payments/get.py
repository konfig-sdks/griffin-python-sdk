...
from griffin_python_sdk.model.payments_get_bank_account_payments_response import PaymentsGetBankAccountPaymentsResponse as PaymentsGetBankAccountPaymentsResponseSchema

from griffin_python_sdk.type.payments_get_bank_account_payments_response import PaymentsGetBankAccountPaymentsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.payments_get_bank_account_payments_response import PaymentsGetBankAccountPaymentsResponse as PaymentsGetBankAccountPaymentsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PaymentsGetBankAccountPaymentsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentsGetBankAccountPaymentsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_bank_account_payments_mapped_args(
        self,
        bank_account_id: str,
    ...
    async def _aget_bank_account_payments_oapg(
        self,
    ...
    def _get_bank_account_payments_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetBankAccountPaymentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_bank_account_payments(
        self,
        bank_account_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_bank_account_payments_mapped_args(
        ...
        return await self._aget_bank_account_payments_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_bank_account_payments(
        self,
        bank_account_id: str,
        sort: typing.Optional[str] = None,
        page_size: typing.Optional[int] = None,
        ...
        return self._get_bank_account_payments_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetBankAccountPayments(BaseApi):
    ...
    async def aget_bank_account_payments(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaymentsGetBankAccountPaymentsResponsePydantic:
        raw_response = await self.raw.aget_bank_account_payments(
            bank_account_id=bank_account_id,
            sort=sort,
            page_size=page_size,
            page_before=page_before,
        ...
        if validate:
            return PaymentsGetBankAccountPaymentsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PaymentsGetBankAccountPaymentsResponsePydantic, raw_response.body)
    ...
    def get_bank_account_payments(
        ...
        raw_response = self.raw.get_bank_account_payments(
            bank_account_id=bank_account_id,
            sort=sort,
            page_size=page_size,
            page_before=page_before,
