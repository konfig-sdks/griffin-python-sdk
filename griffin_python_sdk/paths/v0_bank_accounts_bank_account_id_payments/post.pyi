...
from griffin_python_sdk.model.payments_create_request_request_creditor import PaymentsCreateRequestRequestCreditor as PaymentsCreateRequestRequestCreditorSchema
from griffin_python_sdk.model.payments_create_request_request_payment_amount import PaymentsCreateRequestRequestPaymentAmount as PaymentsCreateRequestRequestPaymentAmountSchema
from griffin_python_sdk.model.payments_create_request_response import PaymentsCreateRequestResponse as PaymentsCreateRequestResponseSchema
from griffin_python_sdk.model.payments_create_request_request import PaymentsCreateRequestRequest as PaymentsCreateRequestRequestSchema

from griffin_python_sdk.type.payments_create_request_response import PaymentsCreateRequestResponse
from griffin_python_sdk.type.payments_create_request_request_payment_amount import PaymentsCreateRequestRequestPaymentAmount
from griffin_python_sdk.type.payments_create_request_request_creditor import PaymentsCreateRequestRequestCreditor
from griffin_python_sdk.type.payments_create_request_request import PaymentsCreateRequestRequest

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.payments_create_request_response import PaymentsCreateRequestResponse as PaymentsCreateRequestResponsePydantic
from griffin_python_sdk.pydantic.payments_create_request_request_creditor import PaymentsCreateRequestRequestCreditor as PaymentsCreateRequestRequestCreditorPydantic
from griffin_python_sdk.pydantic.payments_create_request_request import PaymentsCreateRequestRequest as PaymentsCreateRequestRequestPydantic
from griffin_python_sdk.pydantic.payments_create_request_request_payment_amount import PaymentsCreateRequestRequestPaymentAmount as PaymentsCreateRequestRequestPaymentAmountPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PaymentsCreateRequestRequestSchema


request_body_payments_create_request_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = PaymentsCreateRequestResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: PaymentsCreateRequestResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_request_mapped_args(
        self,
        creditor: PaymentsCreateRequestRequestCreditor,
        payment_amount: PaymentsCreateRequestRequestPaymentAmount,
        bank_account_id: str,
        ...
        if creditor is not None:
            _body["creditor"] = creditor
        if payment_amount is not None:
            _body["payment-amount"] = payment_amount
        if payment_reference is not None:
            _body["payment-reference"] = payment_reference
        args.body = _body
    ...
    async def _acreate_request_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/bank/accounts/{bank-account-id}/payments',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_payments_create_request_request.serialize(body, content_type)
...
class CreateRequest(BaseApi):
    ...
    async def acreate_request(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaymentsCreateRequestResponsePydantic:
        ...
        if validate:
            return PaymentsCreateRequestResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PaymentsCreateRequestResponsePydantic, raw_response.body)
