...
from griffin_python_sdk.model.webhooks_activate_action_response import WebhooksActivateActionResponse as WebhooksActivateActionResponseSchema

from griffin_python_sdk.type.webhooks_activate_action_response import WebhooksActivateActionResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.webhooks_activate_action_response import WebhooksActivateActionResponse as WebhooksActivateActionResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WebhooksActivateActionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebhooksActivateActionResponse
...
class BaseApi(api_client.Api):
    ...
    def _activate_action_mapped_args(
        self,
        webhook_id: str,
    ...
    async def _aactivate_action_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/webhooks/{webhook-id}/actions/activate',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ActivateActionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aactivate_action(
        self,
        webhook_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._activate_action_mapped_args(
            webhook_id=webhook_id,
        )
        return await self._aactivate_action_oapg(
    ...
    def activate_action(
        ...
        return self._activate_action_oapg(
            path_params=args.path,
        )

class ActivateAction(BaseApi):
    ...
    async def aactivate_action(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksActivateActionResponsePydantic:
        raw_response = await self.raw.aactivate_action(
            webhook_id=webhook_id,
            **kwargs,
        )
        if validate:
            return WebhooksActivateActionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhooksActivateActionResponsePydantic, raw_response.body)
    ...
    def activate_action(
        ...
        raw_response = self.raw.activate_action(
            webhook_id=webhook_id,
        )
        if validate:
            return WebhooksActivateActionResponsePydantic(**raw_response.body)
