...
from griffin_python_sdk.model.legal_persons_create_new_legal_person_request import LegalPersonsCreateNewLegalPersonRequest as LegalPersonsCreateNewLegalPersonRequestSchema
from griffin_python_sdk.model.legal_persons_create_new_legal_person_request_claims import LegalPersonsCreateNewLegalPersonRequestClaims as LegalPersonsCreateNewLegalPersonRequestClaimsSchema
from griffin_python_sdk.model.legal_persons_create_new_legal_person_response import LegalPersonsCreateNewLegalPersonResponse as LegalPersonsCreateNewLegalPersonResponseSchema

from griffin_python_sdk.type.legal_persons_create_new_legal_person_response import LegalPersonsCreateNewLegalPersonResponse
from griffin_python_sdk.type.legal_persons_create_new_legal_person_request import LegalPersonsCreateNewLegalPersonRequest
from griffin_python_sdk.type.legal_persons_create_new_legal_person_request_claims import LegalPersonsCreateNewLegalPersonRequestClaims

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.legal_persons_create_new_legal_person_request_claims import LegalPersonsCreateNewLegalPersonRequestClaims as LegalPersonsCreateNewLegalPersonRequestClaimsPydantic
from griffin_python_sdk.pydantic.legal_persons_create_new_legal_person_response import LegalPersonsCreateNewLegalPersonResponse as LegalPersonsCreateNewLegalPersonResponsePydantic
from griffin_python_sdk.pydantic.legal_persons_create_new_legal_person_request import LegalPersonsCreateNewLegalPersonRequest as LegalPersonsCreateNewLegalPersonRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = LegalPersonsCreateNewLegalPersonRequestSchema


request_body_legal_persons_create_new_legal_person_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = LegalPersonsCreateNewLegalPersonResponseSchema
...
class ApiResponseFor201(api_client.ApiResponse):
    body: LegalPersonsCreateNewLegalPersonResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_new_legal_person_mapped_args(
        self,
        display_name: str,
        legal_person_type: str,
        organization_id: str,
        claims: typing.Optional[LegalPersonsCreateNewLegalPersonRequestClaims] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if display_name is not None:
            _body["display-name"] = display_name
        if legal_person_type is not None:
            _body["legal-person-type"] = legal_person_type
    ...
    async def _acreate_new_legal_person_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/organizations/{organization-id}/legal-persons',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_legal_persons_create_new_legal_person_request.serialize(body, content_type)
    ...
    def _create_new_legal_person_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateNewLegalPersonRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_legal_person(
        self,
        display_name: str,
        legal_person_type: str,
        organization_id: str,
        ...
        **kwargs,
        ...
        args = self._create_new_legal_person_mapped_args(
            display_name=display_name,
            legal_person_type=legal_person_type,
            organization_id=organization_id,
            claims=claims,
        )
        return await self._acreate_new_legal_person_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_new_legal_person(
        self,
        display_name: str,
        legal_person_type: str,
        organization_id: str,
        ...
        return self._create_new_legal_person_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewLegalPerson(BaseApi):
    ...
    async def acreate_new_legal_person(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LegalPersonsCreateNewLegalPersonResponsePydantic:
        raw_response = await self.raw.acreate_new_legal_person(
            display_name=display_name,
            legal_person_type=legal_person_type,
            organization_id=organization_id,
            claims=claims,
        ...
        if validate:
            return LegalPersonsCreateNewLegalPersonResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LegalPersonsCreateNewLegalPersonResponsePydantic, raw_response.body)
    ...
    def create_new_legal_person(
        ...
        raw_response = self.raw.create_new_legal_person(
            display_name=display_name,
            legal_person_type=legal_person_type,
            organization_id=organization_id,
            claims=claims,
