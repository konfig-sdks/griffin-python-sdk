...
from griffin_python_sdk.model.legal_persons_list_legal_persons_response import LegalPersonsListLegalPersonsResponse as LegalPersonsListLegalPersonsResponseSchema

from griffin_python_sdk.type.legal_persons_list_legal_persons_response import LegalPersonsListLegalPersonsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.legal_persons_list_legal_persons_response import LegalPersonsListLegalPersonsResponse as LegalPersonsListLegalPersonsResponsePydantic
...
class SortSchema(
    ...
    def STATUSCHANGEDAT(cls):
        return cls("-status-changed-at")
...
class IncludeSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    "latest-risk-rating": "RISKRATING",
                    "latest-verification": "VERIFICATION",
                }
            
            @schemas.classproperty
            def RISKRATING(cls):
                return cls("latest-risk-rating")
            
            @schemas.classproperty
            def VERIFICATION(cls):
                return cls("latest-verification")
...
class FilterApplicationStatusEqSchema(
    schemas.EnumBase,
    schemas.StrSchema
):
...
class FilterHasSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def APPLICATIONSTATUS(cls):
                return cls("application-status")
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'filter[application-status][eq]': typing.Union[FilterApplicationStatusEqSchema, str, ],
        'filter[has][]': typing.Union[FilterHasSchema, list, tuple, ],
...
request_query_filter_application_status_eq = api_client.QueryParameter(
    name="filter[application-status][eq]",
    style=api_client.ParameterStyle.FORM,
    schema=FilterApplicationStatusEqSchema,
    explode=True,
)
request_query_filter_has_ = api_client.QueryParameter(
    name="filter[has][]",
    style=api_client.ParameterStyle.FORM,
    schema=FilterHasSchema,
)
...
SchemaFor200ResponseBodyApplicationJson = LegalPersonsListLegalPersonsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LegalPersonsListLegalPersonsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_legal_persons_mapped_args(
        self,
        organization_id: str,
        sort: typing.Optional[str] = None,
        include: typing.Optional[typing.List[str]] = None,
        filter_application_status_eq: typing.Optional[str] = None,
        filter_has_: typing.Optional[typing.List[str]] = None,
        ...
        if filter_application_status_eq is not None:
            _query_params["filter[application-status][eq]"] = filter_application_status_eq
        if filter_has_ is not None:
            _query_params["filter[has][]"] = filter_has_
    ...
    async def _alist_legal_persons_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_filter_application_status_eq,
            request_query_filter_has_,
...
class ListLegalPersonsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_legal_persons(
        self,
        organization_id: str,
        sort: typing.Optional[str] = None,
        include: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._list_legal_persons_mapped_args(
            organization_id=organization_id,
            sort=sort,
            include=include,
            filter_application_status_eq=filter_application_status_eq,
            filter_has_=filter_has_,
            page_size=page_size,
            page_after=page_after,
            page_before=page_before,
        )
        return await self._alist_legal_persons_oapg(
    ...
    def list_legal_persons(
        ...
        return self._list_legal_persons_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListLegalPersons(BaseApi):
    ...
    async def alist_legal_persons(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LegalPersonsListLegalPersonsResponsePydantic:
        raw_response = await self.raw.alist_legal_persons(
            organization_id=organization_id,
            sort=sort,
            include=include,
            filter_application_status_eq=filter_application_status_eq,
        ...
        if validate:
            return LegalPersonsListLegalPersonsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LegalPersonsListLegalPersonsResponsePydantic, raw_response.body)
    ...
    def list_legal_persons(
        ...
        raw_response = self.raw.list_legal_persons(
            organization_id=organization_id,
            sort=sort,
            include=include,
            filter_application_status_eq=filter_application_status_eq,
