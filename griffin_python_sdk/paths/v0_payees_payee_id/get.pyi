...
from griffin_python_sdk.model.payees_get_details_response import PayeesGetDetailsResponse as PayeesGetDetailsResponseSchema

from griffin_python_sdk.type.payees_get_details_response import PayeesGetDetailsResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.payees_get_details_response import PayeesGetDetailsResponse as PayeesGetDetailsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PayeesGetDetailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PayeesGetDetailsResponse
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PayeesGetDetailsResponsePydantic:
        raw_response = await self.raw.aget_details(
            payee_id=payee_id,
            **kwargs,
        )
        if validate:
            return PayeesGetDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PayeesGetDetailsResponsePydantic, raw_response.body)
