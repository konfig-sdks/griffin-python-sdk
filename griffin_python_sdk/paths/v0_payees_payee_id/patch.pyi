...
from griffin_python_sdk.model.payees_update_payee_request import PayeesUpdatePayeeRequest as PayeesUpdatePayeeRequestSchema
from griffin_python_sdk.model.payees_update_payee_response import PayeesUpdatePayeeResponse as PayeesUpdatePayeeResponseSchema

from griffin_python_sdk.type.payees_update_payee_request import PayeesUpdatePayeeRequest
from griffin_python_sdk.type.payees_update_payee_response import PayeesUpdatePayeeResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.payees_update_payee_response import PayeesUpdatePayeeResponse as PayeesUpdatePayeeResponsePydantic
from griffin_python_sdk.pydantic.payees_update_payee_request import PayeesUpdatePayeeRequest as PayeesUpdatePayeeRequestPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'payee-id': typing.Union[PayeeIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = PayeesUpdatePayeeRequestSchema


request_body_payees_update_payee_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PayeesUpdatePayeeResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PayeesUpdatePayeeResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_payee_mapped_args(
        ...
        _path_params = {}
        _body = {}
        if payee_status is not None:
            _body["payee-status"] = payee_status
        args.body = _body
        if payee_id is not None:
            _path_params["payee-id"] = payee_id
    ...
    async def _aupdate_payee_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/payees/{payee-id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_payees_update_payee_request.serialize(body, content_type)
...
class UpdatePayee(BaseApi):
    ...
    async def aupdate_payee(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PayeesUpdatePayeeResponsePydantic:
        ...
        if validate:
            return PayeesUpdatePayeeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PayeesUpdatePayeeResponsePydantic, raw_response.body)
