...
from griffin_python_sdk.model.bank_accounts_get_account_response import BankAccountsGetAccountResponse as BankAccountsGetAccountResponseSchema

from griffin_python_sdk.type.bank_accounts_get_account_response import BankAccountsGetAccountResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.bank_accounts_get_account_response import BankAccountsGetAccountResponse as BankAccountsGetAccountResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BankAccountsGetAccountResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: BankAccountsGetAccountResponse
...
class GetAccount(BaseApi):
    ...
    async def aget_account(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BankAccountsGetAccountResponsePydantic:
        raw_response = await self.raw.aget_account(
            bank_account_id=bank_account_id,
            **kwargs,
        )
        if validate:
            return BankAccountsGetAccountResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(BankAccountsGetAccountResponsePydantic, raw_response.body)
    ...
    def get_account(
        ...
        raw_response = self.raw.get_account(
            bank_account_id=bank_account_id,
        )
        if validate:
            return BankAccountsGetAccountResponsePydantic(**raw_response.body)
