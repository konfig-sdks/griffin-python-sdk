...
from griffin_python_sdk.model.bank_accounts_update_bank_account_response import BankAccountsUpdateBankAccountResponse as BankAccountsUpdateBankAccountResponseSchema
from griffin_python_sdk.model.bank_accounts_update_bank_account_request import BankAccountsUpdateBankAccountRequest as BankAccountsUpdateBankAccountRequestSchema

from griffin_python_sdk.type.bank_accounts_update_bank_account_request import BankAccountsUpdateBankAccountRequest
from griffin_python_sdk.type.bank_accounts_update_bank_account_response import BankAccountsUpdateBankAccountResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.bank_accounts_update_bank_account_request import BankAccountsUpdateBankAccountRequest as BankAccountsUpdateBankAccountRequestPydantic
from griffin_python_sdk.pydantic.bank_accounts_update_bank_account_response import BankAccountsUpdateBankAccountResponse as BankAccountsUpdateBankAccountResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = BankAccountsUpdateBankAccountRequestSchema


request_body_bank_accounts_update_bank_account_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = BankAccountsUpdateBankAccountResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: BankAccountsUpdateBankAccountResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_bank_account_mapped_args(
        self,
        display_name: str,
        bank_account_id: str,
    ...
    async def _aupdate_bank_account_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/bank/accounts/{bank-account-id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_bank_accounts_update_bank_account_request.serialize(body, content_type)
...
class UpdateBankAccountRaw(BaseApi):
    ...
    async def aupdate_bank_account(
        ...
        **kwargs,
        ...
        args = self._update_bank_account_mapped_args(
            display_name=display_name,
            bank_account_id=bank_account_id,
        )
        return await self._aupdate_bank_account_oapg(
            body=args.body,
    ...
    def update_bank_account(
        ...
        return self._update_bank_account_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateBankAccount(BaseApi):
    ...
    async def aupdate_bank_account(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BankAccountsUpdateBankAccountResponsePydantic:
        raw_response = await self.raw.aupdate_bank_account(
            display_name=display_name,
            bank_account_id=bank_account_id,
            **kwargs,
        )
        if validate:
            return BankAccountsUpdateBankAccountResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(BankAccountsUpdateBankAccountResponsePydantic, raw_response.body)
    ...
    def update_bank_account(
        ...
        raw_response = self.raw.update_bank_account(
            display_name=display_name,
            bank_account_id=bank_account_id,
        )
        if validate:
