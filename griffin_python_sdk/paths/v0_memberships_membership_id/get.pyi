...
from griffin_python_sdk.model.memberships_get_membership_info_response import MembershipsGetMembershipInfoResponse as MembershipsGetMembershipInfoResponseSchema

from griffin_python_sdk.type.memberships_get_membership_info_response import MembershipsGetMembershipInfoResponse

from ...api_client import Dictionary
from griffin_python_sdk.pydantic.memberships_get_membership_info_response import MembershipsGetMembershipInfoResponse as MembershipsGetMembershipInfoResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = MembershipsGetMembershipInfoResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MembershipsGetMembershipInfoResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_membership_info_mapped_args(
        self,
        membership_id: str,
    ...
    async def _aget_membership_info_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v0/memberships/{membership-id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetMembershipInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_membership_info(
        self,
        membership_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_membership_info_mapped_args(
            membership_id=membership_id,
        )
        return await self._aget_membership_info_oapg(
    ...
    def get_membership_info(
        ...
        return self._get_membership_info_oapg(
            path_params=args.path,
        )

class GetMembershipInfo(BaseApi):
    ...
    async def aget_membership_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MembershipsGetMembershipInfoResponsePydantic:
        raw_response = await self.raw.aget_membership_info(
            membership_id=membership_id,
            **kwargs,
        )
        if validate:
            return MembershipsGetMembershipInfoResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MembershipsGetMembershipInfoResponsePydantic, raw_response.body)
    ...
    def get_membership_info(
        ...
        raw_response = self.raw.get_membership_info(
            membership_id=membership_id,
        )
        if validate:
            return MembershipsGetMembershipInfoResponsePydantic(**raw_response.body)
