...
from griffin_python_sdk.pydantic.payments_list_bank_account_admissions_response_admissions_item_admission_scheme_information import PaymentsListBankAccountAdmissionsResponseAdmissionsItemAdmissionSchemeInformation

class PaymentsListBankAccountAdmissionsResponseAdmissionsItem(BaseModel):
    # Specifies the progress of the inbound payment.
    admission-status_: Literal["processing", "returned", "delivered"] = Field(alias='admission-status')

    admission-scheme-information_: PaymentsListBankAccountAdmissionsResponseAdmissionsItemAdmissionSchemeInformation = Field(alias='admission-scheme-information')
    ...
    admission-url_: str = Field(alias='admission-url')
    class Config:
