...
class MembershipsListOrganizationMembershipsResponseMembershipsItemUser(BaseModel):
    # The user's email address.
    user-email_: str = Field(alias='user-email')

    # Link to the user.
    user-url_: str = Field(alias='user-url')

    # The username.
    user-username_: str = Field(alias='user-username')

    # Link to the user's [api keys](http://docs.griffin.com).
    api-keys-url_: str = Field(alias='api-keys-url')

    # Link to the user's [memberships](http://docs.griffin.com).
    user-memberships-url_: str = Field(alias='user-memberships-url')
