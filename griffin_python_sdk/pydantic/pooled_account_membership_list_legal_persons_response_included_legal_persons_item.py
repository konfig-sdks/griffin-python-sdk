...
from griffin_python_sdk.pydantic.pooled_account_membership_list_legal_persons_response_included_legal_persons_item_latest_decision import PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision

class PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItem(BaseModel):
    # Specifies if the legal person is an `individual` or a `corporation`.
    legal-person-type_: Literal["individual", "corporation"] = Field(alias='legal-person-type')
    ...
    legal-person-url_: str = Field(alias='legal-person-url')

    # Link to [decisions](http://docs.griffin.com) for this [legal person](http://docs.griffin.com).
    legal-person-decisions-url_: str = Field(alias='legal-person-decisions-url')
    ...
    legal-person-verifications-url_: str = Field(alias='legal-person-verifications-url')

    # Link to all evidence documents associated with this [legal person](http://docs.griffin.com).
    legal-person-documents-url_: str = Field(alias='legal-person-documents-url')

    latest-decision_: typing.Optional[PooledAccountMembershipListLegalPersonsResponseIncludedLegalPersonsItemLatestDecision] = Field(None, alias='latest-decision')

    # A contextual link to the risk rating.
    latest-risk-rating-url_: typing.Optional[str] = Field(None, alias='latest-risk-rating-url')

    # Status of the current [application](http://docs.griffin.com)
    application-status_: typing.Optional[Literal["referred", "errored", "declined", "submitted", "accepted"]] = Field(None, alias='application-status')

    # ISO 8601 formatted date-time.
    status-changed-at_: typing.Optional[datetime] = Field(None, alias='status-changed-at')

    # Link to the [claims](http://docs.griffin.com) for this [legal person](http://docs.griffin.com).
    legal-person-claims-url_: typing.Optional[str] = Field(None, alias='legal-person-claims-url')

    # Link to the [payees](http://docs.griffin.com) for this [legal person](http://docs.griffin.com).
    legal-person-bank-payees-url_: typing.Optional[str] = Field(None, alias='legal-person-bank-payees-url')
    class Config:
