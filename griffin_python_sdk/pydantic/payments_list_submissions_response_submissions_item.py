...
from griffin_python_sdk.pydantic.payments_list_submissions_response_submissions_item_submission_scheme_information import PaymentsListSubmissionsResponseSubmissionsItemSubmissionSchemeInformation

class PaymentsListSubmissionsResponseSubmissionsItem(BaseModel):
    ...
    submission-scheme-information_: PaymentsListSubmissionsResponseSubmissionsItemSubmissionSchemeInformation = Field(alias='submission-scheme-information')
