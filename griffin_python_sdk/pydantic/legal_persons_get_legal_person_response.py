...
from griffin_python_sdk.pydantic.legal_persons_get_legal_person_response_latest_decision import LegalPersonsGetLegalPersonResponseLatestDecision

class LegalPersonsGetLegalPersonResponse(BaseModel):
    ...
    latest-decision_: typing.Optional[LegalPersonsGetLegalPersonResponseLatestDecision] = Field(None, alias='latest-decision')
