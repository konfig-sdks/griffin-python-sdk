...
from griffin_python_sdk.pydantic.companies_house_get_company_details_response_company_address import CompaniesHouseGetCompanyDetailsResponseCompanyAddress
from griffin_python_sdk.pydantic.companies_house_get_company_details_response_directors import CompaniesHouseGetCompanyDetailsResponseDirectors
from griffin_python_sdk.pydantic.companies_house_get_company_details_response_persons_with_significant_control import CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControl
from griffin_python_sdk.pydantic.companies_house_get_company_details_response_sic_codes import CompaniesHouseGetCompanyDetailsResponseSicCodes

class CompaniesHouseGetCompanyDetailsResponse(BaseModel):
    entity-name_: str = Field(alias='entity-name')

    directors: CompaniesHouseGetCompanyDetailsResponseDirectors = Field(alias='directors')

    corporation-type_: Literal["private-limited-guarant-nsc-limited-exemption", "eeig", "private-limited-shares-section-30-exemption", "limited-partnership", "royal-charter", "private-unlimited-nsc", "old-public-company", "investment-company-with-variable-capital", "other-company-type", "converted-or-closed", "protected-cell-company", "private-limited-guarant-nsc", "scottish-charitable-incorporated-organisation", "industrial-and-provident-society", "registered-society-non-jurisdictional", "private-unlimited", "further-education-or-sixth-form-college-corporation", "limited-liability-partnership", "assurance-company", "other", "northern-ireland-other", "charitable-incorporated-organisation", "oversea-company", "icvc-securities", "uk-establishment", "unregistered-company", "icvc-warrant", "registered-overseas-entity", "public-limited-company", "private-limited-company", "european-public-limited-liability-company-se", "private-unlimted-nsc", "northern-ireland", "icvc-umbrella", "scottish-partnership"] = Field(alias='corporation-type')

    company-status_: Literal["dissolved", "active", "receivership", "registered", "removed", "administration", "open", "closed", "voluntary-arrangement", "liquidation", "converted-closed", "insolvency-proceedings"] = Field(alias='company-status')

    persons-with-significant-control_: CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControl = Field(alias='persons-with-significant-control')

    # ISO 8601 formatted date.
    date-of-incorporation_: date = Field(alias='date-of-incorporation')

    # The entity number assigned by the local register. For UK companies that's the Companies House company number.
    entity-registration-number_: str = Field(alias='entity-registration-number')

    company-address_: typing.Optional[CompaniesHouseGetCompanyDetailsResponseCompanyAddress] = Field(None, alias='company-address')

    # ISO 8601 formatted date.
    date-of-latest-accounts_: typing.Optional[date] = Field(None, alias='date-of-latest-accounts')

    # ISO 8601 formatted date.
    date-of-latest-confirmation-statement_: typing.Optional[date] = Field(None, alias='date-of-latest-confirmation-statement')

    accounts-overdue_: typing.Optional[bool] = Field(None, alias='accounts-overdue')

    sic-codes_: typing.Optional[CompaniesHouseGetCompanyDetailsResponseSicCodes] = Field(None, alias='sic-codes')

    confirmation-statement-overdue_: typing.Optional[bool] = Field(None, alias='confirmation-statement-overdue')
    class Config:
