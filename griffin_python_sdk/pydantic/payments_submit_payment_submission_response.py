...
from griffin_python_sdk.pydantic.payments_submit_payment_submission_response_submission_scheme_information import PaymentsSubmitPaymentSubmissionResponseSubmissionSchemeInformation

class PaymentsSubmitPaymentSubmissionResponse(BaseModel):
    ...
    submission-scheme-information_: PaymentsSubmitPaymentSubmissionResponseSubmissionSchemeInformation = Field(alias='submission-scheme-information')
