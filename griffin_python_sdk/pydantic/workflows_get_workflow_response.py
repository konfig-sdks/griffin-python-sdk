...
from griffin_python_sdk.pydantic.workflows_get_workflow_response_required_claim_types import WorkflowsGetWorkflowResponseRequiredClaimTypes
from griffin_python_sdk.pydantic.workflows_get_workflow_response_workflow_rules import WorkflowsGetWorkflowResponseWorkflowRules

class WorkflowsGetWorkflowResponse(BaseModel):
    ...
    required-claim-types_: typing.Optional[WorkflowsGetWorkflowResponseRequiredClaimTypes] = Field(None, alias='required-claim-types')

    workflow-rules_: typing.Optional[WorkflowsGetWorkflowResponseWorkflowRules] = Field(None, alias='workflow-rules')
    class Config:
