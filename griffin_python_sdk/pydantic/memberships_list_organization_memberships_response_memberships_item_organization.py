...
from griffin_python_sdk.pydantic.memberships_list_organization_memberships_response_memberships_item_organization_available_roles import MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRoles

class MembershipsListOrganizationMembershipsResponseMembershipsItemOrganization(BaseModel):
    ...
    own-legal-person-url_: str = Field(alias='own-legal-person-url')
    ...
    organization-mode_: Literal["test-mode", "live-mode"] = Field(alias='organization-mode')

    # Link to the [memberships](http://docs.griffin.com) for this [organization](http://docs.griffin.com).
    organization-memberships-url_: str = Field(alias='organization-memberships-url')
    ...
    organization-invitations-url_: str = Field(alias='organization-invitations-url')

    # The mutable display name for the Organisation
    display-name_: str = Field(alias='display-name')

    organization-api-keys-url_: str = Field(alias='organization-api-keys-url')

    # Link to the resource that enables you to request live access.
    organization-live-access-url_: str = Field(alias='organization-live-access-url')

    # Link to the endpoint which enables webhook creation.
    organization-webhooks-url_: str = Field(alias='organization-webhooks-url')

    # Link to the onboarding [workflows](http://docs.griffin.com) configured for this [organization](http://docs.griffin.com).
    organization-workflows-url_: str = Field(alias='organization-workflows-url')

    # Link to the [bank accounts](http://docs.griffin.com) managed by this [organization](http://docs.griffin.com).
    organization-bank-accounts-url_: str = Field(alias='organization-bank-accounts-url')

    available-roles_: MembershipsListOrganizationMembershipsResponseMembershipsItemOrganizationAvailableRoles = Field(alias='available-roles')

    # Is this organization able to make manual decisions on verifications?
    can-decide-on-verifications?_: bool = Field(alias='can-decide-on-verifications?')

    # Link to the [organization](http://docs.griffin.com).
    organization-url_: str = Field(alias='organization-url')

    organization-individuals-url_: str = Field(alias='organization-individuals-url')

    organization-corporations-url_: str = Field(alias='organization-corporations-url')

    # Link to the [legal persons](http://docs.griffin.com) grouped under this [organization](http://docs.griffin.com).
    organization-legal-persons-url_: str = Field(alias='organization-legal-persons-url')

    # Link to the endpoint which lists an organization's events.
    organization-events-url_: str = Field(alias='organization-events-url')

    # Link to the [Reliance onboarding](http://docs.griffin.com).
    organization-onboarding-applications-url_: typing.Optional[str] = Field(None, alias='organization-onboarding-applications-url')
    class Config:
