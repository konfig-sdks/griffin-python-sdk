...
from griffin_python_sdk.pydantic.payments_get_bank_account_payments_response_payments_item_creditor import PaymentsGetBankAccountPaymentsResponsePaymentsItemCreditor
from griffin_python_sdk.pydantic.payments_get_bank_account_payments_response_payments_item_debtor import PaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor
from griffin_python_sdk.pydantic.payments_get_bank_account_payments_response_payments_item_payment_amount import PaymentsGetBankAccountPaymentsResponsePaymentsItemPaymentAmount
from griffin_python_sdk.pydantic.payments_get_bank_account_payments_response_payments_item_ultimate_debtor import PaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor

class PaymentsGetBankAccountPaymentsResponsePaymentsItem(BaseModel):
    creditor: PaymentsGetBankAccountPaymentsResponsePaymentsItemCreditor = Field(alias='creditor')
    ...
    payment-amount_: PaymentsGetBankAccountPaymentsResponsePaymentsItemPaymentAmount = Field(alias='payment-amount')

    debtor: PaymentsGetBankAccountPaymentsResponsePaymentsItemDebtor = Field(alias='debtor')
    ...
    ultimate-debtor_: typing.Optional[PaymentsGetBankAccountPaymentsResponsePaymentsItemUltimateDebtor] = Field(None, alias='ultimate-debtor')
