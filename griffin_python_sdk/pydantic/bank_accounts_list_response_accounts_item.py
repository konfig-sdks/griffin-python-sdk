...
from griffin_python_sdk.pydantic.bank_accounts_list_response_accounts_item_account_balance import BankAccountsListResponseAccountsItemAccountBalance
from griffin_python_sdk.pydantic.bank_accounts_list_response_accounts_item_available_balance import BankAccountsListResponseAccountsItemAvailableBalance
from griffin_python_sdk.pydantic.bank_accounts_list_response_accounts_item_bank_addresses import BankAccountsListResponseAccountsItemBankAddresses

class BankAccountsListResponseAccountsItem(BaseModel):
    ...
    available-balance_: BankAccountsListResponseAccountsItemAvailableBalance = Field(alias='available-balance')
    ...
    account-balance_: BankAccountsListResponseAccountsItemAccountBalance = Field(alias='account-balance')
    ...
    bank-addresses_: typing.Optional[BankAccountsListResponseAccountsItemBankAddresses] = Field(None, alias='bank-addresses')
