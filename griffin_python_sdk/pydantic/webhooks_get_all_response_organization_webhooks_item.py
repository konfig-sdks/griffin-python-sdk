...
class WebhooksGetAllResponseOrganizationWebhooksItem(BaseModel):
    ...
    webhook-url_: str = Field(alias='webhook-url')

    # The callback URL of the webhook
    webhook-destination-url_: str = Field(alias='webhook-destination-url')

    # Test a webhook
    test-webhook-url_: str = Field(alias='test-webhook-url')

    # Activate a webhook
    activate-webhook-url_: str = Field(alias='activate-webhook-url')

    # Deactivate a webhook
    deactivate-webhook-url_: str = Field(alias='deactivate-webhook-url')

    # A description of the webhook
    webhook-description_: typing.Optional[str] = Field(None, alias='webhook-description')
    class Config:
