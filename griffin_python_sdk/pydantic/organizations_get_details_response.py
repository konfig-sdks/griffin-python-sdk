...
from griffin_python_sdk.pydantic.organizations_get_details_response_available_roles import OrganizationsGetDetailsResponseAvailableRoles

class OrganizationsGetDetailsResponse(BaseModel):
    ...
    available-roles_: OrganizationsGetDetailsResponseAvailableRoles = Field(alias='available-roles')
