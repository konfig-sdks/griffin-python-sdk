...
from griffin_python_sdk.pydantic.payments_list_admissions_response_admissions_item_admission_scheme_information import PaymentsListAdmissionsResponseAdmissionsItemAdmissionSchemeInformation

class PaymentsListAdmissionsResponseAdmissionsItem(BaseModel):
    ...
    admission-scheme-information_: PaymentsListAdmissionsResponseAdmissionsItemAdmissionSchemeInformation = Field(alias='admission-scheme-information')
