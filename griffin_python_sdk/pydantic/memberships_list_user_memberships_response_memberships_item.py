...
from griffin_python_sdk.pydantic.memberships_list_user_memberships_response_memberships_item_organization import MembershipsListUserMembershipsResponseMembershipsItemOrganization
from griffin_python_sdk.pydantic.memberships_list_user_memberships_response_memberships_item_roles import MembershipsListUserMembershipsResponseMembershipsItemRoles
from griffin_python_sdk.pydantic.memberships_list_user_memberships_response_memberships_item_user import MembershipsListUserMembershipsResponseMembershipsItemUser

class MembershipsListUserMembershipsResponseMembershipsItem(BaseModel):
    ...
    organization: MembershipsListUserMembershipsResponseMembershipsItemOrganization = Field(alias='organization')

    roles: MembershipsListUserMembershipsResponseMembershipsItemRoles = Field(alias='roles')

    user: MembershipsListUserMembershipsResponseMembershipsItemUser = Field(alias='user')
