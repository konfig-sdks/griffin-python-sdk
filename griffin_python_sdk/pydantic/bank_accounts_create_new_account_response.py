...
from griffin_python_sdk.pydantic.bank_accounts_create_new_account_response_account_balance import BankAccountsCreateNewAccountResponseAccountBalance
from griffin_python_sdk.pydantic.bank_accounts_create_new_account_response_available_balance import BankAccountsCreateNewAccountResponseAvailableBalance
from griffin_python_sdk.pydantic.bank_accounts_create_new_account_response_bank_addresses import BankAccountsCreateNewAccountResponseBankAddresses

class BankAccountsCreateNewAccountResponse(BaseModel):
    ...
    available-balance_: BankAccountsCreateNewAccountResponseAvailableBalance = Field(alias='available-balance')
    ...
    account-balance_: BankAccountsCreateNewAccountResponseAccountBalance = Field(alias='account-balance')
    ...
    bank-addresses_: typing.Optional[BankAccountsCreateNewAccountResponseBankAddresses] = Field(None, alias='bank-addresses')
