...
from griffin_python_sdk.pydantic.pooled_account_membership_list_legal_persons_response_included_risk_rating_entries_item_manually_created_by import PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItemManuallyCreatedBy

class PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItem(BaseModel):
    # A contextual link to the risk rating.
    risk-rating-url_: str = Field(alias='risk-rating-url')

    risk-rating_: Literal["high-risk", "prohibited-risk", "medium-risk", "low-risk"] = Field(alias='risk-rating')
    ...
    manually-created-by_: typing.Optional[PooledAccountMembershipListLegalPersonsResponseIncludedRiskRatingEntriesItemManuallyCreatedBy] = Field(None, alias='manually-created-by')

    # A link to the [verification](http://docs.griffin.com).
    verification-url_: typing.Optional[str] = Field(None, alias='verification-url')

    previous-risk-rating_: typing.Optional[Literal["high-risk", "prohibited-risk", "medium-risk", "low-risk"]] = Field(None, alias='previous-risk-rating')
    class Config:
