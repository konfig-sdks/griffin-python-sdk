...
from griffin_python_sdk.pydantic.transactions_get_transaction_by_id_response_account_balance import TransactionsGetTransactionByIdResponseAccountBalance
from griffin_python_sdk.pydantic.transactions_get_transaction_by_id_response_balance_change import TransactionsGetTransactionByIdResponseBalanceChange

class TransactionsGetTransactionByIdResponse(BaseModel):
    ...
    balance-change_: TransactionsGetTransactionByIdResponseBalanceChange = Field(alias='balance-change')

    account-balance_: TransactionsGetTransactionByIdResponseAccountBalance = Field(alias='account-balance')
