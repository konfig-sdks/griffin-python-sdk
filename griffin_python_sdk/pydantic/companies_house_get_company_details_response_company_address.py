...
class CompaniesHouseGetCompanyDetailsResponseCompanyAddress(BaseModel):
    building-number_: typing.Optional[str] = Field(None, alias='building-number')

    street-name_: typing.Optional[str] = Field(None, alias='street-name')

    city: typing.Optional[str] = Field(None, alias='city')

    postal-code_: typing.Optional[str] = Field(None, alias='postal-code')

    # ISO 3166-1 alpha-2 two-letter country code.
    country-code_: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='country-code')
    class Config:
