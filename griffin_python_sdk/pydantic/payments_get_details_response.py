...
from griffin_python_sdk.pydantic.payments_get_details_response_creditor import PaymentsGetDetailsResponseCreditor
from griffin_python_sdk.pydantic.payments_get_details_response_debtor import PaymentsGetDetailsResponseDebtor
from griffin_python_sdk.pydantic.payments_get_details_response_payment_amount import PaymentsGetDetailsResponsePaymentAmount
from griffin_python_sdk.pydantic.payments_get_details_response_ultimate_debtor import PaymentsGetDetailsResponseUltimateDebtor

class PaymentsGetDetailsResponse(BaseModel):
    creditor: PaymentsGetDetailsResponseCreditor = Field(alias='creditor')
    ...
    payment-amount_: PaymentsGetDetailsResponsePaymentAmount = Field(alias='payment-amount')

    debtor: PaymentsGetDetailsResponseDebtor = Field(alias='debtor')
    ...
    ultimate-debtor_: typing.Optional[PaymentsGetDetailsResponseUltimateDebtor] = Field(None, alias='ultimate-debtor')
