...
from griffin_python_sdk.pydantic.legal_persons_update_legal_person_response_latest_decision import LegalPersonsUpdateLegalPersonResponseLatestDecision

class LegalPersonsUpdateLegalPersonResponse(BaseModel):
    ...
    latest-decision_: typing.Optional[LegalPersonsUpdateLegalPersonResponseLatestDecision] = Field(None, alias='latest-decision')
