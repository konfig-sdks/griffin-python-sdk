...
from griffin_python_sdk.pydantic.payments_get_submission_response_submission_scheme_information import PaymentsGetSubmissionResponseSubmissionSchemeInformation

class PaymentsGetSubmissionResponse(BaseModel):
    ...
    submission-scheme-information_: PaymentsGetSubmissionResponseSubmissionSchemeInformation = Field(alias='submission-scheme-information')
