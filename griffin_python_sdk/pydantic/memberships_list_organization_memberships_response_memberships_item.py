...
from griffin_python_sdk.pydantic.memberships_list_organization_memberships_response_memberships_item_organization import MembershipsListOrganizationMembershipsResponseMembershipsItemOrganization
from griffin_python_sdk.pydantic.memberships_list_organization_memberships_response_memberships_item_roles import MembershipsListOrganizationMembershipsResponseMembershipsItemRoles
from griffin_python_sdk.pydantic.memberships_list_organization_memberships_response_memberships_item_user import MembershipsListOrganizationMembershipsResponseMembershipsItemUser

class MembershipsListOrganizationMembershipsResponseMembershipsItem(BaseModel):
    # Link to the [membership](http://docs.griffin.com).
    membership-url_: str = Field(alias='membership-url')

    # Link to the assigned [roles](http://docs.griffin.com) for this [membership](http://docs.griffin.com).
    membership-roles-url_: str = Field(alias='membership-roles-url')

    organization: MembershipsListOrganizationMembershipsResponseMembershipsItemOrganization = Field(alias='organization')

    roles: MembershipsListOrganizationMembershipsResponseMembershipsItemRoles = Field(alias='roles')

    user: MembershipsListOrganizationMembershipsResponseMembershipsItemUser = Field(alias='user')
