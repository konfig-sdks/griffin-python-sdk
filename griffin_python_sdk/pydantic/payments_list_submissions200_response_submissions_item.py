...
from griffin_python_sdk.pydantic.payments_list_submissions200_response_submissions_item_submission_scheme_information import PaymentsListSubmissions200ResponseSubmissionsItemSubmissionSchemeInformation

class PaymentsListSubmissions200ResponseSubmissionsItem(BaseModel):
    # Specifies the progress of the outbound payment.
    submission-status_: Literal["failed", "processing", "returned", "delivered"] = Field(alias='submission-status')

    submission-scheme-information_: PaymentsListSubmissions200ResponseSubmissionsItemSubmissionSchemeInformation = Field(alias='submission-scheme-information')
    ...
    submission-url_: str = Field(alias='submission-url')
    class Config:
