...
from griffin_python_sdk.pydantic.transactions_list_balance_changes_response_included_payments_item_creditor import TransactionsListBalanceChangesResponseIncludedPaymentsItemCreditor
from griffin_python_sdk.pydantic.transactions_list_balance_changes_response_included_payments_item_debtor import TransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor
from griffin_python_sdk.pydantic.transactions_list_balance_changes_response_included_payments_item_payment_amount import TransactionsListBalanceChangesResponseIncludedPaymentsItemPaymentAmount
from griffin_python_sdk.pydantic.transactions_list_balance_changes_response_included_payments_item_ultimate_debtor import TransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor

class TransactionsListBalanceChangesResponseIncludedPaymentsItem(BaseModel):
    creditor: TransactionsListBalanceChangesResponseIncludedPaymentsItemCreditor = Field(alias='creditor')

    # Whether the payment is moving money into or out of the account.
    payment-direction_: Literal["inbound-payment", "outbound-payment"] = Field(alias='payment-direction')

    # ISO 8601 formatted date-time.
    created-at_: datetime = Field(alias='created-at')

    # Link to the payment resource.
    payment-url_: str = Field(alias='payment-url')

    payment-amount_: TransactionsListBalanceChangesResponseIncludedPaymentsItemPaymentAmount = Field(alias='payment-amount')

    debtor: TransactionsListBalanceChangesResponseIncludedPaymentsItemDebtor = Field(alias='debtor')

    # Free-text field to help identify and categorise payments.
    payment-reference_: typing.Optional[str] = Field(None, alias='payment-reference')

    ultimate-debtor_: typing.Optional[TransactionsListBalanceChangesResponseIncludedPaymentsItemUltimateDebtor] = Field(None, alias='ultimate-debtor')

    # Link to the endpoint for listing payment admissions.
    payment-admissions-url_: typing.Optional[str] = Field(None, alias='payment-admissions-url')

    # Link to the endpoint for creating and listing payment submissions.
    payment-submissions-url_: typing.Optional[str] = Field(None, alias='payment-submissions-url')
    class Config:
