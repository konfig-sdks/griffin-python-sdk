...
from griffin_python_sdk.pydantic.memberships_get_membership_info_response_organization_available_roles import MembershipsGetMembershipInfoResponseOrganizationAvailableRoles

class MembershipsGetMembershipInfoResponseOrganization(BaseModel):
    ...
    available-roles_: MembershipsGetMembershipInfoResponseOrganizationAvailableRoles = Field(alias='available-roles')
