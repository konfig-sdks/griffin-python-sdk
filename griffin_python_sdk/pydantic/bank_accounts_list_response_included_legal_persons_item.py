...
from griffin_python_sdk.pydantic.bank_accounts_list_response_included_legal_persons_item_latest_decision import BankAccountsListResponseIncludedLegalPersonsItemLatestDecision

class BankAccountsListResponseIncludedLegalPersonsItem(BaseModel):
    ...
    latest-decision_: typing.Optional[BankAccountsListResponseIncludedLegalPersonsItemLatestDecision] = Field(None, alias='latest-decision')
