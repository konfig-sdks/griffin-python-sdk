...
from griffin_python_sdk.pydantic.workflows_list_organization_workflows_response_workflows_item_required_claim_types import WorkflowsListOrganizationWorkflowsResponseWorkflowsItemRequiredClaimTypes
from griffin_python_sdk.pydantic.workflows_list_organization_workflows_response_workflows_item_workflow_rules import WorkflowsListOrganizationWorkflowsResponseWorkflowsItemWorkflowRules

class WorkflowsListOrganizationWorkflowsResponseWorkflowsItem(BaseModel):
    # A link to the [workflow](http://docs.griffin.com).
    workflow-url_: str = Field(alias='workflow-url')
    ...
    required-claim-types_: typing.Optional[WorkflowsListOrganizationWorkflowsResponseWorkflowsItemRequiredClaimTypes] = Field(None, alias='required-claim-types')

    workflow-rules_: typing.Optional[WorkflowsListOrganizationWorkflowsResponseWorkflowsItemWorkflowRules] = Field(None, alias='workflow-rules')
    class Config:
