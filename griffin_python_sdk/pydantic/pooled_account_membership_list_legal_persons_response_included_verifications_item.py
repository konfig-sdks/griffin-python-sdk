...
class PooledAccountMembershipListLegalPersonsResponseIncludedVerificationsItem(BaseModel):
    # A link to the [verification](http://docs.griffin.com).
    verification-url_: str = Field(alias='verification-url')
    ...
    verification-checks-url_: str = Field(alias='verification-checks-url')

    verification-status_: Literal["in-progress", "pending", "checks-declined", "checks-complete", "failed"] = Field(alias='verification-status')

    # ISO 8601 formatted date-time.
    updated-at_: typing.Optional[datetime] = Field(None, alias='updated-at')

    # A link to the [workflow](http://docs.griffin.com).
    workflow-url_: typing.Optional[str] = Field(None, alias='workflow-url')

    risk-rating_: typing.Optional[Literal["high-risk", "prohibited-risk", "medium-risk", "low-risk"]] = Field(None, alias='risk-rating')

    verification-risk-assessments-url_: typing.Optional[str] = Field(None, alias='verification-risk-assessments-url')
    class Config:
