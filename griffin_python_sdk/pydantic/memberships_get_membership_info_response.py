...
from griffin_python_sdk.pydantic.memberships_get_membership_info_response_organization import MembershipsGetMembershipInfoResponseOrganization
from griffin_python_sdk.pydantic.memberships_get_membership_info_response_roles import MembershipsGetMembershipInfoResponseRoles
from griffin_python_sdk.pydantic.memberships_get_membership_info_response_user import MembershipsGetMembershipInfoResponseUser

class MembershipsGetMembershipInfoResponse(BaseModel):
    ...
    organization: MembershipsGetMembershipInfoResponseOrganization = Field(alias='organization')

    roles: MembershipsGetMembershipInfoResponseRoles = Field(alias='roles')

    user: MembershipsGetMembershipInfoResponseUser = Field(alias='user')
