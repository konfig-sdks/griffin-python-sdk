...
from griffin_python_sdk.pydantic.bank_accounts_close_account_response_account_balance import BankAccountsCloseAccountResponseAccountBalance
from griffin_python_sdk.pydantic.bank_accounts_close_account_response_available_balance import BankAccountsCloseAccountResponseAvailableBalance
from griffin_python_sdk.pydantic.bank_accounts_close_account_response_bank_addresses import BankAccountsCloseAccountResponseBankAddresses

class BankAccountsCloseAccountResponse(BaseModel):
    ...
    available-balance_: BankAccountsCloseAccountResponseAvailableBalance = Field(alias='available-balance')
    ...
    account-balance_: BankAccountsCloseAccountResponseAccountBalance = Field(alias='account-balance')
    ...
    bank-addresses_: typing.Optional[BankAccountsCloseAccountResponseBankAddresses] = Field(None, alias='bank-addresses')
