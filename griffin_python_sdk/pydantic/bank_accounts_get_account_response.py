...
from griffin_python_sdk.pydantic.bank_accounts_get_account_response_account_balance import BankAccountsGetAccountResponseAccountBalance
from griffin_python_sdk.pydantic.bank_accounts_get_account_response_available_balance import BankAccountsGetAccountResponseAvailableBalance
from griffin_python_sdk.pydantic.bank_accounts_get_account_response_bank_addresses import BankAccountsGetAccountResponseBankAddresses

class BankAccountsGetAccountResponse(BaseModel):
    ...
    available-balance_: BankAccountsGetAccountResponseAvailableBalance = Field(alias='available-balance')
    ...
    account-balance_: BankAccountsGetAccountResponseAccountBalance = Field(alias='account-balance')
    ...
    bank-addresses_: typing.Optional[BankAccountsGetAccountResponseBankAddresses] = Field(None, alias='bank-addresses')
