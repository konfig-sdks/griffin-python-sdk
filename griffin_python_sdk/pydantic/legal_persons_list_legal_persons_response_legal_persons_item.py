...
from griffin_python_sdk.pydantic.legal_persons_list_legal_persons_response_legal_persons_item_latest_decision import LegalPersonsListLegalPersonsResponseLegalPersonsItemLatestDecision

class LegalPersonsListLegalPersonsResponseLegalPersonsItem(BaseModel):
    ...
    latest-decision_: typing.Optional[LegalPersonsListLegalPersonsResponseLegalPersonsItemLatestDecision] = Field(None, alias='latest-decision')
