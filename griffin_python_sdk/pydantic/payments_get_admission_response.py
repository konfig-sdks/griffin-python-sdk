...
from griffin_python_sdk.pydantic.payments_get_admission_response_admission_scheme_information import PaymentsGetAdmissionResponseAdmissionSchemeInformation

class PaymentsGetAdmissionResponse(BaseModel):
    ...
    admission-scheme-information_: PaymentsGetAdmissionResponseAdmissionSchemeInformation = Field(alias='admission-scheme-information')
