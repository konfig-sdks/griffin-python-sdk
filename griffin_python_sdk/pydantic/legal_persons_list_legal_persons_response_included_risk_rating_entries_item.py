...
from griffin_python_sdk.pydantic.legal_persons_list_legal_persons_response_included_risk_rating_entries_item_manually_created_by import LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItemManuallyCreatedBy

class LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItem(BaseModel):
    ...
    manually-created-by_: typing.Optional[LegalPersonsListLegalPersonsResponseIncludedRiskRatingEntriesItemManuallyCreatedBy] = Field(None, alias='manually-created-by')
