...
from griffin_python_sdk.pydantic.legal_persons_create_new_legal_person_response_latest_decision import LegalPersonsCreateNewLegalPersonResponseLatestDecision

class LegalPersonsCreateNewLegalPersonResponse(BaseModel):
    ...
    latest-decision_: typing.Optional[LegalPersonsCreateNewLegalPersonResponseLatestDecision] = Field(None, alias='latest-decision')
