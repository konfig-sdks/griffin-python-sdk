...
class NavigationGlobalPathsFetchResponse(BaseModel):
    # Link to the [organization](http://docs.griffin.com).
    organizations-url_: str = Field(alias='organizations-url')

    users-url_: str = Field(alias='users-url')

    roles-url_: str = Field(alias='roles-url')

    session-url_: typing.Optional[str] = Field(None, alias='session-url')

    # The resource path for the API key
    api-key-url_: typing.Optional[str] = Field(None, alias='api-key-url')

    # Link to the [organization](http://docs.griffin.com).
    organization-url_: typing.Optional[str] = Field(None, alias='organization-url')
    class Config:
