...
from griffin_python_sdk.pydantic.memberships_list_user_memberships_response_memberships_item_organization_available_roles import MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRoles

class MembershipsListUserMembershipsResponseMembershipsItemOrganization(BaseModel):
    ...
    available-roles_: MembershipsListUserMembershipsResponseMembershipsItemOrganizationAvailableRoles = Field(alias='available-roles')
