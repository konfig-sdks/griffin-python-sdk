...
from griffin_python_sdk.pydantic.companies_house_get_company_details_response_persons_with_significant_control_item_natures_of_control import CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItemNaturesOfControl

class CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItem(BaseModel):
    # A human readable label for an entity
    display-name_: str = Field(alias='display-name')

    natures-of-control_: CompaniesHouseGetCompanyDetailsResponsePersonsWithSignificantControlItemNaturesOfControl = Field(alias='natures-of-control')

    # The URL of the entity in Companies House
    companies-house-url_: str = Field(alias='companies-house-url')

    given-name_: typing.Optional[str] = Field(None, alias='given-name')

    surname: typing.Optional[str] = Field(None, alias='surname')

    day-of-birth_: typing.Optional[int] = Field(None, alias='day-of-birth')

    month-of-birth_: typing.Optional[int] = Field(None, alias='month-of-birth')

    year-of-birth_: typing.Optional[int] = Field(None, alias='year-of-birth')
    class Config:
