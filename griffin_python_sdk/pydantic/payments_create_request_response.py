...
from griffin_python_sdk.pydantic.payments_create_request_response_creditor import PaymentsCreateRequestResponseCreditor
from griffin_python_sdk.pydantic.payments_create_request_response_debtor import PaymentsCreateRequestResponseDebtor
from griffin_python_sdk.pydantic.payments_create_request_response_payment_amount import PaymentsCreateRequestResponsePaymentAmount
from griffin_python_sdk.pydantic.payments_create_request_response_ultimate_debtor import PaymentsCreateRequestResponseUltimateDebtor

class PaymentsCreateRequestResponse(BaseModel):
    creditor: PaymentsCreateRequestResponseCreditor = Field(alias='creditor')
    ...
    payment-amount_: PaymentsCreateRequestResponsePaymentAmount = Field(alias='payment-amount')

    debtor: PaymentsCreateRequestResponseDebtor = Field(alias='debtor')
    ...
    ultimate-debtor_: typing.Optional[PaymentsCreateRequestResponseUltimateDebtor] = Field(None, alias='ultimate-debtor')
