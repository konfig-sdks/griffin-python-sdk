...
from griffin_python_sdk.paths.v0_memberships_membership_id import delete
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0MembershipsMembershipId(ApiTestMixin, unittest.TestCase):
    """
    V0MembershipsMembershipId unit test stubs
        Delete membership
    """
