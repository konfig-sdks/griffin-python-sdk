...
from griffin_python_sdk.paths.v0_memberships_membership_id_roles import put
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0MembershipsMembershipIdRoles(ApiTestMixin, unittest.TestCase):
    """
    V0MembershipsMembershipIdRoles unit test stubs
        Update role
    """
