...
from griffin_python_sdk.paths.v0_legal_persons_legal_person_id_decisions import post
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0LegalPersonsLegalPersonIdDecisions(ApiTestMixin, unittest.TestCase):
    """
    V0LegalPersonsLegalPersonIdDecisions unit test stubs
        Create decision
    """
