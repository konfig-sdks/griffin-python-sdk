...
from griffin_python_sdk.paths.v0_organizations_organization_id_invitations import post
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0OrganizationsOrganizationIdInvitations(ApiTestMixin, unittest.TestCase):
    """
    V0OrganizationsOrganizationIdInvitations unit test stubs
        Create invitation
    """
