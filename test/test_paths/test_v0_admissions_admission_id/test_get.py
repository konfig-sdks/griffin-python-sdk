...
from griffin_python_sdk.paths.v0_admissions_admission_id import get
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0AdmissionsAdmissionId(ApiTestMixin, unittest.TestCase):
    """
    V0AdmissionsAdmissionId unit test stubs
