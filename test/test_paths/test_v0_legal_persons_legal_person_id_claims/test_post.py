...
from griffin_python_sdk.paths.v0_legal_persons_legal_person_id_claims import post
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0LegalPersonsLegalPersonIdClaims(ApiTestMixin, unittest.TestCase):
    """
    V0LegalPersonsLegalPersonIdClaims unit test stubs
        Create claim
    """
