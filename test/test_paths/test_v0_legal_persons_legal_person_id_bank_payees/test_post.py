...
from griffin_python_sdk.paths.v0_legal_persons_legal_person_id_bank_payees import post
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0LegalPersonsLegalPersonIdBankPayees(ApiTestMixin, unittest.TestCase):
    """
    V0LegalPersonsLegalPersonIdBankPayees unit test stubs
        Create payee
    """
