...
from griffin_python_sdk.paths.v0_bank_accounts_bank_account_id_submissions import get
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0BankAccountsBankAccountIdSubmissions(ApiTestMixin, unittest.TestCase):
    """
    V0BankAccountsBankAccountIdSubmissions unit test stubs
