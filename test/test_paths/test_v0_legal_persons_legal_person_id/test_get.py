...
from griffin_python_sdk.paths.v0_legal_persons_legal_person_id import get
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0LegalPersonsLegalPersonId(ApiTestMixin, unittest.TestCase):
    """
    V0LegalPersonsLegalPersonId unit test stubs
        Get legal person
    """
