...
from griffin_python_sdk.paths.v0_bank_accounts_bank_account_id_payments import post
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0BankAccountsBankAccountIdPayments(ApiTestMixin, unittest.TestCase):
    """
    V0BankAccountsBankAccountIdPayments unit test stubs
        Create payment
    """
