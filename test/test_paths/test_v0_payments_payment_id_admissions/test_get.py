...
from griffin_python_sdk.paths.v0_payments_payment_id_admissions import get
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0PaymentsPaymentIdAdmissions(ApiTestMixin, unittest.TestCase):
    """
    V0PaymentsPaymentIdAdmissions unit test stubs
