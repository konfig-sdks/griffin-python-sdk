...
import griffin_python_sdk
from griffin_python_sdk.paths.v0_organizations_organization_id_onboarding_applications import post
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0OrganizationsOrganizationIdOnboardingApplications(ApiTestMixin, unittest.TestCase):
    """
    V0OrganizationsOrganizationIdOnboardingApplications unit test stubs
