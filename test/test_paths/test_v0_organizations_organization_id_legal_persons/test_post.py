...
from griffin_python_sdk.paths.v0_organizations_organization_id_legal_persons import post
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0OrganizationsOrganizationIdLegalPersons(ApiTestMixin, unittest.TestCase):
    """
    V0OrganizationsOrganizationIdLegalPersons unit test stubs
        Create legal person
    """
