...
from griffin_python_sdk.paths.v0_payments_payment_id_submissions import post
from griffin_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV0PaymentsPaymentIdSubmissions(ApiTestMixin, unittest.TestCase):
    """
    V0PaymentsPaymentIdSubmissions unit test stubs
        Submit payment
    """
